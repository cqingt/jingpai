	...
	<!--商品和店铺-->
      ...
      <div class="keyword"><?php echo $lang['hot_search'].$lang['nc_colon'];?>
        <ul>
          ...
          <li><a href="<?php echo urlArtist('search', 'index', array('keyword' => $val));?>"><?php echo $val; ?></a></li>
          <?php } }?>
        </ul>
      </div>
    </div>
      ...
      <dl class="my-mall">
        ...
        <dd>
          <div class="sub-title">
            ...
            <div class="nc-grade-mini" style="cursor:pointer;" onClick="javascript:go('<?php echo urlArtist('pointgrade','index');?>');"><?php echo $output['member_info']['level_name'];?></div>
            <?php } ?>            
            </h4>
            <a href="<?php echo urlArtist('member', 'home');?>" class="arrow">我的用户中心<i></i></a></div>
...
<nav class="public-nav-layout">
  <div class="wrapper">
    ...
    <ul class="site-menu">
      ...
      <li><a href="<?php echo urlArtist('show_groupbuy', 'index');?>" <?php if($output['index_sign'] == 'groupbuy' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_groupbuy'];?></a></li>
      <?php } ?>
      <li><a href="<?php echo urlArtist('brand', 'index');?>" <?php if($output['index_sign'] == 'brand' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_brand'];?></a></li>
      <?php if (C('points_isuse') && C('pointshop_isuse')){ ?>
      <li><a href="<?php echo urlArtist('pointshop', 'index');?>" <?php if($output['index_sign'] == 'pointshop' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> <?php echo $lang['nc_pointprod'];?></a></li>
      <?php } ?>
      <?php if (C('cms_isuse')){ ?>
      <li><a href="<?php echo urlArtist('special', 'special_list');?>" <?php if($output['index_sign'] == 'special' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> 专题</a></li>
      <?php } ?>
      ...
      <li><a
        ...
        switch($nav['nav_type']) {
            case '0':
                ...
                break;
            case '1':
                echo ' href="' . urlArtist('search', 'index',array('cate_id'=>$nav['item_id'])) . '"';
                if (isset($_GET['cate_id']) && $_GET['cate_id'] == $nav['item_id']) {
                    echo ' class="current"';
                }
                break;
            case '2':
                echo ' href="' . urlArtist('article', 'article',array('ac_id'=>$nav['item_id'])) . '"';
                if (isset($_GET['ac_id']) && $_GET['ac_id'] == $nav['item_id']) {
                    echo ' class="current"';
                }
                break;
            case '3':
                echo ' href="' . urlArtist('activity', 'index', array('activity_id'=>$nav['item_id'])) . '"';
