...
<?php if ($output['hidden_nctoolbar'] == 1111) {?>
<div id="ncToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <?php if (!$output['hidden_rtoolbar_cart']) { ?>
      ...
      <div class="chat"><a href="javascript:void(0);" <?php if($output['store_info']['is_own_shop'] == 1){?> 
	...
	?>><span class="icon"></span><i id="new_msg" class="new_msg" style="display:none;"></i><span class="tit">在线联系</span></a></div>
    </div>
    <div class="variation">
      <div class="middle">
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <?php } ?>
      </span> <?php echo $lang['nc_comma'],$lang['welcome_to_site'];?> <a rel="nofollow" href="<?php echo BASE_SITE_URL;?>"  title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><span><?php echo $output['setting_config']['site_name']; ?></span></a> <span>[<a rel="nofollow" href="<?php echo urlShop('login','logout');?>"><?php echo $lang['nc_logout'];?></a>] </span>
      <?php }else{?>
      <?php echo $lang['nc_hello'].$lang['nc_comma'].$lang['welcome_to_site'];?> <a rel="nofollow" href="<?php echo BASE_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a> <span>[<a rel="nofollow" href="<?php echo urlShop('login');?>"><?php echo $lang['nc_login'];?></a>]</span> <span>[<a rel="nofollow" href="<?php echo urlShop('login','register');?>"><?php echo $lang['nc_register'];?></a>]</span>
      <?php }?>

    <?php if($_GET['act'] == 'artist_blog'){?>
          <span style="margin-left:10px;"><a href="<?php echo urlArtist('artist_new','index');?>" style="color:red; font-family: Microsoft YaHei; font-size:14px;font-weight: bold;">书画馆</a></span>
    <?php }?>
 ...
 <dl style=" width: 100px;">
        <dt><a rel="nofollow" href="/index.php">收藏天下首页</a></dt>
      </dl>
      ...
      <dl>
        ...
        <dd>
          <ul>
            <li><a rel="nofollow" href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fglist">作品收藏</a></li>
            <li><a rel="nofollow" href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fslist">店铺收藏</a></li>
			<?php if($_SESSION['is_login'] == 1){?>
				<li><a rel="nofollow" href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=memberShoucang">艺术家收藏</a></li>
			 <?php }?>
          </ul>
        </dd>
      </dl>
	  ...
	  <dl class="weixin">
        ...
        <dd>
          <h4>扫描二维码<br/>
            关注商城微信号</h4>
          <img src="http://www.96567.com/shop/templates/default/images/art/footerwechat.jpg" > </dd>
        </dl>
    </div>
  </div>
</div>
