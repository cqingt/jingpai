...
//乐拍路径
define('LEPAI_SITE_URL', $config['lepai_site_url']);
//圈子路径
define('M_TMP_DEF_URL', $config['m_tmp_def_url']);
define('M_CIRCLE', $config['m_circle']);
//圈子logo路径
define('CIRCLE_PATH', 'http://images.96567.com/upload/circle/group/');
//CRM路径
define('CRM_SITE_URL', $config['crm_site_url']);
...
//手机端样式文件
define('M_TMP_PATH','/public_html/m/templates/default/circle');
...
$ignore = array('article_content','pgoods_body','doc_content','content','sn_content','g_body','store_description','p_content','groupbuy_intro','remind_content','note_content','adv_pic_url','adv_word_url','adv_slide_url','appcode','mail_content');
