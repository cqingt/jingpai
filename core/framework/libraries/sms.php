...
class Sms {
    ...
    */
    public function send($mobile,$content) {
		...
		{
			return $this->mysend_shoucang($mobile,$content);
		}
	...
	* 收藏天下内部短信通道
   */
    private function mysend_shoucang($mobile,$content) {
		if(!$mobile || !$content){
			return false;
		}
        $content =  iconv("UTF-8","GB2312//IGNORE",$content);
		$send = "http://123.57.49.61:8888/sms/codeSMS.php?from=utf8&mobile=".$mobile."&content=".$content;
