...
class ALIOSS{
	...
	public function auth($options){
		...
		// 把 /data
		$signable_resource = str_replace('/webroot/web/96567.com/public_html/data/','',$signable_resource);
	...
	public function set_bucket_website($bucket, $index_document, $error_document, $options = NULL){
		...
		$xml = new SimpleXMLElement('<?xml version="1.0" encoding="gb2312"?><WebsiteConfiguration></WebsiteConfiguration>');
