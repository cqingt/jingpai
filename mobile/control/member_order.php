    ...
    public function order_listOp() {
        ...
        foreach ($order_list_array as $value) {
            ...
            if ($value['order_state'] == ORDER_STATE_NEW) {
                $order_group_list[$value['pay_sn']]['pay_amount'] += $value['order_amount'] - $value['rcb_amount'] - $value['pd_amount'] - $value['money_paid'];
            }
...
//print_r($payment_list);
            ...
            if(!empty($payment_list)) {
                foreach ($payment_list as $value) {
                    ...
                    if(!$this->wx_browser && $value['payment_code'] == 'wxpay'){
                        continue;
                    }
