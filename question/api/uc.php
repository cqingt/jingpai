...
if(!defined('IN_UC')) {
	...
	require_once ASK2_ROOT.'/config.php';
	require_once ASK2_ROOT.'/data/ucconfig.inc.php';
	require_once ASK2_ROOT.'/lib/global.func.php';
	require_once ASK2_ROOT.'/lib/cache.class.php';
	$get = $post = array();
	...
	if(in_array($get['action'], array('test', 'deleteuser', 'renameuser', 'gettag', 'synlogin', 'synlogout', 'updatepw', 'updatebadwords', 'updatehosts', 'updateapps', 'updateclient', 'updatecredit', 'getcreditsettings', 'updatecreditsettings'))) {
		require_once ASK2_ROOT.'/lib/db.class.php';
