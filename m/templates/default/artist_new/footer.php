    ...
    <?php if(!$output['app_']){ ?>
        ...
        <footer class="footerNav">
            <div class="ui-row-flex">
                <div class="ui-col ui-col <?php if($output['XuanHuaType'] == '') echo 'active';?>" onclick="window.location.href='<?php echo urlWap('artist','index');?>'">
                    <i class="icon-home-nav1"></i>
                    <p>首页</p>
                </div>
                <div class="ui-col ui-col <?php if($output['XuanHuaType'] == 'FenLei') echo 'active';?>" onclick="window.location.href='<?php echo urlWap('artist','FenLei');?>'">
                    <i class="icon-home-nav2"></i>
                    <p>选画中心</p>
                </div>
                <div class="ui-col ui-col" onclick="window.location.href='<?php echo urlWap('member_cart','cart_list')?>'">
                    <i class="icon-home-nav3"></i>
                    <p>购物车</p>
                </div>
                <div class="ui-col ui-col" onclick="window.location.href='<?php echo urlWap('member','home');?>'">
