...
<div class="login-form">
    <form action="" method ="post" id="login_form">
      ...
      <input type="hidden" name="op" value="index">
        ...
        <input type="submit" class="l-btn-login mt10" id="loginbtn"  value="登陆">
    </form>

    <div class="footer-top">
    <div class="footer-tleft">
        <a href="<?php echo urlWap('login','register')?>" style="color:#D9434E;font-size:16px;">1注册</a>
		<a href="<?php echo urlWap('member_pas','pas_step1')?>" style="color:#D9434E;font-size:16px;">1忘记密码</a>
    </div>
    </div>
