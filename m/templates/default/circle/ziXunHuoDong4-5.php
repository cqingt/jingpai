...
<html lang="en">
	<head>
		...
		<script type="text/javascript" src="<?php echo M_TMP_DEF_URL;?>/js/group.js"></script>
		  ...
		  <section class="ui-container">
						...
						<li class="ui-col ui-col">
							...
							<h6>
								<?php if($output['circle_info']['mapply_open'] == 1 && $output['identity'] == 3 && $output['cm_info']['cm_level'] >= $output['circle_info']['mapply_ml']){?>
									<a href="index.php?act=circle_group&op=manage_applyview&c_id=<?php echo $output['c_id'];?>" nctype="manageApply"><?php echo "申请为管理员"?></a>
								<?php }?>
							</h6>
						</li>
						<li class="ui-col ui-col">
		  	...
		  	<div class="demo-tiem">
				<div class="ui-row-flex ui-whitespace manPilot">
					...
					<div data-href="index.php?act=circle_manage_mapply&c_id=<?php echo $output['c_id'];?>" class="ui-col ui-col active">申请管理</div>
				</div>
		  	</div>
				    ...
				    <li class="ui-row-flex ui-border-b">
				    	<div class="ui-col ui-col-4">
					        ...
					        <div class="ui-list-info">
					            <h4 class="ui-nowrap"><?php echo $val['member_name'];?></h4>
					            <p class="ui-nowrap">申请时间：2016-02-02</p>
					        </div>
							<div class="demo-txt">
								<p class="ui-nowrap-flex">申请理由：文本标签文本标签文本标签</p>
							</div>	
				    	</div>
				    	<div class="ui-col">
							<button class="ui-btn-ok" data-href="index.php?act=circle_manage_mapply&op=mapply_pass&cm_id=<?php echo $val['member_id'];?>&c_id=<?php echo $output['c_id'];?>">通过</button>
							<button class="ui-btn-no" data-href="index.php?act=circle_manage_mapply&op=del&cm_id=<?php echo $val['member_id'];?>&c_id=<?php echo $output['c_id'];?>">拒绝</button>
				    	</div>
				    </li>
					<?php }?>
				</ul>
...
<script>
	$('#apply').click(function(){
		var mapply_reason = prompt("希望您能告诉我们是什么原因使您希望成为本圈管理？","");
		$.ajax({
			url:"index.php?act=circle_group&op=manage_apply",
			type:"POST",
			data:{'mapply_reason':mapply_reason},
