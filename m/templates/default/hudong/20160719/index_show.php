<link rel="stylesheet" href="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/css/demo.css" />
<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/css/default.css" />
<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/css/component.css" />
<script src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/js/tabulous.js"></script>
<script>
$(function(){
	$('.tabs').tabulous({
		effect: 'scale'
...
if(!empty($_SESSION['is_login']) && (!empty($output['member_weixin_info']) || !empty($output['member_weixin_info']['dianzan']))){
	...
	$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/hudong/20160719/images/100x100.jpg";
	$array['P']['link'] = urlWap('hudong','ad_20160719',array('push_openid'=>$_SESSION['openid'],'ua'=>$_GET['ua']?$_GET['ua']:$_SESSION['zan_ua'])); //分享连接
	$array['Y']['link'] = urlWap('hudong','ad_20160719',array('push_openid'=>$_SESSION['openid'],'ua'=>$_GET['ua']?$_GET['ua']:$_SESSION['zan_ua'])); //分享连接
	$array['Y']['title'] = '我在这里抢银条，打开链接，速来帮忙';
	$array['Y']['desc'] = '万人疯抢，一元一克【包邮】，再不帮忙抢就没了！！';
	$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/hudong/20160719/images/100x100.jpg";
	echo weixinShare($array,urlWap('hudong','ad_20160719'));
	...
	$array['P']['title'] = '我在这里抢银条，打开链接，速来帮忙';
	$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/hudong/20160719/images/100x100.jpg";
	$array['P']['link'] = urlWap('hudong','ad_20160719',array('push_openid'=>$_GET['push_openid'],'ua'=>$_GET['ua']?$_GET['ua']:$_SESSION['zan_ua'])); //分享连接
	$array['Y']['link'] = urlWap('hudong','ad_20160719',array('push_openid'=>$_GET['push_openid'],'ua'=>$_GET['ua']?$_GET['ua']:$_SESSION['zan_ua'])); //分享连接
	$array['Y']['title'] = '我在这里抢银条，打开链接，速来帮忙';
	$array['Y']['desc'] = '万人疯抢，一元一克【包邮】，再不帮忙抢就没了！！';
	$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/hudong/20160719/images/100x100.jpg";
...
<section class="banner">
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_01.jpg"/>
	<img id="huodongguize"  src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_02.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_03.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_04.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_05.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_06.jpg"/>
</section>

<section class="praise-main">
	<img id="zan" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/home-love.jpg"/>
	<img id="yaoqing" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/home-yaoqing.jpg"/>
	<img id="linqu" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/home-lingqu.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_07.jpg"/>
</section>
<!--点进进入首页显示的主内容 A-->
...
<!--给它点赞状态后的内容 S-->
<section class="banner" >
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_a1.jpg"/>
	<img id="huodongguize" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_a2.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_a3.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_a4.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_a5.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_a6.jpg"/>
</section>

<section class="praise-main" >
	<img id="button_dianzan" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/a_give.jpg"/>
	<img id="yeyaoling" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/a_me.jpg"/>
	<!--进度条的背景盒子-->
...
<!--好友状参与页 S-->
<section class="banner" >
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_c1.jpg"/>
	<img id="huodongguize" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_c2.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_c3.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_c4.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_c5.jpg"/>
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/banner_c6.jpg"/>
</section>

<section class="praise-main">
    <img id="user_zan" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/c_zan.jpg"/>
	<!--进度条的背景盒子-->
	...
	<!--进度条的背景盒子-->
	<img id="user_yaoqing" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/c_yaoqing.jpg"/>
	<img id="user_linqu" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/c_lingqu.jpg"/>
</section>
<!--好友状参与页 A-->
        ...
        <div class="demo clearfix">
             ...
             <div class="tc-con clearfix">
				...
				<div class="sea-mew clearfix">
					<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/sea-mew.jpg"/>
				</div>		
...
<!-- Demo end --> 
				...
				<div class="tabs" id="login_zc" style="display: none;">
					<img class="img mt" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/five.png"/>
	...
	<form id="form_zhuce" action="<?php echo urlWap('hudong','register_show');?>" method="post">
	...
	<form id="form_login" action="<?php echo urlWap('hudong','login_show');?>" method="post">
          ...
          <button class="tc-btn-vote mt" >立即登录</button>   
				...
				<div class="tabs" id="dianzan" style="display: none;">
                    <div class="rule-box">
                    	...
                    	<img class="img mt" src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/succeed.jpg"/>
                    </div>
				</div>
				<!-- Demo end --> 								
            </div>
...
<div class="md-modal md-effect-3" id="modal-share">
 <button class="md-close close-one"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/share.png"/></button>
</div>
...
<script src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/js/classie.js"></script>
<script src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/js/modalEffects.js"></script>
<script>
	var polyfilter_scriptpath = "<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/js/";
</script>
...
<section class="photo">
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_01.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_02.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_03.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_04.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_05.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_06.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_07.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_08.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_09.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_10.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_11.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_12.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_13.jpg"/>
	<img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/photo_14.jpg"/>
</section>

<!-- 左下角领取银条按钮 -->
<!-- <div class="flotage"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/hudong/20160719/images/flotage.png" alt="" /></div> -->
...
$(function(){
	...
	$("#yaoqing,#linqu,#zan").click(function(){
		...
		if(!!is_login){
			if(!!member_weixin_info){
				...
				window.location.href="<?php echo urlWap('hudong','get_weixin_info');?>";
			}
		}else{
	...
	$("#yeyaoling").click(function(){
		...
		if(!!is_login){
			if(!!member_weixin_info_push_this){
				...
				// window.location.href="<?php echo urlWap('hudong','ad_20160719');?>";
			}else{
				window.location.href="<?php echo urlWap('hudong','get_weixin_info');?>";
			}
		}else{
    ...
    $("#button_dianzan").click(function(){
		...
		if(!!is_login){
			if(!!member_weixin_info_push_this){
		    	$.ajax({
			        url:"<?php echo urlWap('hudong','ad_20160719_dianzan');?>",
			        type:"POST",
				...
				window.location.href="<?php echo urlWap('hudong','get_weixin_info',array('zan_url'=>urlencode(urlWap('hudong','ad_20160719',array('push_openid'=>$_GET['push_openid'])))));?>";
			}
		}else{
			$("#modal-from").addClass('md-show');
			$("#login_zc").show();
...
//获取区域列表
	$.ajax({
		type:'post',
		url:"<?php echo urlWap('hudong','area_list')?>",
		data:'',
		dataType:'json',
...
// 领取
	$("#btnLingQu").bind("click", function() {
		...
		$.ajax({
			type:'post',
			url:"index.php?act=hudong&op=dianZanLinQu",
...
function getPhoneYzm(){
        ...
        $.ajax({
            type:'post',
            url:"index.php?act=hudong&op=getPhoneYzm",
