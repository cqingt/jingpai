...
<?php }else{$_SESSION['is_login'] = 1;file_put_contents('app_session.txt',print_r($_SESSION,true),FILE_APPEND);}?>
    ...
    <div class="main-opera-pannel">
        <div class="main-op-table main-op-warp"  style="display: none">
            <a href="<?php echo M_SITE_URL?>" class="quarter">
                <i class="fa fa-home fa-2x"></i>
                <p>首页</p>
            </a>
            <a href="<?php echo urlWap('goods_class','index')?>" class="quarter">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
                $("#btn-opera").click(function(event) {
                    ...
                    $(".demo-header").toggleClass('hh5').next('.main-opera-pannel').css('margin-top','50px');
                });
            });
    </script>
</header>
