...
if(!empty($_SESSION['is_login']) && (!empty($output['member_weixin_info']) || !empty($output['member_weixin_info']['dianzan']))){
	$array['P']['title'] = '我在这里抢银条，速来帮忙！';
	$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160719/images/100x100.jpg";
	$array['P']['link'] = urlWap('zhuanti','ad_20160719',array('push_openid'=>$_SESSION['openid'])); //分享连接
	$array['Y']['link'] = urlWap('zhuanti','ad_20160719',array('push_openid'=>$_SESSION['openid'])); //分享连接
	$array['Y']['title'] = '我在这里抢银条，速来帮忙！';
	...
	$array['P']['title'] = '我在这里抢银条，速来帮忙！';
	$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160719/images/100x100.jpg";
	$array['P']['link'] = urlWap('zhuanti','ad_20160719',array('push_openid'=>$_GET['push_openid'])); //分享连接
	$array['Y']['link'] = urlWap('zhuanti','ad_20160719',array('push_openid'=>$_GET['push_openid'])); //分享连接
	$array['Y']['title'] = '我在这里抢银条，速来帮忙！';
	$array['Y']['desc'] = '万人疯抢，一元一克【包邮】，再不帮忙抢就没了！！';
	$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160719/images/100x100.jpg";
	echo weixinShare($array);
...
<?php if($output['member_this'] === true && empty($output['member_weixin_info']['dianzan'])){?>
...
<section class="praise-main">
	<img class="md-trigger" data-modal="modal-share" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160719/images/home-love.jpg"/>
...
<section class="praise-main">
    <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160719/images/c_zan.jpg"/>
	<!--进度条的背景盒子-->
        ...
        <div class="demo clearfix">
             ...
             <div class="tc-con clearfix">
				...
				<div class="tabs" id="huodong_guize" style="display: none;">
                    <div class="rule-box">
                    	<h3>活动规则</h3>
                    	<p>1、获得5个点赞，即可以1元/克的超低价格购买银条</p>
                    	<p>2、每位用户限购5克银条</p>
                    	<p>3、邮费由收藏天下承担，无需用户支付</p>
                    	<p>4、本活动最终解释权归“收藏天下”所有</p>
                    </div>
				</div>
				<!-- Demo end --> 					
...
<div class="tabs" id="xiadan" style="display: none;">
	<div class="get-box">
		<h3>领取银条</h3>
          ...
          <h6><em style="text-decoration:line-through">邮费为《好运投资银条》5g版  发行价45元/条</em>5元/条（包邮）</h6>
