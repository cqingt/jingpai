...
function clock(time,key,t){
	...
	<div class="banner">
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/banner_01.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/banner_02.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/banner_03.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/banner_04.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/banner_05.jpg"/>
	</div>
		<!--
	...
	<div class="send-money" id="nav1">
		<div class="moneybox">
		    ...
		    <div class="coupon">
		    	...
		    	<div class="coupon2">
		    		<a href="javascript:void(0);" onclick="lingqu(5);"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/Coupon_05.jpg"/></a>
		    	</div> 			    	
		    </div>
        ...
        <div class="free-postage inter-cut">
			<div>
                <a href="http://www.96567.com/goods-15597.html#id=indexlh"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/inter-cut.jpg" alt=""></a>
			</div>			
		</div>
		...
		<div class="lucky-draw" id="nav2">
			<div class="w">
			    <div class="headline"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/lucky-draw.jpg"/></div>
				...
				<div class="main2">
					...
					<?php if($output['is_qian_dao'] == 1){ ?>
						<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/go2.jpg" id="main3-btn-type" qian-dao-caou-jiang="2"/>
						<?php }else{ ?>
							<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/go1.jpg" id="main3-btn-type" qian-dao-caou-jiang="1"></div>
						<?php } ?>
					</div>
				</div>		    
			    <!-- 奖 a -->
			    ...
			    <ul class="award-nav investment_title">
			    	<li class="on">中奖公告</li>
			    	<?php if(intval($_SESSION['member_id'] > 0)) {?><li>我的中奖纪录</li><?php }?>
			    </ul>
					...
					$.ajax({
						...
						success:function(result){
							 ...
							 if(result.msg == -1){//未登录
								...
								$(".main3-btn").html('<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/go2.jpg" id="main3-btn-type" qian-dao-caou-jiang="2">');
							  }else{
								var txt=  "<p>"+result.msg+"</p>";
								var option = {
									title: "提示信息：",										
		...
		function letGo(rid){
			...
			var num1=[-575,-685,-793,-899][TextNum1];//在这里随机
			var num2=[-1388,-1496,-1605,-413,-573,-685,-793,-899][TextNum2];
			var num3=[-1388,-1496,-1605,-413,-573,-685,-794,-899][TextNum3];
		...
		function reset(){
			$(".num-con1,.num-con2,.num-con3").css({"top":-414});
		}			
		</script>	
		
		<div class="free-postage" id="nav3">
			<div>
			    <div class="headline"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/free-postage.jpg"/></div>
			    <h2 class="headline-h2">纪念钞9.9包邮到家  迎接新会员不玩虚的</h2>
			    <a class="btn-eye eye-red" href="javascript:;" id="btn4">查看活动规则</a>
			    <a class="free-postage-add" href="javascript:;" onclick="btn_9_9();"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/free-postage-add.jpg"/></a>
			</div>			
		</div>		

		<div class="value-for-money" id="nav4">
			<div class="w">
			    <div class="headline"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/value-for-money.jpg"/></div>
						...
						<div <?php if($v['end']=='1'){ ?> class="day day1" <?php }elseif($v['end']=='2'){ ?>  class="day day2" <?php }else{ ?> class="day day3" <?php } ?>>
						   ...
						   <?php } ?>
							...
							<div class="seckill-img">
								...
								<a  href="<?php echo $v['goods_url'];?>"><img src="<?php echo $v['goods_image'];?>" alt="<?php echo $v['goods_name'];?>" />
								...
								<?php if($v['end']=='1'){ ?>
								<a class="btn-sec" href="<?php echo $v['goods_url'];?>">该秒杀已结束</a>
							   <?php }elseif($v['end']=='2'){ ?>
									<a class="btn-sec" href="<?php echo $v['goods_url'];?>">立即秒杀</a>
							   <?php }else{ ?>
									<a class="btn-sec" href="<?php echo $v['goods_url'];?>">即将开始</a>
							   <?php } ?>
		...
		<div class="lowest-price"  id="nav5">
			<div class="w">
			    <div class="headline"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/lowest-price.png"/></div>
			    <a class="btn-eye" href="javascript:;" id="btn5">查看活动规则</a>
			    <h2 class="headline-h2">购专区产品享三倍积分 全国包邮</h2>
			    <h2 class="headline-h2"><strong>购专区产品满299元送十国纪念钞</strong></h2>
			    
			    <div class="lp-ad">
			    	<a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=17163"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/lp-ad1.jpg"/></a>
			    	<a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=16091"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/lp-ad2.jpg"/></a>
			    </div>
				...
				<li>
			    		<a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=<?php echo $v['goods_id'];?>" >
				    		<div class="shopimg">
			    		...
			    		<p>惊爆价<em> ¥</em><em><?php if(intval($v['goods_promotion_price']) > 0){ echo intval($v['goods_promotion_price']); }else{ echo intval($v['goods_price']); }?></em><a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=<?php echo $v['goods_id'];?>" >购买</a></p>
			    	</li>
				<?php } ?>
		...
		<div class="free-postage priority-have"  id="nav6">
			<div class="w">
			    <div class="headline"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/have.jpg"/></div>
			    <h2 class="headline-h2">填写10字以上五星好评 返现金5元</h2>
			    <p class="eye">收货后不要忘了去点评哦，有返现拿</p>
            ...
            <?php foreach($output['goodsevallist'] as $k=>$v){?>
                  ...
                  <?php }?></strong>
									...
									<strong class="object">评论对象：<?php echo $v['geval_goodsname'];?></strong>
								</p>
								<p>用户评论：
					    ...
					    <a class="btn-comment" <?php if(time() < '1463500800'){ echo 'href="javascript:;" onclick="tishi();"';}else{ ?>href="http://m.96567.com/index.php?act=member_order&op=order_list"  <?php }?>>我要评论</a>
<!--					<div class="scroltit"><div class="updown" id="but_down">向上</div><div class="updown" id="but_up">向下</div></div>-->
				</div>	
				
				<a class="btn-top" href="#"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160518/images/icon-top.jpg"/></a>
             ...
             <div class="df_investment_con">
	             ...
	             <div class="tab-content">
						<div class="">     
							  ...
							  <div class="row">
								 <label for="">验证</label>
								 <input type="text" name="captcha_code" id="code">
								 <button type="button" class="verify" value="获取验证码" onclick="getPhoneYzm();" name="getYzm" id="getYzm">获取验证码</button>	     	
								</div>	
