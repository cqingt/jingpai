<link href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160622/css/index.css" rel="stylesheet">

<div class="header">
     <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160622/images/header.jpg" alt="">
</div>
...
<script>
    $("#btnOne").bind("click", function(event) {
		...
		$.ajax({
			type:'post',
			url:"index.php?act=zhuanti&op=ad_20160622&action=yanzhengone",
...
<div class="synopsis">
     <div class="syn-text">
         <h2>《 抗战胜利70周年纪念币简介 》</h2>
         <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160622/images/rmb.jpg" alt="">
...
<div class="get">
     <div class="getbox">
          <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160622/images/get.jpg" alt="">
     ...
     <a class="btn" href="http://m.96567.com"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160622/images/btn.jpg" alt=""></a>
</div>
...
<script>
	...
	$("#btnLingQu").bind("click", function() {
		...
		$.ajax({
			type:'post',
			url:"http://m.96567.com/index.php?act=zhuanti&op=ad_20160622&action=lingqu",
...
$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160622/images/weixinfen.jpg";
$array['Y']['title'] = "抗战胜利70周年纪念币免费领取";
$array['Y']['desc'] = "收藏天下注册免费送抗战胜利70周年币一套，名额有限，速来！";
$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160622/images/weixinfen.jpg";
