...
<div class="wrapper">
    <div class="pages">
        <section class="page">
            <div class="animation1"><div class="box1" id="btnRule" data-animation="fadeInToBottom" data-delay="1000"></div></div>
            <div class="box2" data-animation="fadeInToTop" data-delay="1500"></div>
            <div class="box3" data-animation="fadeInToLeft" data-delay="1800"></div>
            <div class="box4" data-animation="fadeInToRight" data-delay="2000"></div>
            ...
            <div class="box6" data-animation="fadeInToTop" data-delay="2800"></div>
        </section>  
    </div>
</div>
...
//	代替a标签
	$('.page div').click(function() {
		if($(this).data('href')) {
			alert("用户可多次参与预测，系统以最后一次选择的数据为准");
			$.ajax({
			        url:$(this).data('href'),
			        type:"POST",
			        data:{num:1},
