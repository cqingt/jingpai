<link rel='stylesheet' href='<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160504_2/css/rio.css'>
<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160504_2/js/jquery.js"></script>
<div class="rio-photo">
...
<div class="popup">
   ...
   <div id="dialog" class="content">
     ...
     <img class="rioimg-top" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160504_2/images/riotab_top.jpg"/>
     <img class="rioimg-up" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160504_2/images/rio_up.jpg"/>
...
$("#btnLingQu").bind("click", function() {
    ...
    $.ajax({
      type:'post',
      url:"index.php?act=zhuanti&op=ad_20160504_2&action=Linqu",
...
$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160504_2/images/1weixin.jpg";
$array['Y']['title'] = "里约奥运纪念币火爆预售    十万人掀起抢订狂潮";
$array['Y']['desc'] = "错过了600倍涨幅的08奥运纪念钞，就不要再错过这次抄底机会!";
$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160504_2/images/1weixin.jpg";
