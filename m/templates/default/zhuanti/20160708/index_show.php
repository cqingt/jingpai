	...
	<div class="silver-bar">
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_01.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_02.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_03.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_04.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_05.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_06.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_07.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/banner1_08.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_02.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_03.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_04.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_05.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_06.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_07.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_08.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_09.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_10.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_11.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_12.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_13.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_14.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_15.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_16.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_17.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_18.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_19.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_20.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_21.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_22.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_23.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_24.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_25.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_26.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_27.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_28.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_29.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_30.jpg"/>
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/im1/photo4_31.jpg"/>
	</div>
	<div class="btn-play">
		<img class="md-trigger" data-modal="modal-from1" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160708/images/mfbtn.png"/>
	</div>
	        ...
	        <div class="demo clearfix">
                 ...
                 <div class="tc-con clearfix">
					...
					<div class="tabs" id="modal-from99" style="display:none;">
						...
						<div id="tabs_container">
							<div class="demo formbox showscale" id="tabs-1">
			                  ...
			                  <p id="gong-passwordf">您的密码为：手机号后6位的明码</p><strong style="color:#DC3B37;">您的手机号后六位，请及时修改</strong>
					...
					<div class="tabs onlylq" id="Demo_start1" <?php if(intval($_SESSION['member_id']) <= 0){?>style="display:none;"<?php }?>>
						<ul class="tabsnav tc-tabsnav">
							<!----><li><a class="no-no" href="#tabs-1" title="">领取银条</a></li>
						</ul>
						...
						<div id="tabs_container">
							<div class="demo formbox showscale" id="tabs-1">
			                  ...
			                  <p class="newp1">由于银条贵重，邮费需要自理哦（20元）</p>			                  
	...
	$("#btnLingQu").bind("click", function() {
		...
		$.ajax({
			type:'post',
			url:"index.php?act=zhuanti&op=ad_20160708&action=lingqu",
...
$("#member_reg").bind("click", function() {
	...
	$.ajax({
		type:'post',
		url:"index.php?act=zhuanti&op=ad_20160708&action=regs",
