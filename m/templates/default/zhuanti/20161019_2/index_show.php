...
<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/css/new_file.css"/>
	<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/css/component.css" />
	<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/js/tabulous.js" ></script>
	<script>
	$(function(){
		$('.tabs').tabulous({
			effect: 'scale'
	...
	<div class="silver-bar">
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_01.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_02.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_03.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_04.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_05.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_06.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_07.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_08.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_09.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_10.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_11.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_12.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_13.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_14.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_15.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_16.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_17.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_18.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_19.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_20.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_21.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_22.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_23.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_24.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_25.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_26.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_27.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_28.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_29.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmb_30.jpg" alt="" />
	</div>


	<div class="btn-play">
		<img class="md-trigger" data-modal="modal-from1" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/images/rmbfudong_02.jpg"/>
	</div>
...
<!--	                  <p class="postage">由于图书贵重，邮费需自理哦（9.9元）</p>-->
	...
	<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/js/classie.js"></script>
	<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161019_2/js/modalEffects.js"></script>
	<script>
...
$("#member_reg").bind("click", function() {
	...
	$.ajax({
		type:'post',
		url:"index.php?act=zhuanti&op=ad_20161019_2&action=regs",
...
$("#member_login").bind("click", function() {
	...
	$("#btnLingQu").bind("click", function() {
		...
		$.ajax({
			type:'post',
			url:"index.php?act=zhuanti&op=ad_20161019_2&action=lingqu",
