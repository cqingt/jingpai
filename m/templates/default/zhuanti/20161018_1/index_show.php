<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/css/new_file.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/css/component.css" />
<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/js/tabulous.js" ></script>
<script>
$(function(){
	$('.tabs').tabulous({
		effect: 'scale'
	...
	<div class="silver-bar">
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_01.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_02.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_03.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_04.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_05.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_06.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_07.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_08.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_09.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_10.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_11.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_12.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_13.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_14.jpg" alt="" />
		<img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmb_15.jpg" alt="" />
	</div>


	<div class="btn-play">
		<img class="md-trigger" data-modal="modal-from1" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/images/rmbfudong_02.jpg"/>
	</div>
	     			...
	     			<div class="demo formbox" id="Demo_start1" style="display:none;">
					   <h1 class="yes">恭喜您注册成功</h1>
						<span class="celebrate">
	                  	<p>恭喜您成为收藏天下会员！</p>
	                  	<p style="color: red; float: left;">账号：<strong id='user_namedf'>XXXXX</strong></p>
	                  	<p id="gong-passwordf" style="color: red; clear:both;">密码：XXXXX</p>
						<!--
						<strong style="color:#DC3B37;">您的密码为您的手机号，请及时修改</strong></p>
						-->
	                  ...
	                  <p class="postage" style="color: red;">因兑换量巨大，邮费需自理哦（9元）</p>
	...
	<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/js/classie.js"></script>
	<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161018_1/js/modalEffects.js"></script>
	<script>
...
$("#member_reg").bind("click", function() {
	...
	$.ajax({
		type:'post',
		url:"index.php?act=zhuanti&op=ad_20161018_1&action=regs",
...
$("#member_login").bind("click", function() {
	...
	$("#btnLingQu").bind("click", function() {
		...
		$.ajax({
			type:'post',
			url:"index.php?act=zhuanti&op=ad_20161018_1&action=lingqu",
...
$array['P']['title'] = "孙中山纪念币等值兑换，不需银行排队，轻松兑！";
$array['P']['imgUrl'] = '';
$array['Y']['title'] = "孙中山纪念币等值兑换，不需银行排队，轻松兑！";
$array['Y']['desc'] = "当下最热门纪念币，5元等面值兑换";
$array['Y']['imgUrl'] = '';
