<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/css/new_file.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/css/component.css" />

<div class="demo-con">
<img src="http://sctx.oss-cn-beijing.aliyuncs.com/images/ss20161101app/s_001.jpg"/>
<img src="http://sctx.oss-cn-beijing.aliyuncs.com/images/ss20161101app/s_002.jpg"/>
    ...
    <ul class="shopbox">
        <li>
            <a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=36521">
                ...
                <div class="imgbox"><p class="img" style="background: url(<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/images/pic_01.jpg)"></p></div>
                <h2>五大名窑品茗杯套装</h2>
                <div class="bxocom">
                    <span>
                        <p>惊爆价</p>
        ...
        <li>
            <a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=17163">
                ...
                <div class="imgbox"><p class="img" style="background: url(<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/images/pic_02.jpg)"></p></div>
                <h2>冰裂紫砂茶具套装</h2>
                <div class="bxocom">
                    <span>
                        <p>惊爆价</p>
        ...
        <li>
            <a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=34192">
                ...
                <div class="imgbox"><p class="img" style="background: url(<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/images/pic_04.jpg)"></p></div>
                <h2>天然玉化砗磲手串</h2>
                <div class="bxocom">
                    <span>
                        <p>惊爆价</p>
        ...
        <li>
            <a href="http://m.96567.com/index.php?act=goods&op=index&goods_id=27276">
                <i class="icon-zuidi"></i>
                <div class="imgbox"><p class="img" style="background: url(<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/images/pic_03.jpg)"></p></div>
                <h2>天然黑石手链</h2>
                <div class="bxocom">
                    <span>
                        <p>惊爆价</p>
...
<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/js/classie.js"></script>
<script src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161101_1/js/modalEffects.js"></script>
<script>
