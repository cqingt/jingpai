<link rel="stylesheet" type="text/css" href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20161207/css/new_file.css"/>
...
<div class="chicken-bar">
	...
	<div id="chickenNav" class="fochickenox">
		<form id="form1" class="form" action="<?php echo urlWap('zhuanti','ad_20161207',array('ua'=>$_GET['ua']?$_GET['ua']:'m','action'=>'lingqu'));?>" method="post">
		<h4>填写收货信息</h4>
      <span class="item">
...
$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20161207/images/1207.jpg";
$array['Y']['title'] = "2017鸡年纯金大红包";
$array['Y']['desc'] = "2017鸡年纯金大红包限量发售！建国钞、人民币设计大师亲自设计，奢华纯金，送礼有面子！";
$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20161207/images/1207.jpg";
