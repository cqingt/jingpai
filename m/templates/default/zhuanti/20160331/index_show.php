<link href="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/css/index.css" rel="stylesheet">
<div class="header">
     <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/images/header.jpg" alt="">
</div>

<div class="synopsis">
     <div class="syn-text">
         <h2>《 抗战胜利70周年纪念币简介 》</h2>
         <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/images/rmb.jpg" alt="">
...
<div class="get">
     <img class="getimgbj" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/images/up.jpg" alt="">
     <div class="getbox">
       <div>
          <img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/images/get.jpg" alt="">
     ...
     <img class="getimgbj" src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/images/down.jpg" alt="">
</div>
...
<script>
    $("#btnOne").bind("click", function(event) {
		...
		$.ajax({
			type:'post',
			url:"index.php?act=zhuanti&op=ad_20160331&action=yanzhengone",
...
<a class="btn" href="http://m.96567.com/"><img src="<?php echo MOBILE_TEMPLATES_URL;?>/zhuanti/20160331/images/btn.jpg" alt=""></a>
...
$array['P']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160314/images/weixinfen.jpg";
$array['Y']['title'] = "抗战胜利70周年纪念币免费领取";
$array['Y']['desc'] = "收藏天下注册免费送抗战胜利70周年币一套，名额有限，速来！";
$array['Y']['imgUrl'] = MOBILE_TEMPLATES_URL."/zhuanti/20160314/images/weixinfen.jpg";
