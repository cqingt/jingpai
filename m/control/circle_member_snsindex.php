...
class circle_member_snsindexControl extends BaseMemberControl {
...
//			showDialog(Language::get('sns_share_fail'),'','error');
	 ...
	 *add time 2016-12-01
	 * */
	public function collection_goodsOp(){

		$order_model = Model('order');
		$condition = array();
		$condition['buyer_id'] = $_GET['mid'];
	...
	public function collection_storeOp(){
		//查询收藏店铺信息
		$favorites_model = Model('favorites');
		$condition = array();
		$condition['member_id'] = $_GET['mid'];
