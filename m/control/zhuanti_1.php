...
class zhuanti_1Control extends mobileHomeControl {
	private $ZtModel;
	...
	public function ad_20161123Op(){
		...
		if(chksubmit(true)){
			...
			if($retuen_type == 1){
				...
				echo '<script>alert(\'您已提交成功1，客服人员会尽快与您取得电话联系 咨询请拨400-81-96567客服热线!\');window.location.href=\'http://m.96567.com/index.php?act=zhuanti_1&op=ad_20161123\';</script>';
				exit();
			}else{
				echo '<script>alert(\'您已提交成功2，客服人员会尽快与您取得电话联系 咨询请拨400-81-96567客服热线!\');window.location.href=\'http://m.96567.com/index.php?act=zhuanti_1&op=ad_20161123\';</script>';
				exit();
			}
