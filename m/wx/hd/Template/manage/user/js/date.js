...
'a:hover{height:17px;padding-top:1px;border:1px solid #0099cc;background:#FFF;}'+
'.CurrentDate {height:17px;padding-top:1px;border:1px solid #0099cc;background: #FFF;}'+
...
'#Tools {width:204px;background:#09a1d0;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #006699;background:#0592c2;}'+
'#Title {width:204px;background:#eaf8fd;border-bottom:1px solid #82d1f0;}'+
...
'<div id="SelectYear" style="left:31px;" onclick="ShowSelect(\'SelectYear\',\'Y\');"><div id="Select"><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Up\\\',\\\'Y\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-bottom:1px solid #0099cc;"><font face="Webdings">5</font></a><div id="SelectYearItem">'+
