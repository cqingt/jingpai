...
class UPOP
{
    ...
    function get_code($order, $payment)
    {
		...
		$param['frontEndUrl']           = 'http://w.96567.com/lib/control/main/respond.class.php?code='.basename(__FILE__, ".php").'';   // 前台回调URL
		$param['backEndUrl']            = 'http://w.96567.com/lib/control/main/respond.class.php?code='.basename(__FILE__, ".php").'';    // 后台回调URL
