...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="<?php echo ($info["img"]); ?>" name="img" style="width:500px" >  <script src="<?php echo C('site_url');?>/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a></TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
