...
<script type="text/javascript" src="<?php echo C('site_url');?>/tpl/static/audioplayer/inc/jquery.jplayer.min.js"></script>
    <script type="text/javascript" src="<?php echo C('site_url');?>/tpl/static/audioplayer/inc/jquery.mb.miniPlayer.js"></script>
