...
<meta name="Keywords" content="Lanuu微信营销系统" />
<meta name="Description" content="Lanuu微信营销系统" />
            	...
            	<form name="form1" method="post" action="<?php echo U('Admin/insert');?>" id="form1" class="myform">
                	...
                	<fieldset>
                    	...
                    	<p>
                        	...
                        	<span class="chk_img"><img src="<?php echo U('Admin/verify');?>" id="imgCheckB" onclick="javascript:refresh();" /></span>
...
<!--footer-->
<div class="footer pt30" style="font-family:Arial, Helvetica, sans-serif;">
	CopyRight &copy 2014 百成互联科技
</div>
</body>
</html>