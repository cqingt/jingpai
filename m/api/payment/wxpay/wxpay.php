...
class wxpay extends weixinPAYBASE{
    ...
    public function __construct($payment_info = array(), $order_info = array()) {
        ...
        // $_SESSION['openid'] = 'ocmCHjo6Ji2fLljqKXwo2rwmQH68';

        parent::__construct($_SESSION['openid']);
    ...
    public function submit() {
        ...
        $this->setParameter('notify_url',M_SITE_URL.'/api/payment/wxpay/notify_url.php');//通知页面
