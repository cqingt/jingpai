<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li><a href="index.php?act=article&op=article" class="current"><span><?php echo $lang['nc_manage'];?></span></a></li>
                <li><a href="index.php?act=article&op=article_add" ><span><?php echo $lang['nc_new'];?></span></a></li>
                <li><a href="JavaScript:void(0);" class="current"><span><?php echo '服务中心焦点区';?></span></a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="homepage-focus" id="homepageFocusTab">
        <form id="upload_screen_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=service&op=screen_pic" target="upload_pic">
