	...
	public function settingOp(){
		...
		if (chksubmit()){
			...
			if ($error != ''){
                ...
                $update_array['show_goods_marketprice'] = $_POST['show_goods_marketprice']; //add 前台是否显示原价 xin 20151216
                $update_array['groupbuy_allow'] = $_POST['groupbuy_allow'];
                $update_array['miaosha_allow'] = $_POST['miaosha_allow']; //add 秒杀模块  xin  秒杀开关
                $update_array['vipsale_allow'] = $_POST['vipsale_allow']; //add 会员特价模块  xin  开关 20151127
