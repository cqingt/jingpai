		...
		'left' =>array(
			...
			3 => array(
				...
				'list' => array(
                    ...
                    array('args'=>'index,store_dengji,store',						'text'=>'入驻登记'),
				)
			),
			4 => array(
				'nav' => 'member',
			...
			5 => array(
				...
				'list' => array(
					...
					array('args'=>'index,shangjia_order,trade',				        'text'=>'商家订单'),
                    array('args'=>'index,lepai_order,trade',				    'text'=>'乐拍订单'),
					...
					array('args'=>'yijia,yijia,trade',			'text'=>"议价管理"),
			...
			6 => array(
				...
				'list' => array(
					...
					array('args'=>'artist,artist,website',					'text'=>'艺术家官网'),
					array('args'=>'artist_web,artist_web,website',					'text'=>'艺术家首页管理'),
				)
			),
			7 => array(
				'nav' => 'operation',
				...
				'list' => array(
					...
					array('args'=>'index,toupiao,operation',			    'text'=>'投票管理'),
					array('args'=>'index,push_user_gift,operation',			    'text'=>'藏豆管理'),
					array('args'=>'groupbuy_template_list,groupbuy,operation',	'text'=>"藏品惠管理"),
                    //add 秒杀模块 xin
                    array('args'=>'miaosha_template_list,miaosha,operation',	'text'=>$lang['nc_miaosha_manage']),
                    //add end

                    /*乐拍*/
                    array('args'=>'index,lepai,operation','text'=>'拍卖惠管理'),
                    /*End*/

                    //add 会员特价模块 xin 20151130
                    array('args'=>'vipsale_template_list,vipsale,operation',	'text'=>'会员特价管理'),
                    //add end
					...
					/* Add is name lt 2016-09-22 类目成交管理*/
					array('args'=>'index,category,operation',					    'text'=>'成交管理'),
					/* End */

					array('args'=>'index,vr_bill,operation',					'text'=>'虚拟订单结算'),
					array('args'=>'index,promotion,operation',					'text'=>$lang['nc_promotion']),
                    ...
                    array('args'=>'index,zhuantiad,operation',                   'text'=>'专题管理')
				)
			),
			8 => array(
				'nav' => 'stat',
...
//				'text' => $lang['nc_questions'],
//				'list' => array(
//					array('args'=>'homepage,questions,questions',			'text'=>$lang['nc_questions_home_page']),
//					array('args'=>'integral,questions,questions',			'text'=>$lang['nc_questions_integral']),
//					array('args'=>'search,questions,questions',			'text'=>$lang['nc_questions_search']),
//					array('args'=>'navigation,questions,questions',		'text'=>$lang['nc_questions_navigation']),
//					array('args'=>'user,questions,questions',				'text'=>$lang['nc_questions_user']),
//					array('args'=>'question,questions,questions',			'text'=>$lang['nc_questions_question']),
//					array('args'=>'category,questions,questions',			'text'=>$lang['nc_questions_category']),
//					array('args'=>'label,questions,questions',			'text'=>$lang['nc_questions_label']),
//					array('args'=>'wordfilter,questions,questions',			'text'=>$lang['nc_questions_word_filter']),
//					array('args'=>'announcement,questions,questions',			'text'=>$lang['nc_questions_announcement']),
//					array('args'=>'advertisement,questions,questions',			'text'=>$lang['nc_questions_advertisement']),
//					array('args'=>'rectification,questions,questions',			'text'=>$lang['nc_questions_rectification']),
//					array('args'=>'updates,questions,questions',			'text'=>$lang['nc_questions_cached_updates']),
//				)
//			),
		)
);
...
if(C('mobile_isuse')){
	...
	$arr['left'][] = array(
				...
				'list' => array(
					...
					array('args'=>'index_edit,mb_yishujia,mobile',				'text'=>'书画馆首页编辑'),
				)
			);
}
