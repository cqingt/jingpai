...
$_limit =  array(
	...
	array('name'=>$lang['nc_store'], 'child'=>array(
        ...
        array('name'=>'入驻登记', 'op'=>null, 'act'=>'store_dengji'),
		)),
	...
	array('name'=>$lang['nc_trade'], 'child'=>array(
		...
		array('name'=>'商家订单', 'op'=>null, 'act'=>'shangjia_order'),
        array('name'=>'乐拍订单', 'op'=>null, 'act'=>'lepai_order'),
		...
		array('name'=>"议价管理", 'op'=>null, 'act'=>'yijia'),
	...
	array('name'=>$lang['nc_website'], 'child'=>array(
		...
		array('name'=>'友情连接', 'op'=>null, 'act'=>'link'),
		array('name'=>'艺术家官网', 'op'=>null, 'act'=>'artist'),
		array('name'=>'艺术家首页管理', 'op'=>null, 'act'=>'artist_web|web_api'),
		)),
	array('name'=>$lang['nc_operation'], 'child'=>array(
		array('name'=>$lang['nc_operation_set'], 'op'=>null, 'act'=>'operation'),
		array('name'=>'投票管理', 'op'=>null, 'act'=>'toupiao'),
		array('name'=>'藏豆管理', 'op'=>null, 'act'=>'push_user_gift'),
		array('name'=>'藏品惠管理', 'op'=>null, 'act'=>'groupbuy'),
        array('name'=>'秒杀管理', 'op'=>null, 'act'=>'miaosha'),
        array('name'=>'拍卖惠管理', 'op'=>null, 'act'=>'lepai|web_api'),
        array('name'=>'会员特价管理', 'op'=>null, 'act'=>'vipsale'),
    ...
    //问答系统
    array('name'=>$lang['nc_questions'], 'child'=>array(
        array('name'=>$lang['nc_questions_home_page'], 'op'=>'homepage', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_integral'], 'op'=>'integral', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_search'], 'op'=>'search', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_navigation'], 'op'=>'navigation', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_user'], 'op'=>'user', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_question'], 'op'=>'question', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_category'], 'op'=>'category', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_label'], 'op'=>'label', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_word_filter'], 	'op'=>'wordfilter', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_announcement'], 	'op'=>'announcement', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_advertisement'], 	'op'=>'advertisement', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_rectification'], 	'op'=>'rectification', 'act'=>'questions'),
        array('name'=>$lang['nc_questions_cached_updates'], 	'op'=>'updates', 'act'=>'questions'),
    )),
);
...
if (C('mobile_isuse') !== NULL){
	$_limit[] = array('name'=>$lang['nc_mobile'], 'child'=>array(
		...
		array('name'=>'书画馆首页编辑', 'op'=>NULL, 'act'=>'mb_yishujia'),
		));
}
