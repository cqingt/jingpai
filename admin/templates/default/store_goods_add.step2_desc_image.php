<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?act=goods_edit&op=pic_list&item=des&store_id=<?php echo $output['store_id']?>" style="display:none;"><?php echo $lang['nc_submit'];?></a>
