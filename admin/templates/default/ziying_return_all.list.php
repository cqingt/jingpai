...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="JavaScript:void(0);" class="current"><span><?php echo '自营客户审核';?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="ziying_return_all" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?act=return&op=ziying_view&return_id=<?php echo $val['refund_id']; ?>"> 审核 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
