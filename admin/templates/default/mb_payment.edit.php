  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_payment', 'payment_save');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <?php } ?>
		<?php if ($output['payment']['payment_code'] == 'jdpay') { ?>
            <tr>
                <td colspan="2" class="required"><label class="validation">京东商户号：</label> </td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="merchantNum" id="merchantNum" value="<?php echo $output['payment']['payment_config']['merchantNum'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
            <tr>
                <td colspan="2" class="required"><label class="validation">商户DES密钥: </label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="desKey" id="desKey" value="<?php echo $output['payment']['payment_config']['desKey'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
			<tr>
                <td colspan="2" class="required"><label class="validation">商户MD5密钥: </label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="md5Key" id="md5Key" value="<?php echo $output['payment']['payment_config']['md5Key'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
