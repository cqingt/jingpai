    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <th><label for="owner_and_name">开始时间</label></th>
          <td><input type="text" id="sdate" name="sdate" class="txt date" value="<?php echo $_GET['sdate'];?>" ></td>
          <th><label for="owner_and_name">结束时间</label></th>
          <td><input type="text" id="edate" name="edate" class="txt date" value="<?php echo $_GET['edate'];?>" ></td>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w72 align-center">
              ...
              &nbsp;&nbsp; <a href="index.php?act=store&op=del_join&id=<?php echo $v['member_id']?>" onclick="return confirm('您确认要删除此申请吗？');">删除</a>
               <?php } ?>
          </td>
        </tr>
        <?php } ?>
