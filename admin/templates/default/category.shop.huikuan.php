...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      <h3>成交管理</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=category&op=index"><span>类目销售额统计</span></a></li>
        ...
        <li><a href="JavaScript:void(0);" class="current"><span>频道回款统计</span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="shopHuikuan" />
...
<!--   <table class="table tb-type2" id="prompt">
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      <?php if(!empty($output['tuangou_list']) || !empty($output['miaosha_list'])){?>




<?php if(!empty($output['tuangou_list'])){?>

      <tr class="hover">
        <td>团购</td>
        <td style="text-align:right;"><?php echo $output['tuangou_list']['pay_num'];?></td>
        <td style="text-align:right;"><?php echo sprintf("%.2f",$output['tuangou_list']['pay_commis_rate']);?></td>
        <td class="nowrap align-center"><?php echo $output['tuangou_list']['count_order'];?></td>
        <td class="align-center">
                    <a href="index.php?act=category&op=shopCountInfo&hui=1&class_type=1&gc_id_1=<?php echo $output['gc_id_1'];?>&store_name=<?php echo $_GET['store_name'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
...
<?php if(!empty($output['miaosha_list'])){?>
      <tr class="hover">
        <td>秒杀</td>
        <td style="text-align:right;"><?php echo $output['miaosha_list']['pay_num'];?></td>
        <td style="text-align:right;"><?php echo sprintf("%.2f",$output['miaosha_list']['pay_commis_rate']);?></td>
        <td class="nowrap align-center"><?php echo $output['miaosha_list']['count_order'];?></td>
        <td class="align-center">
                    <a href="index.php?act=category&op=shopCountInfo&hui=1&class_type=2&gc_id_1=<?php echo $output['gc_id_1'];?>&store_name=<?php echo $_GET['store_name'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
