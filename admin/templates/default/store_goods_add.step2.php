...
<!--[if IE 7]>
<link rel="stylesheet" href="<?php echo BASE_SITE_URL;?>/shop/resource/font/font-awesome/css/font-awesome-ie7.min.css">
<![endif]-->
...
<![endif]-->
<script src="<?php echo BASE_SITE_URL;?>/shop/resource/js/store_goods_add.adminstep2.js"></script>
...
<div class="page">
<div class="tabmenu">
    <ul class="tab pngFix"  style="padding:0;">
      <?php /*if(is_array($output['member_menu']) and !empty($output['member_menu'])) {
        ...
        */?>
        <li class="active"><a href="index.php?act=goods_edit&op=edit_goods&commonid=<?php echo $output['commonid'];?>&store_id=<?php echo $output['store_id'];?>">编辑商品</a></li><li class="normal"><a href="index.php?act=goods_edit&op=edit_image&commonid=<?php echo $output['commonid'];?>&store_id=<?php echo $output['store_id'];?>">编辑图片</a></li>
    </ul>
</div>
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlAdmin('goods_edit', 'edit_save_goods');} else { echo urlAdmin('goods_edit', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        ...
        <dd id="gcategory"> <?php echo $output['goods_class']['gc_tag_name'];?> <a class="ncsc-btn" href="<?php if ($output['edit_goods_sign']) { echo urlAdmin('goods_edit', 'edit_class', array('commonid' => $output['goods']['goods_commonid'],'store_id'=>$output['goods']['store_id'], 'ref_url' => getReferer())); } else { echo urlAdmin('goods_edit', 'add_step_one'); }?>"><?php echo $lang['nc_edit'];?></a>
      ...
      <dl nc_type="spec_group_dl_<?php echo $i;?>" nctype="spec_group_dl" class="spec-bg" <?php if($k == '1'){?>spec_img="t"<?php }?>>
        ...
        <dd <?php if($k == '1'){?>nctype="sp_group_val"<?php }?>>
          <ul class="spec">
            ...
            <?php }?>
            <?php }?>
            <li data-param="{gc_id:<?php echo $output['goods_class']['gc_id'];?>,sp_id:<?php echo $k;?>,url:'<?php echo urlAdmin('goods_edit', 'ajax_add_spec', array('store_id'=>$output['store_id']));?>'}">
          ...
          <div class="ncsc-goods-default-pic">
            <div class="goodspic-uplaod">
              ...
              <div class="handle">
                ...
                <a class="ncsc-btn mt5" nctype="show_image" href="<?php echo urlAdmin('goods_edit', 'pic_list', array('item'=>'goods','store_id'=>$output['store_id']));?>"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_goods_demo" class="ncsc-btn mt5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
            </div>
          </div>
          <div id="demo"></div>
        </dd>
        ...
        <dd>
          <div class="ncsc-brand-select">
            ...
            <div class="ncsc-brand-select-container">
              <div class="brand-index" data-tid="<?php echo $output['goods_class']['type_id'];?>" data-url="<?php echo urlAdmin('store_goods_add', 'ajax_get_brand');?>">
          ...
          <div class="tabs">
            ...
            <div id="panel-1" class="ui-tabs-panel" jquery1239647486215="4">
              ...
              <div class="hr8">
                ...
                <a class="ncsc-btn mt5" nctype="show_desc" href="index.php?act=goods_edit&op=pic_list&item=des&store_id=<?php echo $output['store_id'];?>"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc" class="ncsc-btn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
              <p id="des_demo"></p>
            </div>
      ...
      <dl class="special-02" nctype="virtual_null" <?php if ($output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
        ...
        <dd>
          ...
          <p class="hint vital">*F码商品不能参加团购、限时折扣和组合销售三种促销活动。也不能预售和推荐搭配。</p>
        </dd>
      </dl>
      ...
      <dl class="special-02" nctype="fcode_valid">
        <dt>
            <a class="ncsc-btn-mini ncsc-btn-red" href="<?php echo urlAdmin('goods_edit', 'download_f_code_excel', array('commonid' => $val['goods_commonid']));?>">下载F码</a>&nbsp;&nbsp;F码<?php echo $lang['nc_colon'];?></dt>
        <dd>
          <ul class="ncsc-form-radio-list">
      ...
      <dl class="special-03" nctype="virtual_null" <?php if ($output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
        ...
        <dd>
          ...
          <p class="hint vital">*预售商品不能参加团购、限时折扣和组合销售三种促销活动。也不能推荐搭配。</p>
        </dd>
      </dl>
...
<script src="<?php echo BASE_SITE_URL;?>/shop/resource/js/scrolld.js"></script>
