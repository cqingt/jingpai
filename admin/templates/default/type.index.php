...
<table class="tb-type1 noborder search">
  <tbody>
    <tr>
      ...
      <th><label for="search_commonid">商品名称</label></th>
      <td><input type="text" value="<?php echo $_GET['goods_name'];?>" name="goods_name"  class="txt" /></td>

	  <th><label for="search_commonid">分类</label></th>
