...
<table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php echo ncPriceFormat($output['store_info']['commis_rate'] *$order_info['order_amount']/100);?></td>
        <td class="align-center"><?php echo date('Y-m-d',$order_info['add_time']);?></td>

        <td class="align-center"><?php echo date('Y-m-d',$order_info['payment_time']);?></td>
        <td class="align-center"><?php echo orderPaymentName($order_info['payment_code']);?></td>
        <td class="align-center"><?php echo $order_info['trade_no'];?></td>
