...
<div class="page">
  ...
  <form method="post" id="mg_form" name="mg_form" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
        ...
        <tbody id="mg_tbody">
            <tr id="row_0">
        		<td class="w108 align-center"><?php echo $output['list_setting']['member_grade'][0]['level_name'];?></td>
        	...
        	<tr id="row_1">
        		<td class="w108 align-center"><?php echo $output['list_setting']['member_grade'][1]['level_name'];?></td>
        	...
        	<tr id="row_2">
        		<td class="w108 align-center"><?php echo $output['list_setting']['member_grade'][2]['level_name'];?></td>
        	...
        	<tr id="row_3">
        		<td class="w108 align-center"><?php echo $output['list_setting']['member_grade'][3]['level_name'];?></td>
          ...
          <tr id="row_3">
            <td class="w108 align-center"><?php echo $output['list_setting']['member_grade'][4]['level_name'];?></td>
          ...
          <tr id="row_3">
            <td class="w108 align-center"><?php echo $output['list_setting']['member_grade'][5]['level_name'];?></td>
            <td class="align-left"><input type="text" name="mg[5][exppoints]" value="<?php echo $output['list_setting']['member_grade'][5]['exppoints'];?>" class="w60" nc_type="verify" data-param='{"name":"经验值","type":"int"}'/></td>
          </tr>
