  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" >移动版<?php echo $lang['activity_index_banner'];?>:</label></td>
        </tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
            <span class="type-file-show">
              <img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png" />
              <div class="type-file-preview"><img src="<?php if(is_file(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$output['activity']['activity_banner_m'])){echo UPLOAD_SITE_URL."/".ATTACH_ACTIVITY."/".$output['activity']['activity_banner_m'];}else{echo ADMIN_SITE_URL."/templates/".TPL_NAME."/images/sale_banner.jpg";}?>" onload="javascript:DrawImage(this,500,500);"></div>
            </span>
            <span class="type-file-box">
              <input type="file" class="type-file-file" id="activity_banner_m" name="activity_banner_m" size="30" hidefocus="true"  nc_type="upload_activity_banner_m" title="<?php echo $lang['activity_index_banner'];?>">
            </span>
          </td>
          <td class="vatop tips"><?php echo $lang['activity_new_banner_tip'];?></td>
        </tr>
...
// 模拟活动页面横幅Banner上传input type='file'样式
  var textButton="<input type='text' name='textfield_m' id='textfield1_m' class='type-file-text' /><input type='button' name='button' id='button1' value='' class='type-file-button' />"
    $(textButton).insertBefore("#activity_banner_m");
  $("#activity_banner_m").change(function(){
     $("#textfield1_m").val($("#activity_banner_m").val());
  });
