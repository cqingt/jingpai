    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <?php if($v['class_parent_id'] == $val['class_id']){?>
          <tr class="hover edit">
            <td class="w24"><input type="checkbox" value="<?php echo $v['class_id'];?>" class="checkitem"></td>
            <td class="w48 sort"><span nc_type="class_sort" column_id="<?php echo $v['class_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $v['class_sort'];?></span></td>
            <td class="name">&nbsp;&nbsp;&nbsp;&nbsp;<span nc_type="class_name" column_id="<?php echo $v['class_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $v['class_name'];?></span></td>
            <td class="w72 align-center"><a href="javascript:submit_delete(<?php echo $v['class_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
          </tr>
            <?php foreach($output['list'] as $vv){ ?>
            <?php if($vv['class_parent_id'] == $v['class_id']){?>
            <tr class="hover edit">
              <td class="w24"><input type="checkbox" value="<?php echo $vv['class_id'];?>" class="checkitem"></td>
              <td class="w48 sort"><span nc_type="class_sort" column_id="<?php echo $vv['class_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $vv['class_sort'];?></span></td>
              <td class="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span nc_type="class_name" column_id="<?php echo $vv['class_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $vv['class_name'];?></span></td>
              <td class="w72 align-center"><a href="javascript:submit_delete(<?php echo $vv['class_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
            </tr>
            <?php } ?>
            <?php } ?>
