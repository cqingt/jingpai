  ...
  <form id="goods_class_form" name="goodsClassForm" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <!-- add 是否开放此分类给第三方店铺展示 xin 20151104-->
        <tr>
            <td colspan="2" class="required"><label>分类开放第三方:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><label>
                    <input type="checkbox" name="gc_isopen" id="gc_isopen" <?php echo ($output['class_array']['gc_isopen'] == 1)?'checked="checked"':'';?> > 开放</label></td>
            <td class="vatop tips">勾选后，此分类在第三方商家后台可见，商家可以申请此类目。</td>
        </tr>
        <!-- add end-->
        <tr>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation">艺术家:</label>
            <span>
            <label for="t_associated">
              <input class="checkbox" type="checkbox" name="is_artist" value="1" id="is_artist" <?php if($output['class_array']['is_artist'] == 1){ echo "checked='checked'";}?>/>
              是否关联艺术家</label>
            </span></td>
        </tr>

        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="gc_name">首页二级分类显示个数:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['class_array']['is_two_class'];?>" name="is_two_class" id="is_two_class" maxlength="20" class="txt"></td>
          <td class="vatop tips">限制首页左边列表二级分类显示的个数</td>
        </tr>
