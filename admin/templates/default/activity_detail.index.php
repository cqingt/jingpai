      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="16" id="batchAction">
              ...
              自定义分类名称：<input type="text" name="cat_name" id="cat_name" class="txt" value=""><a href="JavaScript:void(0);" class="btn" onclick="javascript:submit_form('update_cat');"><span>修改</span></a>&nbsp;&nbsp;&nbsp;|&nbsp;
...
function submit_form(op){
	...
	}else if(op=='update_cat'){
        $('#listform').attr('action','index.php?act=activity&op=update_cat');
    }
	$('#listform').submit();
}
</script>
