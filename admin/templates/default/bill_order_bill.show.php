...
<div class="fixed-empty"></div>  
    <table class="table tb-type2 noborder search">
      ...
      <td>平台应付金额：<?php echo $output['bill_info']['ob_result_totals'];?> = <?php echo $output['bill_info']['ob_order_totals'];?> (订单金额<?php echo ($output['bill_info']['ob_order_totals']-$output['bill_info']['ob_leipai_order_totals']).'+乐拍订单金额'.$output['bill_info']['ob_leipai_order_totals']."+乐拍返还保证金".$output['bill_info']['ob_leipai_bao_totals'];?> ) - <?php echo $output['bill_info']['ob_commis_totals'];?> (佣金金额<?php echo ($output['bill_info']['ob_commis_totals']-$output['bill_info']['ob_leipai_commis_totals']).'+乐拍佣金'.$output['bill_info']['ob_leipai_commis_totals'];?>) - <?php echo $output['bill_info']['ob_order_return_totals'];?> (退单金额) + <?php echo $output['bill_info']['ob_commis_return_totals'];?> (退还佣金) - <?php echo $output['bill_info']['ob_store_cost_totals'];?> (店铺促销费用)</td>
      </tr>
	  ...
	  <tr><td>结算银行开户名<?php echo $lang['nc_colon'];?><?php echo $output['joinin_detail']['settlement_bank_account_name'];?></td></tr>
	   <tr><td>	结算银行账号<?php echo $lang['nc_colon'];?><?php echo $output['joinin_detail']['settlement_bank_account_number'];?></td></tr>
	   <tr><td>	结算开户银行支行名称<?php echo $lang['nc_colon'];?><?php echo $output['joinin_detail']['settlement_bank_name'];?></td></tr>
	   <tr><td>	结算支行联行号<?php echo $lang['nc_colon'];?><?php echo $output['joinin_detail']['settlement_bank_code'];?></td></tr>
	   <tr><td>	结算开户银行所在地<?php echo $lang['nc_colon'];?><?php echo $output['joinin_detail']['settlement_bank_address'];?></td></tr>
      </tbody>
    </table>
