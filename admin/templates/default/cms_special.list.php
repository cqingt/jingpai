      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w120 align-center">
              ...
              <?php if($val['special_on'] == '0') { ?> 
              <a href="index.php?act=cms_special&op=cms_special_on&on=1&special_id=<?php echo $val['special_id'];?>">开启</a>
              <?php } else { ?>
              <a href="index.php?act=cms_special&op=cms_special_on&on=0&special_id=<?php echo $val['special_id'];?>">关闭</a>
              <?php } ?>
