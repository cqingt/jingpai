...
<div class="page">
  ...
  <div class="fixed-bar">
    ...
    <form id="form1" method="post" enctype="multipart/form-data" >
        ...
        <input type="hidden" name="op" value="tuijian_add" />
        ...
        <table class="table tb-type2">
            ...
            <tr>
                <td colspan="2" class="required"><label class="validation" for="price">折后价:</label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" name="price" id="price" class="txt" value="<?php echo $output['cangdou_info']['price'];?>"/></td>
                <td class="vatop tips"></td>
            </tr>

			<tr>
                <td colspan="2" class="required"><label class="validation" for="number">数量:</label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" name="number" id="number" class="txt" value="<?php echo $output['cangdou_info']['number'];?>"/></td>
                <td class="vatop tips"></td>
            </tr>

			<tr>
                <td colspan="2" class="required"><label class="validation" for="number">每人可购买数量:</label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" name="member_number" id="member_number" class="txt" value="<?php echo $output['cangdou_info']['member_number'];?>"/></td>
                <td class="vatop tips"></td>
            </tr>
			...
			<tr>
                <td colspan="2" class="required"><label class="validation" for="is_tuijian">是否推荐:</label></td>
            </tr>
            <tr class="noborder">

                <td class="vatop rowform">
				<input type="checkbox" name="is_tuijian" id="is_tuijian" value='1' <?php if($output['cangdou_info']['is_tuijian'] == 1){ echo 'checked="checked"'; }?>>
				</td>
                <td class="vatop tips"></td>
            </tr>
