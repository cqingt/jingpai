  ...
  <form id="post_form" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <?php } elseif ($output['payment']['payment_code'] == 'bank') { ?>
            <tr>
                <td colspan="2" class="required">银行转账内容: </td>
            </tr>
            <tr class="noborder"><input type="hidden" name="config_name" value="bank_content" />
                <td class="vatop rowform"><?php showEditor('bank_content', $output['config_array']['bank_content']); ?></td>
                <td class="vatop tips"></td>
            </tr>
            <!--add 微信支付 xin 20151120-->
        <?php } elseif ($output['payment']['payment_code'] == 'wxpay') { ?>
            ...
            <tr class="noborder">
                ...
                <td class="vatop tips">绑定支付的APPID</td>
            </tr>
            <tr>
            ...
            <tr class="noborder">
                ...
                <td class="vatop tips">商户支付密钥，参考开户邮件设置</td>
            </tr>
        <?php } ?>
        <!--微信支付end-->
        <tr>
