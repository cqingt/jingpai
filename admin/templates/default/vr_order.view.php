        ...
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                ...
                <td class="w50pre"><p><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $output['order_info']['goods_id'];?>" target="_blank"><?php echo $output['order_info']['goods_name'];?></a></p><p><?php if ($output['order_info']['order_promotion_type'] == 1) {?>团购，<?php } ?>使用时效：即日起 至 <?php echo date("Y-m-d",$output['order_info']['vr_indate']);?>
