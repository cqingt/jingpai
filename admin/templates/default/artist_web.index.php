  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="index.php?act=artist_web&op=sale_edit&web_id=216"><span><?php echo '促销专区';?></span></a></li>
		<li><a href="index.php?act=artist_web&op=tuijian_edit&web_id=217"><span><?php echo '艺术家推荐';?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><a href="index.php?act=artist_web&op=web_edit&web_id=<?php echo $v['web_id'];?>"><?php echo $lang['web_config_web_edit'];?></a> | 
          	<a href="index.php?act=artist_web&op=code_edit&web_id=<?php echo $v['web_id'];?>"><?php echo $lang['web_config_code_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
