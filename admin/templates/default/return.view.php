  ...
  <div class="fixed-empty"></div>
    <table class="table tb-type2">
      <tbody>
		...
		<?php if($output['return']['invoice_no']){ ?>
		<tr>
          <td colspan="2" class="required">快递信息：</td>
        </tr>
		<tr class="noborder">
          <td class="vatop rowform"><?php echo "公司：".$output['return']['express_name']."&nbsp;快递编号：".$output['return']['invoice_no'];?></td>
          <td class="vatop tips"></td>
        </tr>
		<?php } ?>

		<?php if($output['return']['goods_state'] == 4){ ?>
		<tr>
          <td colspan="2" class="required">发货状态：</td>
        </tr>
		<tr class="noborder">
          <td class="vatop rowform">已收货</td>
          <td class="vatop tips"></td>
        </tr>
		<?php } ?>
