    ...
    <table class="tb-type1 noborder search">
      <tbody>
        ...
        <tr>
		 ...
		 <th>订单来源</th>
         <td>
            <select name="order_from" class="w100">
            <option value=""><?php echo $lang['nc_please_choose'];?></option>
           
            <option <?php if($_GET['order_from'] == 1){?>selected<?php }?> value="1">pc站</option>
			<option <?php if($_GET['order_from'] == 2){?>selected<?php }?> value="2">手机站</option>
            
            </select>
         </td>

<th>支付单号</th>
         <td><input class="txt2" type="text" name="pay_sn" value="<?php echo $_GET['pay_sn'];?>" /></td> 
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php echo orderState($order);if($order['lock_state'] >= 1){echo '(锁定)';}?></td>

		<td class="align-center"><?php if($order['order_from'] == 1){ echo "pc站";}else{echo "手机站";}?></td>
