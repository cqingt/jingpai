...
<!--   <table class="table tb-type2" id="prompt">
  ...
  <div style="text-align:right;"><a class="btns" target="_blank" href="index.php?act=category&op=info&exportExcel=1&hui=<?php echo $_GET['hui'];?>&class_type=<?php echo $_GET['class_type'];?>&type=<?php echo $_GET['type'];?>&gc_id_1=<?php echo $_GET['gc_id_1'];?>&gc_id_2=<?php echo $_GET['gc_id_2'];?>&store_name=<?php echo $_GET['store_name'];?>&choose_gcid=<?php echo $_GET['choose_gcid'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>"><span><?php echo $lang['nc_export'];?>Excel</span></a></div>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="nowrap align-center"><a href="index.php?act=order&op=show_order&order_id=<?php echo $order['order_id'];?>"><?php echo $order['order_sn'];?></td>
