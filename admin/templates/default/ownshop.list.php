...
<?php foreach($output['store_list'] as $k => $v) { ?>
        <tr class="">
			<td class="w48 sort"><span title="可编辑" ajax_branch="store_sort" datatype="number" fieldid="<?php echo $v['store_id'];?>" fieldname="store_sort" nc_type="inline_edit" class="editable2"><?php echo $v['store_sort']; ?></span></td>
          <td>
