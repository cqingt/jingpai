        ...
        <tr>
		  ...
		  <td>
				<select name="is_short">
					...
					<option value="1" <?php if(intval($_GET['is_short']) == 1){ echo 'selected'; } ?>>自营店铺</option>
					<option value="2" <?php if(intval($_GET['is_short']) == 2){ echo 'selected'; } ?>>商家店铺</option>
					<option value="3" <?php if(intval($_GET['is_short']) == 3){ echo 'selected'; } ?>>代运营店铺</option>
				</select>
		   </td>

		   <td>
				<select name="is_huifu">
					<option value="0">全部</option>
					<option value="1" <?php if(intval($_GET['is_huifu']) == 1){ echo 'selected'; } ?>>已回复</option>
					<option value="2" <?php if(intval($_GET['is_huifu']) == 2){ echo 'selected'; } ?>>未回复</option>
				</select>
		  </td>
