    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li ><strong><?php echo $lang['admin_pointorder_info_shipinfo_description'];?>:</strong><?php echo $output['order_info']['point_shippingdesc'];?></li>
            <?php }?>
            

          <?php if ($output['express_info']['e_name'] != ''){?>
            <li ><strong>物流公司:</strong><?php echo $output['express_info']['e_name'];?></li>
<?php }?>
