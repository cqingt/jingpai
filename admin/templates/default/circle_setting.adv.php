...
<div class="page">
  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr>
          <td class="required"><label><?php echo $lang['circle_setting_adv'];?>-01:</label></td><td><?php echo $lang['circle_setting_adv_url_address'];?>:</td><td>标题:</td>
        </tr>
        <tr class="noborder">
		  ...
		  <td class="vatop tips">
		  <input type="text" name="adv_title1" value="<?php echo $output['list'][1]['adv_title'];?>" style=" width:300px;">
		 
          </td>
        </tr>
        <tr>
          <td class="required"><label><?php echo $lang['circle_setting_adv'];?>-02:</label></td><td><?php echo $lang['circle_setting_adv_url_address'];?>:</td><td>标题:</td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips"><input class="txt" type="text" name="adv_url2" value="<?php echo $output['list'][2]['url'];?>" style=" width:300px;">
		   ...
		   <td class="vatop tips">
		  <input type="text" name="adv_title2" value="<?php echo $output['list'][2]['adv_title'];?>" style=" width:300px;">
		 
          </td>
        </tr>
        <tr>
          <td class="required"><label><?php echo $lang['circle_setting_adv'];?>-03:</label></td><td><?php echo $lang['circle_setting_adv_url_address'];?>:</td><td>标题:</td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips">
		   ...
		   <td class="vatop tips">
		  <input type="text" name="adv_title3" value="<?php echo $output['list'][3]['adv_title'];?>" style=" width:300px;">
		 
          </td>
        </tr>
        <tr>
          <td class="required"><label><?php echo $lang['circle_setting_adv'];?>-04:</label></td><td><?php echo $lang['circle_setting_adv_url_address'];?>:</td><td>标题:</td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips">
            <input class="txt" type="text" name="adv_url4" value="<?php echo $output['list'][4]['url'];?>" style=" width:300px;">
		     ...
		     <td class="vatop tips">
		  <input type="text" name="adv_title4" value="<?php echo $output['list'][4]['adv_title'];?>" style=" width:300px;">
