...
<div class="page"> 
  ...
  <form id="form_item" action="<?php echo urlAdmin('mb_yishujia', 'special_item_save');?>" method="post">
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><a id="btn_save" class="btn" href="javascript:;"><span>保存编辑</span></a>
            ...
            <a id="btn_back" href="<?php echo urlAdmin('mb_yishujia', 'index_edit', array('special_id' => $output['item_info']['special_id']));?>" class="btn"><span>返回上一级</span></a>
            <?php } else { ?>
            <a id="btn_back" href="<?php echo urlAdmin('mb_yishujia', 'index_edit');?>" class="btn"><span>返回上一级</span></a>
            <?php } ?></td>
        </tr>
      </tfoot>
    </table>
...
<script type="text/javascript">
    var url_upload_image = '<?php echo urlAdmin('mb_yishujia', 'special_image_upload');?>';
