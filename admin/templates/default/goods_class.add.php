  ...
  <form id="goods_class_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><label>
                    <input type="checkbox" name="gc_isopen" id="gc_isopen" checked="checked"> 开放</label></td>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation">艺术家:</label>
            ...
            <label for="t_associated">
              <input class="checkbox" type="checkbox" name="is_artist" value="1" id="is_artist" />
              是否关联艺术家</label>
            </span></td>
        </tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="3" name="is_two_class" id="is_two_class" maxlength="20" class="txt"></td>
