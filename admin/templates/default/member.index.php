    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <td>开始时间：<input style="width:100px;" type="text" value="<?php echo $output['search_begin_time'];?>" name="search_begin_time" id="search_begin_time" class="txt"><br />结束时间：<input style="width:100px;" type="text" value="<?php echo $output['search_end_time'];?>" name="search_end_time" id="search_end_time" class="txt"></td>

          <td>
            <?php if(!empty($output['member_from'])){?>
                注册来源: <select name="search_field_regfrom[]" id="search_field_regfrom" multiple="multiple">
                <?php foreach($output['member_from'] as $k => $v){?>
                    <option value="<?php echo $v['member_from'];?>" <?php
                    if(!empty($output['search_field_regfrom'])){ echo (in_array($v['member_from'],$output['search_field_regfrom'])?'selected':''); } ?>><?php echo $v['member_from'];?></option>
                <?php }?>
              </select>
            <?php }?>
          </td>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center"><?php echo $v['member_from'];?></td>
      ...
      <tfoot class="tfoot">
        ...
        <td class="w24"><input type="checkbox" class="checkall" id="checkallBottom"></td>
          ...
          <label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
           ...
           <div class="pagination"><ul><li><span style="color:#0D93BF;">总数：<?php echo $output['pageNumber']; ?></span> </li></ul></div><span ><div class="pagination"><?php echo $output['page'];?> </div></td>
        </tr>
        <?php } ?>
      </tfoot>
    </table>
