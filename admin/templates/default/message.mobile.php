      ...
      <tbody>
       <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <label>
          <input type="radio" name="mobile_host_type" value="1" <?php echo ($output['list_setting']['mobile_host_type']==1)?'checked="checked"':''; ?> />短信宝
          </label>
		  <label>
         <input type="radio" name="mobile_host_type" value="2" <?php echo ($output['list_setting']['mobile_host_type']==2)?'checked="checked"':''; ?> />
          云片网络
          </label>
		  <label>
         <input type="radio" name="mobile_host_type" value="3" <?php echo ($output['list_setting']['mobile_host_type']==3)?'checked="checked"':''; ?> />
          收藏网络短信
          </label>
