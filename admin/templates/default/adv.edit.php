  ...
  <form id="adv_form" enctype="multipart/form-data" method="post" name="advForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="adv_start_date" id="adv_start_date" class="txt date" value="<?php echo date('Y-m-d H:i',$v['adv_start_date']); ?>"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="adv_end_date" id="adv_end_date" class="txt date" value="<?php echo date('Y-m-d H:i',$v['adv_end_date']); ?>"></td>
          <td class="vatop tips"></td>
        </tr>
...
<link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_SITE_URL."/js/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.css";?>"/>
...
$(function(){
    $('#adv_start_date').datetimepicker({controlType: 'select'});
    $('#adv_end_date').datetimepicker({controlType: 'select'});
});
</script>
<script type="text/javascript">
$(function(){
