    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
		 ...
		 <tr class="noborder">
          <td colspan="2" class="required"><label for="special_keywords" class="validation">专题关键词</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input id="special_keywords" name="special_keywords" class="txt" type="text" value="<?php if(!empty($output['special_detail'])) echo $output['special_detail']['special_keywords'];?>"/></td>
          <td class="vatop tips"></td>
        </tr>

		<tr class="noborder">
          <td colspan="2" class="required"><label for="special_description" class="validation">专题描述</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input id="special_description" name="special_description" class="txt" type="text" value="<?php if(!empty($output['special_detail'])) echo $output['special_detail']['special_description'];?>"/></td>
          <td class="vatop tips"></td>
        </tr>
