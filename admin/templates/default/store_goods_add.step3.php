...
<script type="text/javascript" src="<?php echo BASE_SITE_URL;?>/shop/resource/js/seller.js"></script>
...
<!--[if lt IE 9]>
<script src="<?php echo BASE_SITE_URL;?>/data/resource/js/html5shiv.js"></script>
<script src="<?php echo BASE_SITE_URL;?>/data/resource/js/respond.min.js"></script>
<![endif]-->
<!--[if IE 6]>
<script src="<?php echo BASE_SITE_URL;?>/data/resource/js/IE6_MAXMIX.js"></script>
<script src="<?php echo BASE_SITE_URL;?>/data/resource/js/IE6_PNG.js"></script>
<script>
...
<![endif]-->
<script type="text/javascript" src="<?php echo BASE_SITE_URL;?>/data/resource/js/ToolTip.js"></script>

<div class="page main-content" id="mainContent">
    <div class="tabmenu">
        ...
        */?>
            <li class="normal"><a href="index.php?act=goods_edit&op=edit_goods&commonid=<?php echo $output['commonid'];?>&store_id=<?php echo $output['store_id'];?>">编辑商品</a></li><li class="active"><a href="index.php?act=goods_edit&op=edit_image&commonid=<?php echo $output['commonid'];?>&store_id=<?php echo $output['store_id'];?>">编辑图片</a></li>
        </ul>
    </div>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo urlAdmin('goods_edit', 'edit_save_image'); } else { echo urlShop('store_goods_add', 'save_image');}?>">
    ...
    <div class="container">
      ...
      <div class="ncsc-goodspic-list">
        ...
        <div class="ncsc-select-album">
          <a class="ncsc-btn" href="index.php?act=goods_edit&op=pic_list&item=goods_image&store_id=<?php echo $output['store_id']?>&color_id=<?php echo $value['sp_value_id'];?>" nctype="select-<?php echo $value['sp_value_id'];?>"><i class="icon-picture"></i>从图片空间选择</a>
...
<script type="text/javascript" src="<?php echo BASE_SITE_URL;?>/shop/resource/js/store_goods_add.adminstep3.js" charset="utf-8"></script>
<script>
