...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span>频道销售额统计</span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="shopCount" />
...
<?php if(!empty($output['tuangou_list'])){?>
      ...
      <tr class="hover">
        ...
        <td class="align-center">
          <a href="index.php?act=category&op=shopCountInfo&class_type=1&gc_id_1=<?php echo $output['gc_id_1'];?>&store_name=<?php echo $_GET['store_name'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
        </td>
      </tr>
...
<?php if(!empty($output['miaosha_list'])){?>
      <tr class="hover">
        ...
        <td class="align-center">
          <a href="index.php?act=category&op=shopCountInfo&class_type=2&gc_id_1=<?php echo $output['gc_id_1'];?>&store_name=<?php echo $_GET['store_name'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
        </td>
      </tr>
<?php }?>
