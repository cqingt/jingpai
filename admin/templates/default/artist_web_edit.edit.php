  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '基本设置';?></span></a></li>
        <li><a href="index.php?act=artist&op=artist_web_config_edit&web_id=<?php echo $_GET['web_id'];?>" ><span>板块编辑</span></a></li>      </ul>
    </div>
  </div>
