...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>乐拍<?php echo $lang['order_manage'];?></h3>
      <ul class="tab-base">
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center">第三方流水号</th>
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td><?php echo $output['lepaistore'][$order['store_member_id']];?></td>
        ...
        <td class="w144 align-center"><a href="index.php?act=lepai&op=orderInfo&orderid=<?php echo $order['order_id'];?>"><?php echo $lang['nc_view'];?></a>
