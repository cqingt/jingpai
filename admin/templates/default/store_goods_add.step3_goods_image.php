...
<div class="goods-gallery" nctype="gallery-<?php echo $output['color_id'];?>"> <a class="sample_demo" href="index.php?act=goods_edit&op=pic_list&item=goods_image&store_id=<?php echo $output['store_id']?>&color_id=<?php echo $output['color_id'];?>" style="display:none;"><?php echo $lang['nc_submit'];?></a>
