  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('artist', 'focus_edit');?>"><span>焦点区</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><a href="index.php?act=artist&op=artist_web_edit&web_id=<?php echo $v['web_id'];?>"><?php echo $lang['web_config_web_edit'];?></a> | 
          	<a href="index.php?act=artist&op=artist_web_config_edit&web_id=<?php echo $v['web_id'];?>"><?php echo $lang['web_config_code_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
