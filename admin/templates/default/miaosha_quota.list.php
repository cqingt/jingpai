...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" name="op" value="miaosha_quota">
  ...
  <form id="list_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
            <td></td>
            <td class="align-left"><a target="_blank" href="<?php echo urlShop('show_store','index', array('store_id'=>$val['store_id']));?>" ><span><?php echo $val['store_name'];?></span></a></td>
