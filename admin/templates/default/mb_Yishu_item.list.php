...
<script type="text/javascript">
    ...
    var url_item_add = "<?php echo urlAdmin('mb_YiShuJia', 'special_item_add');?>";
    var url_item_del = "<?php echo urlAdmin('mb_YiShuJia', 'special_item_del');?>";
    var url_item_edit = "<?php echo urlAdmin('mb_YiShuJia', 'special_item_edit');?>";
    $(document).ready(function(){
        ...
        var update_item_sort = function() {
            ...
            $.post("index.php?act=mb_YiShuJia&op=update_item_sort", {special_id: special_id, item_id_string: item_id_string}, function(data) {
                if(typeof data.error != 'undefined') {
        ...
        $('#item_list').on('click', '[nctype="btn_usable"]', function() {
            ...
            $.post("index.php?act=mb_YiShuJia&op=update_item_usable", {item_id: item_id, usable: usable, special_id: special_id}, function(data) {
                if(typeof data.error != 'undefined') {
                    showError(data.message);
                }
            }, 'json');
