    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <a href="JavaScript:void(0);" onclick="get_recommend_goods();" class="btn-search " title="<?php echo $lang['nc_query'];?>"></a>          <input name="goods_id" type="hidden" id="goods_id" value="0" />
          <input name="goods_pic" type="hidden" id="goods_pic" value="0" />
          <input name="goods_price" type="hidden" id="goods_price" value="0" />
          <input name="market_price" type="hidden" id="market_price" value="0" />
          <div id="show_recommend_goods_list" style="width:48%"></div>
          </td>
        </tr>
        <tr class="noborder">
          <td colspan="2"><label class="validation" for="promotion_title"><?php echo $lang['promotion_index_title'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="promotion_title" name="promotion_title" class="txt"></td>
          <td class="vatop tips"><?php //echo $lang['promotion_new_title_tip'];?></td>
        </tr>
        <tr style="display:none;">
          <td colspan="2" class="required"><label class="validation" ><?php echo $lang['promotion_index_type'];?>:</label></td>
        </tr>
        <tr class="noborder" style="display:none;">
          <td class="vatop rowform">
          <select name="promotion_type">
              <option value="1"><?php echo $lang['promotion_index_goods'];?></option>
              <option value="2"><?php echo $lang['promotion_index_group'];?></option>
              </optgroup>
            </select></td>
          <td class="vatop tips"><?php echo $lang['promotion_new_type_tip'];?></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label class="validation" ><?php echo $lang['promotion_index_start'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="promotion_start_date" name="promotion_start_date" class="txt date"/></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label class="validation" ><?php echo $lang['promotion_index_end'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="promotion_end_date" name="promotion_end_date" class="txt date"/></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder" style="display:none;">
          <td class="vatop rowform"><select id="promotion_style" name="promotion_style">
              <option value="default_style"><?php echo $lang['promotion_index_default'];?></option>
            </select></td>
          <td class="vatop tips"><?php echo $lang['promotion_new_style_tip'];?></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label class="validation"  for="promotion_sort"><?php echo $lang['nc_sort'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" id="promotion_sort" name="promotion_sort" class="txt" value="0"></td>
...
$(document).ready(function(){
	$("#promotion_start_date").datepicker({dateFormat: 'yy-mm-dd'});
	...
	$("#add_form").validate({
        ...
        messages : {
			...
			promotion_banner: {
        		required : '<?php echo $lang['promotion_new_banner_null'];?>',
				accept   : '<?php echo $lang['promotion_new_ing_wrong'];?>'	
			},
        	promotion_sort: {
