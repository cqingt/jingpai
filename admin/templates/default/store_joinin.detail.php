...
电子版：</th>
	  ...
	  <tr>
        <th>法人身份证<br />
电子版：</th>
        <td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_legal_person_img']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_legal_person_img']);?>" alt="" /> </a></td>
      </tr>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
