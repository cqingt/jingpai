    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <?php if(intval($output['order_info']['trade_no'])){?>
                <li><strong>第三方流水号：</strong><?php echo $output['order_info']['trade_no'];?></li>
            <?php }?>
      ...
      <tr>
        <td><ul>
            ...
            <li><strong><?php echo $lang['tel_phone'];?><?php echo $lang['nc_colon'];?></strong><?php echo @$output['order_user_info']['mob_phone'];?></li>
            <li><strong><?php echo $lang['address'];?><?php echo $lang['nc_colon'];?></strong><?php echo @$output['order_user_info']['address'];?></li>
            ...
            <?php }?>
            <li><strong><?php echo '物流信息';?><?php echo $lang['nc_colon'];?></strong><?php echo $output['order_user_info']['payment_code'];?></li>
          </ul></td>
          </tr>
        ...
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                ...
                <td class="w96 align-center"><span class="red_common"><?php echo $lang['currency'].$goods['goods_pay_price'];?></span><?php if($goods['pingtai_voucher_price'] > 0) echo "<br />+使用平台优惠劵(“".$goods['pingtai_voucher_price']."元”)" ; ?></td>
				...
				<?php if($goods['goods_costprice'] > 0 && (($goods['goods_pay_price']+$goods['pingtai_voucher_price'])*(1-$goods['commis_rate']/100)) < $goods['goods_costprice']*$goods['goods_num']) {?>
					<?php echo ($goods['goods_pay_price']+$goods['pingtai_voucher_price'])-($goods['goods_costprice']*$goods['goods_num']);?>
				<?php }else{ ?>
				<?php echo $goods['commis_rate'] == 200 ? '' : ncPriceFormat(($goods['goods_pay_price']+$goods['pingtai_voucher_price'])*$goods['commis_rate']/100);?>
				<?php } ?>
				</td>
              </tr>
              <?php }?>
