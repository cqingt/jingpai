...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=artist_code&op=artist_code"><span><?php echo '板块区';?></span></a></li>
        <li><a href="index.php?act=artist_code&op=web_edit&web_id=<?php echo $_GET['web_id'];?>"><span><?php echo $lang['web_config_web_edit'];?></span></a></li>
  ...
  <table class="table tb-type2 nohover">
      ...
      <tr class="noborder">
        <td colspan="2" class="vatop"><div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>">
            ...
            <div class="middle">
			  ...
			  <style>
							.left-y{top: 0px;left: 176px;}
							.left-y img{ width: 176px; height: 306px;}
							.left-z{top: 0px;left:0px;}
							.left-z img{width: 176px;height: 153px;}
							.middle-y{bottom: 0px;left:0px;}
							.middle-y img{width: 176px;height: 153px;}
							.right-y{top: 0px;right:176px;}
							.right-y img{width: 176px;height: 153px;}
							.bottom-y{bottom: 0; right:176px;}
							.bottom-y img{width: 176px;height: 153px;}
						</style>
                ...
                <dd>
                    ...
                    <?php } elseif (!empty($val['pic_list']) && is_array($val['pic_list'])) { ?>
                        ...
                        <div class="middle-banner">
                            <a href="javascript:void(0);" class="left-y"><img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>" title="<?php echo $val['pic_list']['11']['pic_name'];?>" pic_price="<?php echo $val['pic_list']['11']['pic_price'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a>
                           

                            <a href="javascript:void(0);" class="left-z"><img pic_url="<?php echo $val['pic_list']['12']['pic_url'];?>" title="<?php echo $val['pic_list']['12']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['12']['pic_img'];?>" pic_price="<?php echo $val['pic_list']['12']['pic_price'];?>"/></a>
                            
                            <a href="javascript:void(0);" class="middle-y"><img pic_url="<?php echo $val['pic_list']['14']['pic_url'];?>" title="<?php echo $val['pic_list']['14']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['14']['pic_img'];?>" pic_price="<?php echo $val['pic_list']['14']['pic_price'];?>"/></a>
                             
                            <a href="javascript:void(0);" class="right-y"><img pic_url="<?php echo $val['pic_list']['21']['pic_url'];?>" title="<?php echo $val['pic_list']['21']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['21']['pic_img'];?>" pic_price="<?php echo $val['pic_list']['21']['pic_price'];?>"/></a>

							<a href="javascript:void(0);" class="bottom-y"><img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>" title="<?php echo $val['pic_list']['32']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>" pic_price="<?php echo $val['pic_list']['32']['pic_price'];?>"/></a>
                            
                            <a href="javascript:void(0);" class="right-b"><img pic_url="<?php echo $val['pic_list']['24']['pic_url'];?>" title="<?php echo $val['pic_list']['24']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['24']['pic_img'];?>" pic_price="<?php echo $val['pic_list']['24']['pic_price'];?>"/></a>
                            
                            <a href="javascript:void(0);" class="bottom-a"><img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>" title="<?php echo $val['pic_list']['31']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>" pic_price="<?php echo $val['pic_list']['31']['pic_price'];?>"/></a>
    ...
    <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="index.php?act=artist_web&op=web_html&web_id=<?php echo $_GET['web_id'];?>" class="btn" id="submitBtn"><span><?php echo $lang['web_config_web_html'];?></span></a></td>
        </tr>
      </tfoot>
  </table>
</div>
...
<div id="category_list_dialog" style="display:none;">
  ...
  <form id="category_list_form" method="post" name="articleForm" style="margin-top:10px;">
    ...
    <textarea name="article_content" id="article_content" cols="45" rows="5"><?php echo $output['code_category_list']['code_html'];?></textarea>
<a href="JavaScript:void(0);" onclick="update_category1();" class="btn ml30"><span><?php echo $lang['web_config_save'];?></span></a>
  </form>
</div>
<!-- 活动图片 -->
                ...
                <ul class="dialog-goodslist-s1 goods-list">
                  ...
                  <?php } elseif (!empty($val['pic_list']) && is_array($val['pic_list'])) { ?>
                      ...
                      <li id="select_recommend_<?php echo $key;?>_pic_<?php echo $k;?>" style="display:none;">
						...
						<input name="recommend_list[<?php echo $key;?>][pic_list][<?php echo $v['pic_id'];?>][pic_price]" value="<?php echo $v['pic_price'];?>" type="hidden">
  ...
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?act=web_api&op=recommend_pic" target="upload_pic">
    ...
    <input type="hidden" name="pic_id" value="">
    	...
    	<table class="">
            <tr>
			<style>
					#add_recommend_pic .middle-banner a.left-y { line-height: 80px; width: 80px; height: 206px;left:80px;}
					#add_recommend_pic .middle-banner a.left-y img { max-width: 80px; max-height: 206px;}

					#add_recommend_pic .middle-banner a.left-z{ line-height: 80px; width: 80px; height: 103px;top: 0px;}
					#add_recommend_pic .middle-banner a.left-z img { max-width: 80px; max-height: 103px;}

					#add_recommend_pic .middle-banner a.middle-y{ line-height: 80px; width: 80px; height: 103px;bottom: 0px;left:0px;}
					#add_recommend_pic .middle-banner a.middle-y img { max-width: 80px; max-height: 103px;left:0px;}
					
					#add_recommend_pic .middle-banner a.right-y{ line-height: 80px; width: 80px; height: 103px;top: 0px;right:80px;}
					#add_recommend_pic .middle-banner a.right-y img { max-width: 80px; max-height: 103px;}
					
					#add_recommend_pic .middle-banner a.bottom-y{ line-height: 80px; width: 80px; height: 103px;bottom: 0px;right:80px;}
					#add_recommend_pic .middle-banner a.bottom-y img { max-width: 80px; max-height: 103px;}
            ...
            <?php if (!empty($val['pic_list']) && is_array($val['pic_list'])) { ?>
                ...
                <div select_recommend_pic_id="<?php echo $key;?>" class="middle-banner">
                        <a recommend_pic_id="11" href="javascript:void(0);" class="left-y"><img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['11']['pic_price'];?>" title="<?php echo $val['pic_list']['11']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a>
                        
                        <a recommend_pic_id="12" href="javascript:void(0);" class="left-z"><img pic_url="<?php echo $val['pic_list']['12']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['12']['pic_price'];?>" title="<?php echo $val['pic_list']['12']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['12']['pic_img'];?>"/></a>

                        <a recommend_pic_id="14" href="javascript:void(0);" class="middle-y"><img pic_url="<?php echo $val['pic_list']['14']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['14']['pic_price'];?>" title="<?php echo $val['pic_list']['14']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['14']['pic_img'];?>"/></a>
                        
                        
                        <a recommend_pic_id="21" href="javascript:void(0);" class="right-y"><img pic_url="<?php echo $val['pic_list']['21']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['21']['pic_price'];?>" title="<?php echo $val['pic_list']['21']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['21']['pic_img'];?>"/></a>

						<a recommend_pic_id="32" href="javascript:void(0);" class="bottom-y"><img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['32']['pic_price'];?>" title="<?php echo $val['pic_list']['32']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>"/></a>


                        <a recommend_pic_id="24" href="javascript:void(0);" class="right-b"><img pic_url="<?php echo $val['pic_list']['24']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['24']['pic_price'];?>" title="<?php echo $val['pic_list']['24']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['24']['pic_img'];?>"/></a>
                        
                        <a recommend_pic_id="31" href="javascript:void(0);" class="bottom-a"><img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>" pic_price="<?php echo $val['pic_list']['31']['pic_price'];?>" title="<?php echo $val['pic_list']['31']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>"/></a>
              ...
              <td>
            	 <table class="table tb-type2">
            	   <tbody>
					...
					<tr>
                      <td><?php echo '价格'.$lang['nc_colon'];?></td>
                    </tr>
                    <tr class="noborder">
                      <td class="vatop rowform">
                      	<input class="txt" type="text" name="pic_list[pic_price]" value="">
                      	</td>
                    </tr>
                    <tr>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/web_config/artist_index.js"></script>
