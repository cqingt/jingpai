...
<div class="page">
  ...
  <div class="homepage-focus" nctype="editStoreContent">
    ...
    <table class="table tb-type2">
      ...
      <tr>
          <td colspan="2" class="required"><label class="validation" for="store_name">运营类目:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
            <input type="radio" name="store_is_shuhua_" value="1" <?php if($output['store_array']['store_is_shuhua_'] == 1){echo "checked='checked'";}?> onclick="store_is_shuhua(1);">书画代运营
          <input type="radio" name="store_is_shuhua_" value="0" <?php if(empty($output['store_array']['store_is_shuhua_'])){echo "checked='checked'";}?> onclick="store_is_shuhua(0);">其它
    
          </td>
          <td class="vatop tips"></td>
        </tr>
		 <tr id="is_least_shuhua" <?php if($output['store_array']['store_is_shuhua_'] != 1){ ?>style="display:none;"<?php } ?>>
          <td colspan="2" class="required"><label class="validation" for="store_name">最低结算金额:</label></td>
        </tr>
        <tr class="noborder" id="is_least_shuhua1" <?php if($output['store_array']['store_is_shuhua_'] != 1){ ?>style="display:none;"<?php } ?>>
          <td class="vatop rowform">
            <input type="text" value="<?php echo $output['store_array']['least_shuhua'];?>" id="least_shuhua" name="least_shuhua" class="txt">
...
<tr>
      <td colspan="2" class="required">店铺排序:</td>
</tr>
<tr class="noborder">
  <td class="vatop rowform"><input type="text" width="50px" value="<?php echo $output['store_array']['store_sort'];?>" id="store_sort" name="store_sort" class="txt valid"></td>
  <td class="vatop tips"><?php echo $lang['formart'];?></td>
</tr>


<tr>
      <td colspan="2" class="required">店铺编号:</td>
</tr>
<tr class="noborder">
  <td class="vatop rowform"><input type="text" width="50px" value="<?php echo $output['store_array']['store_is_number_'];?>" id="store_is_number_" name="store_is_number_" class="txt valid"></td>
</tr>

<tr>
    <td colspan="2" class="required">招商人姓名:</td>
</tr>
<tr class="noborder">
  <td class="vatop rowform"><input type="text" width="50px" value="<?php echo $output['store_array']['zhaoshang_name'];?>" id="zhaoshang_name" name="zhaoshang_name" class="txt valid"></td>
</tr>


<tr>
    <td colspan="2" class="required">运营人员姓名:</td>
</tr>
<tr class="noborder">
  <td class="vatop rowform"><input type="text" width="50px" value="<?php echo $output['store_array']['yunying_name'];?>" id="yunying_name" name="yunying_name" class="txt valid"></td>
</tr>
<tr>
    <td colspan="2" class="required">运营人员手机号:</td>
</tr>
<tr class="noborder">
  <td class="vatop rowform"><input type="text" width="50px" value="<?php echo $output['store_array']['yunying_mobile'];?>" id="yunying_mobile" name="yunying_mobile" class="txt valid"></td>
</tr>
<tr>
    <td colspan="2" class="required">运营人员QQ:</td>
</tr>
<tr class="noborder">
  <td class="vatop rowform"><input type="text" width="50px" value="<?php echo $output['store_array']['yunying_qq'];?>" id="yunying_qq" name="yunying_qq" class="txt valid"></td>
</tr>
...
<td class="vatop tips"></td>
		...
		<tr>
			<td>
				...
				<div class="onoff" style="float:left;margin-right:10px;">
					<label for="store_yijia1" class="cb-enable <?php if(intval($output['store_array']['store_yijia']) == '1'){ ?>selected<?php } ?>" ><span>议价开</span></label>
					<label for="store_yijia0" class="cb-disable <?php if(intval($output['store_array']['store_yijia']) == '0'){ ?>selected<?php } ?>" ><span>议价关</span></label>

					<input id="store_yijia1" name="store_yijia" <?php if(intval($output['store_array']['store_yijia']) == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
					<input id="store_yijia0" name="store_yijia" <?php if(intval($output['store_array']['store_yijia']) == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
				</div>
...
电子版：</th>
        <td colspan="20">
          <a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_legal_person_img']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_legal_person_img']);?>" alt="" /> </a>
          <input class="w200" type="file" name="business_legal_person_img">
        </td>
      </tr>
    </tbody>
  </table>
...
function store_is_shuhua(obj){
	if(obj == 1){
		$('#is_least_shuhua').show();
		$('#is_least_shuhua1').show();
	}

	if(obj == 0){
		$('#is_least_shuhua').hide();
		$('#is_least_shuhua1').hide();
	}
}
</script>