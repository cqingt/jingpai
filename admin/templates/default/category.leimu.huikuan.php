...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span>类目回款统计</span></a></li>
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    ...
    <input type="hidden" name="op" value="leimuHuiKuan" />
      ...
      <tr class="hover">
        ...
        <td class="align-center">
          <?php if($output['search_gc_type'] == 2){?>
            <a href="index.php?act=category&op=info&hui=1&class_type=1&type=2&gc_id_1=<?php echo $order['gc_id_1'];?>&gc_id_2=<?php echo $order['gc_id_2'];?>&store_name=<?php echo $_GET['store_name'];?>&choose_gcid=<?php echo $_GET['choose_gcid'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
          <?php }elseif($output['search_gc_type'] == 1){?>
            <a href="index.php?act=category&op=info&hui=1&class_type=1&type=1&gc_id_1=<?php echo $order['gc_id_1'];?>&store_name=<?php echo $_GET['store_name'];?>&choose_gcid=<?php echo $_GET['choose_gcid'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
          <?php }else{?>
            <a href="index.php?act=category&op=info&hui=1&class_type=1&type=2&gc_id_1=<?php echo $order['gc_id_1'];?>&gc_id_2=<?php echo $order['gc_id_2'];?>&store_name=<?php echo $_GET['store_name'];?>&choose_gcid=<?php echo $_GET['choose_gcid'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
          <?php }?>
        </td>
        ...
        <?php if(count($output['order_list_offline'])>0){?>


          <?php foreach($output['order_list_offline'] as $key=>$v){?>

            <?php if($order['gc_id_1'] === $v['gc_id_1'] && $order['gc_id_2'] === $v['gc_id_2']){?>

              <tr class="hover">
                <td style='color:red;'><?php echo $output['class_list'][$v['gc_id_1']].' > '.$output['class_list'][$v['gc_id_2']];?></td>
                <td style="text-align:right;color:red;"><?php echo $v['pay_num'];?></td>
                <td style="text-align:right;color:red;"><?php echo sprintf("%.2f",$v['pay_commis_rate']);?></td>
                <td class="nowrap align-center" style='color:red;'><?php echo $v['count_order'];?></td>
                <td class="align-center">
                  <a  style='color:red;' href="index.php?act=category&op=info&hui=1&class_type=2&type=2&gc_id_1=<?php echo $order['gc_id_1'];?>&gc_id_2=<?php echo $order['gc_id_2'];?>&store_name=<?php echo $_GET['store_name'];?>&choose_gcid=<?php echo $_GET['choose_gcid'];?>&order_state=<?php echo $_GET['order_state'];?>&is_short=<?php echo $_GET['is_short'];?>&query_start_time=<?php echo $_GET['query_start_time'];?>&query_end_time=<?php echo $_GET['query_end_time'];?>">明细</a>
                </td>
              </tr>

            <?php unset($output['order_list_offline'][$key]);}?>
