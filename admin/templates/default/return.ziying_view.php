  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
		...
		<li><a href="index.php?act=return&op=ziying_return_all"><span><?php echo '自营客户审核';?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span>审核</span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="post_form" method="post" action="index.php?act=return&op=ziying_view&return_id=<?php echo $output['return']['refund_id']; ?>">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
        	<textarea id="admin_message" name="admin_message" class="tarea"><?php echo $output['return']['crm_info']; ?></textarea></td>
          <td class="vatop tips"></td>
        </tr>
