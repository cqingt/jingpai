...
<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?act=goods_edit&op=pic_list&item=goods&store_id=<?php echo $output['store_id']?>" style="display:none;"><?php echo $lang['nc_submit'];?></a>
...
$(function(){
    ...
    $('#jumpMenu').change(function(){
        $('[nctype="mea_img"]').load('index.php?act=goods_edit&op=pic_list&store_id=<?php echo $output['store_id']?>&item=mobile<?php if ($output['type'] == 'replace') {?>&type=replace<?php }?>&id=' + $(this).val());
    });
});
</script>