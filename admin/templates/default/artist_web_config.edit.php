...
.home-templates-board-layout .middle-banner { width: 1200px; height: 306px; margin: 1px; position: relative; z-index: 1;}
...
.home-templates-board-layout .middle-banner a.right-b { width: 240px; height: 153px;}

.home-templates-board-layout .middle-banner a.left-a,
.home-templates-board-layout .middle-banner a.right-b { line-height: 306px; width: 240px; height: 306px;}



.home-templates-board-layout .middle-banner a.middle-a { width: 240px; height: 153px;}
...
.home-templates-board-layout .middle-banner a.bottom-d { width: 240px; height: 153px;}

.home-templates-board-layout .middle-banner a.bottom-d {display:none;}
...
.home-templates-board-layout .middle-banner a.right-b img { max-width: 240px; max-height: 153px; width: 240px; height: 153px;}

.home-templates-board-layout .middle-banner a.left-a img,
.home-templates-board-layout .middle-banner a.right-b img { max-width: 240px; max-height: 306px; width: 240px; height: 306px;}


.home-templates-board-layout .middle-banner a.middle-a img { max-width: 240px; max-height: 153px;width: 240px; height: 153px;}
...
.home-templates-board-layout .middle-banner a.bottom-d img { max-width: 240px; max-height: 153px; width: 240px; height: 153px;}
.home-templates-board-layout .middle-banner a.left-a { top: 0; left: 0;}
.home-templates-board-layout .middle-banner a.left-b { top: 0px; left: 240px;}
.home-templates-board-layout .middle-banner a.right-a { top: 0; right: 240px;}
.home-templates-board-layout .middle-banner a.right-b { top: 0px; right: 0;}
.home-templates-board-layout .middle-banner a.middle-a { top: 0; left: 480px;}
.home-templates-board-layout .middle-banner a.bottom-a { bottom: 0; left: 240px;}
.home-templates-board-layout .middle-banner a.bottom-b { bottom: 0; left: 480px;}
.home-templates-board-layout .middle-banner a.bottom-c { bottom: 0; right: 240px;}
...
#add_recommend_pic .middle-banner a.right-b { line-height: 103px; width: 64px; height: 103px;}

#add_recommend_pic .middle-banner a.left-a,
#add_recommend_pic .middle-banner a.right-b { line-height: 206px; width: 64px; height: 206px;}


#add_recommend_pic .middle-banner a.middle-a { line-height: 103px; width: 64px; height: 103px;}
...
#add_recommend_pic .middle-banner a.bottom-d { line-height: 103px; width: 64px; height: 103px;}

#add_recommend_pic .middle-banner a.bottom-d {display:none;}
...
#add_recommend_pic .middle-banner a.right-b img { max-width: 64px; max-height: 103px;}

#add_recommend_pic .middle-banner a.left-a img,
#add_recommend_pic .middle-banner a.right-b img { max-width: 64px; max-height: 206px;}


#add_recommend_pic .middle-banner a.middle-a img { max-width: 64px; max-height: 103px;}
...
#add_recommend_pic .middle-banner a.bottom-d img { max-width: 64px; max-height: 103px;}
#add_recommend_pic .middle-banner a.left-a { top: 0; left: 0;}
#add_recommend_pic .middle-banner a.left-b { top: 0px; left: 64px;}
#add_recommend_pic .middle-banner a.right-a { top: 0; right: 64px;}
#add_recommend_pic .middle-banner a.right-b { top: 0px; right: 0;}
#add_recommend_pic .middle-banner a.middle-a { top: 0; left: 128px;}
#add_recommend_pic .middle-banner a.bottom-a { bottom: 0; left: 64px;}
#add_recommend_pic .middle-banner a.bottom-b { bottom: 0; left: 128px;}
#add_recommend_pic .middle-banner a.bottom-c { bottom: 0; right: 64px;}
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('artist', 'artist_web_config');?>" ><span><?php echo '板块区';?></span></a></li>
        <li><a href="index.php?act=artist&op=artist_web_edit&web_id=<?php echo $_GET['web_id'];?>"><span><?php echo '基本设置';?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span>板块编辑</span></a></li>
...
<div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>" style="width:1220px;">

<div class="middle"  style="width:1200px;">
...
<?php if (is_array($output['code_recommend_list']['code_info']) && !empty($output['code_recommend_list']['code_info'])) { ?>
  ...
  <dl recommend_id="<?php echo $key;?>"   style="height:400px;">
    ...
    <dt>
      ...
      <a href="JavaScript:show_artist_recommend_pic_dialog(<?php echo $key;?>);"><i class="icon-lightbulb"></i><?php echo '广告块';?></a>
    </dt>


    <dd   style="height:367px;">
...
<?php } ?>
  ...
  <div class="add-tab" id="btn_add_list">
    <a href="JavaScript:add_artist_recommend();"><i class="icon-plus-sign-alt"></i><?php echo $lang['web_config_add_recommend'];?></a>最多10个</div>
    ...
    <tfoot>
      <tr class="tfoot">
        <td colspan="2" ><a href="index.php?act=artist&op=artist_web_html&web_id=<?php echo $_GET['web_id'];?>" class="btn" id="submitBtn"><span><?php echo $lang['web_config_web_html'];?></span></a></td>
      </tr>
    </tfoot>
    	...
    	<table class="">
            ...
            <?php if (!empty($val['pic_list']) && is_array($val['pic_list'])) { ?>
                <div select_recommend_pic_id="<?php echo $key;?>" class="middle-banner">
                        <a recommend_pic_id="11" href="javascript:void(0);" class="left-a"  pic_goods_price="<?php echo $val['pic_list']['11']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>"  title="<?php echo $val['pic_list']['11']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a>
                        <a recommend_pic_id="12" href="javascript:void(0);" class="left-b"  pic_goods_price="<?php echo $val['pic_list']['12']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['12']['pic_url'];?>"  title="<?php echo $val['pic_list']['12']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['12']['pic_img'];?>"/></a>
                        <a recommend_pic_id="14" href="javascript:void(0);" class="middle-a"  pic_goods_price="<?php echo $val['pic_list']['14']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['14']['pic_url'];?>"  title="<?php echo $val['pic_list']['14']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['14']['pic_img'];?>"/></a>
                        <a recommend_pic_id="21" href="javascript:void(0);" class="right-a"  pic_goods_price="<?php echo $val['pic_list']['21']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['21']['pic_url'];?>"  title="<?php echo $val['pic_list']['21']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['21']['pic_img'];?>"/></a>
                        <a recommend_pic_id="24" href="javascript:void(0);" class="right-b"  pic_goods_price="<?php echo $val['pic_list']['24']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['24']['pic_url'];?>"  title="<?php echo $val['pic_list']['24']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['24']['pic_img'];?>"/></a>
                        <a recommend_pic_id="31" href="javascript:void(0);" class="bottom-a"  pic_goods_price="<?php echo $val['pic_list']['31']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>"  title="<?php echo $val['pic_list']['31']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>"/></a>
                        <a recommend_pic_id="32" href="javascript:void(0);" class="bottom-b"  pic_goods_price="<?php echo $val['pic_list']['32']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>"  title="<?php echo $val['pic_list']['32']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>"/></a>
                        <a recommend_pic_id="33" href="javascript:void(0);" class="bottom-c"  pic_goods_price="<?php echo $val['pic_list']['33']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['33']['pic_url'];?>"  title="<?php echo $val['pic_list']['33']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['33']['pic_img'];?>"/></a>
                        <a recommend_pic_id="34" href="javascript:void(0);" class="bottom-d"  pic_goods_price="<?php echo $val['pic_list']['34']['pic_goods_price'];?>"     ><img pic_url="<?php echo $val['pic_list']['34']['pic_url'];?>"  title="<?php echo $val['pic_list']['34']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['34']['pic_img'];?>"/></a>
            	</div>
            <?php } ?>
            <?php } ?>
            <?php } ?>
              ...
              <td>
            	 <table class="table tb-type2">
            	   <tbody>
                    ...
                    <tr>
                      <td><?php echo '商品价格'.$lang['nc_colon'];?></td>
                    </tr>
                    <tr class="noborder">
                      <td class="vatop rowform">
                        <input class="txt" type="text" name="pic_list[pic_goods_price]" value="">
                        </td>
                    </tr>
