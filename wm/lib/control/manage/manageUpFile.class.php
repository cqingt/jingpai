 ...
 * @联系QQ：9132761
 * 
 * @文件名称：manageUpFile.class.php
 * 
 * @开发时间：2015-4-23 15:28:17
 * 
 * @画廊认证
 * 
 */
...
class manageUpFile extends manage{

	public function __construct(){
		parent::__construct();
		$this->c->table('pc_advert');
	}
	...
	public function index(){
		...
		$this->filename = 'pc_advert_list.html';	
	}
	...
	public function popAdvert(){
		...
		$this->filename = 'pop/pc_popAdvert.html';
	}
	...
	public function addAdvert(){
		...
		$cid = $this->c->insertID();
		show('添加成功!','index.php?m=manageUpFile&c=index&p=manage');
	}
	...
	public function updateAdvert(){
		...
		show('更新成功!','index.php?m=manageUpFile&c=index&p=manage');
	}
