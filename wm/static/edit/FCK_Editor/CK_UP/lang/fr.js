...
CKFinder.lang['fr'] =
{
	...
	common :
	{
		...
		confirmCancel	: 'Certaines options ont été modifiées. ^Etes vous s^ur de vouloir fermer cette fenêtre ?',
		ok				: 'OK',
		cancel			: 'Annuler',
	...
	FolderDelete	: '^Etes-vous s^ur de vouloir effacer le dossier "%1" ?',
	FolderRenaming	: ' (Renommage en cours...)',
	FolderDeleting	: ' (Suppression en cours...)',

	// Files
	FileRename		: 'Entrez le nouveau nom du fichier: ',
	FileRenameExt	: '^Etes-vous s^ur de vouloir ¨changer l\'extension de ce fichier? Le fichier pourrait devenir inutilisable',
	FileRenaming	: 'Renommage en cours...',
	FileDelete		: '^Etes-vous s^ur de vouloir effacer le fichier "%1" ?',
	...
	BasketTruncateConfirm : '^Etes vous s^ur de vouloir supprimer tous les fichiers de la corbeille ?',
	BasketRemoveConfirm	: '^Etes vous s^ur de vouloir supprimer le fichier "%1" de la corbeille ?',
	...
	116 : 'Ce dossier n\'existe pas. Veuillez rafra^ichir la page et réessayer.',
	117 : 'Ce fichier n\'existe pas. Veuillez rafra^ichir la page et réessayer.',
