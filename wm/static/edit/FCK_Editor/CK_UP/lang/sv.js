...
CKFinder.lang['sv'] =
{
	...
	FolderNew		: 'Skriv namnet pa den nya mappen: ',
	FolderRename	: 'Skriv det nya namnet pa mappen: ',
	FolderDelete	: '"Ar du s"aker pa att du vill radera mappen "%1"?',
	FolderRenaming	: ' (Byter mappens namn...)',
	FolderDeleting	: ' (Raderar...)',

	// Files
	FileRename		: 'Skriv det nya filnamnet: ',
	FileRenameExt	: '"Ar du s"aker pa att du fill "andra pa fil"andelsen? Filen kan bli oanv"andbar',
	FileRenaming	: 'Byter filnamn...',
	FileDelete		: '"Ar du s"aker pa att du vill radera filen "%1"?',
	...
	UploadSelectLbl		: 'V"alj fil att ladda upp',
	UploadProgressLbl	: '(Laddar upp filen, var god v"anta...)',
	UploadBtn			: 'Ladda upp den valda filen',
	UploadBtnCancel		: 'Cancel', // MISSING

	UploadNoFileMsg		: 'V"alj en fil fran din dator',
	...
	ErrorUnknown	: 'Beg"aran kunde inte utf"oras eftersom ett fel uppstod. (Error %1)',
	Errors :
	{
	 10 : 'Ogiltig beg"aran.',
	 11 : 'Resursens typ var inte specificerad i f"orfragan.',
	 12 : 'Den efterfragade resurstypen "ar inte giltig.',
	102 : 'Ogiltigt fil- eller mappnamn.',
	103 : 'Beg"aran kunde inte utf"oras p.g.a. restriktioner av r"attigheterna.',
	104 : 'Beg"aran kunde inte utf"oras p.g.a. restriktioner av r"attigheter i filsystemet.',
	105 : 'Ogiltig fil"andelse.',
	109 : 'Ogiltig beg"aran.',
	110 : 'Ok"ant fel.',
	115 : 'En fil eller mapp med aktuellt namn finns redan.',
	116 : 'Mappen kunde inte hittas. Var god uppdatera sidan och f"ors"ok igen.',
	117 : 'Filen kunde inte hittas. Var god uppdatera sidan och f"ors"ok igen.',
	118 : 'Source and target paths are equal.', // MISSING
	201 : 'En fil med aktuellt namn fanns redan. Den uppladdade filen har d"opts om till "%1"',
	202 : 'Ogiltig fil',
	203 : 'Ogiltig fil. Filen var f"or stor.',
	204 : 'Den uppladdade filen var korrupt.',
	205 : 'En tillf"allig mapp f"or uppladdning "ar inte tillg"anglig pa servern.',
	206 : 'Uppladdningen stoppades av s"akerhetssk"al. Filen innehaller HTML-liknande data.',
	207 : 'Den uppladdade filen har d"opts om till "%1"',
	300 : 'Moving file(s) failed.', // MISSING
	301 : 'Copying file(s) failed.', // MISSING
	500 : 'Filhanteraren har stoppats av s"akerhetssk"al. Var god kontakta administrat"oren f"or att kontrollera konfigurationsfilen f"or CKFinder.',
	501 : 'St"od f"or tumnaglar har st"angts av.'
	},

	// Other Error Messages.
	ErrorMsg :
	{
		FileEmpty		: 'Filnamnet far inte vara tomt',
		FileExists		: 'File %s already exists', // MISSING
		FolderEmpty		: 'Mappens namn far inte vara tomt',

		FileInvChar		: 'Filnamnet far inte innehalla nagot av f"oljande tecken: \n\\ / : * ? " < > |',
		FolderInvChar	: 'Mappens namn far inte innehalla nagot av f"oljande tecken: \n\\ / : * ? " < > |',

		PopupBlockView	: 'Det gick inte att "oppna filen i ett nytt f"onster. "Andra inst"allningarna i din webbl"asare och tillat popupf"onster f"or den h"ar hemsidan.'
	},
