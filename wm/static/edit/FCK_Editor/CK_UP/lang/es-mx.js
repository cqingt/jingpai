...
CKFinder.lang['es-mx'] =
{
	...
	Upload		: 'A~nadir',
	UploadTip	: 'A~nadir nuevo archivo',
	Refresh		: 'Actualizar',
	...
	// Upload Panel
	UploadTitle			: 'A~nadir nuevo archivo',
	...
	SetDisplaySize	: 'Tama~no del archivo',
	SetSort			: 'Ordenar:',
	SetSortName		: 'por Nombre',
	SetSortDate		: 'por Fecha',
	SetSortSize		: 'por Tama~no',
	...
	203 : 'Archivo inválido. El tama~no es demasiado grande.',
	...
	Imageresize :
	{
		...
		thumbnailSmall	: 'Peque~na (%s)',
		thumbnailMedium	: 'Mediana (%s)',
		thumbnailLarge	: 'Grande (%s)',
		newSize			: 'Establecer nuevo tama~no',
		width			: 'Ancho',
		height			: 'Alto',
		...
		imageSmall		: 'La imagen original es demasiado peque~na',
