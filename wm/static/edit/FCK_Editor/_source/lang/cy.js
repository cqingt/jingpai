...
CKEDITOR.lang['cy'] =
{
	...
	link :
	{
		...
		targetFrameName	: 'Enw Ffr^am y Targed',
	...
	list:
	{
		...
		decimalLeadingZero	: 'Degol ^a sero arweiniol (01, 02, 03, ayyb.)'
	},
	...
	table :
	{
		...
		cell :
		{
			...
			insertAfter		: 'Mewnosod Cell Ar ^Ol',
		...
		row :
		{
			...
			insertAfter		: 'Mewnosod Rhes Ar ^Ol',
		...
		column :
		{
			...
			insertAfter		: 'Mewnosod Colofn Ar ^Ol',
	...
	clipboard :
	{
		...
		copyError	: 'Nid yw gosodiadau diogelwch eich porwr yn caniatàu\'r golygydd i gynnal \'gweithredoedd cop"io\' yn awtomatig. Defnyddiwch y bysellfwrdd (Ctrl/Cmd+C).',
	...
	pastefromword :
	{
		confirmCleanup	: 'Mae\'r testun rydych chi am ludo wedi\'i gop"io o Word. Ydych chi am ei lanhau cyn ei ludo?',
	...
	scayt :
	{
		...
		mixedCase		: 'Anwybyddu Geiriau ^a Chymysgedd Nodau Uwch ac Is',
		mixedWithDigits	: 'Anwybyddu Geiriau ^a Rhifau',
	...
	docprops :
	{
		...
		charsetCT : 'Tsiein"eeg Traddodiadol (Big5)',
		charsetCR : 'Syrilig',
		charsetGR : 'Groeg',
		charsetJP : 'Siapan"eeg',
		charsetKR : 'Cor"eeg',
		charsetTR : 'Tyrceg',
