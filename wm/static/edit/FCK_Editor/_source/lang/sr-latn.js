...
CKEDITOR.lang['sr-latn'] =
{
	...
	link :
	{
		...
		targetFrameName	: 'Naziv odredisnog frejma',
	...
	select :
	{
		...
		size		: 'Velicina',
		lines		: 'linija',
		chkMulti	: 'Dozvoli visestruku selekciju',
		opText		: 'Tekst',
		opValue		: 'Vrednost',
		btnAdd		: 'Dodaj',
		btnModify	: 'Izmeni',
		btnUp		: 'Gore',
		btnDown		: 'Dole',
		btnSetValue : 'Podesi kao oznacenu vrednost',
		btnDelete	: 'Obrisi'
	},
	...
	spellCheck :
	{
		...
		notInDic		: 'Nije u recniku',
		changeTo		: 'Izmeni',
		btnIgnore		: 'Ignorisi',
		btnIgnoreAll	: 'Ignorisi sve',
		btnReplace		: 'Zameni',
		btnReplaceAll	: 'Zameni sve',
		btnUndo			: 'Vrati akciju',
		noSuggestions	: '- Bez sugestija -',
		progress		: 'Provera spelovanja u toku...',
		noMispell		: 'Provera spelovanja zavrsena: greske nisu pronadene',
		noChanges		: 'Provera spelovanja zavrsena: Nije izmenjena nijedna rec',
		oneChange		: 'Provera spelovanja zavrsena: Izmenjena je jedna rec',
		manyChanges		: 'Provera spelovanja zavrsena: %1 rec(i) je izmenjeno',
		ieSpellDownload	: 'Provera spelovanja nije instalirana. Da li zelite da je skinete sa Interneta?'
	},
	...
	{
		title		: 'Zalepi',
		cutError	: 'Sigurnosna podesavanja Vaseg pretrazivaca ne dozvoljavaju operacije automatskog isecanja teksta. Molimo Vas da koristite precicu sa tastature (Ctrl/Cmd+X).',
		copyError	: 'Sigurnosna podesavanja Vaseg pretrazivaca ne dozvoljavaju operacije automatskog kopiranja teksta. Molimo Vas da koristite precicu sa tastature (Ctrl/Cmd+C).',
		pasteMsg	: 'Molimo Vas da zalepite unutar donje povrine koriste'ci tastaturnu precicu (<STRONG>Ctrl/Cmd+V</STRONG>) i da pritisnete <STRONG>OK</STRONG>.',
	...
	pasteText :
	{
		button	: 'Zalepi kao cist tekst',
		title	: 'Zalepi kao cist tekst'
	},

	templates :
	{
		button			: 'Obrasci',
		title			: 'Obrasci za sadrzaj',
		options : 'Template Options', // MISSING
		insertOption	: 'Replace actual contents', // MISSING
		selectPromptMsg	: 'Molimo Vas da odaberete obrazac koji ce biti primenjen na stranicu (trenutni sadrzaj ce biti obrisan):',
	...
	fontSize :
	{
		label		: 'Velicina fonta',
		voiceLabel	: 'Font Size', // MISSING
		panelTitle	: 'Velicina fonta'
	},
	...
	docprops :
	{
		...
		marginRight : 'Desna',
		marginBottom : 'Donja',
		metaKeywords : 'Kljucne reci za indeksiranje dokumenta (razdvojene zarezima)',
