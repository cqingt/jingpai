...
CKEDITOR.lang['lv'] =
{
	...
	link :
	{
		...
		toUrl		: 'URL', // MISSING
		toAnchor	: 'Iezīme sajā lapā',
		toEmail		: 'E-pasts',
		targetFrame		: '<ietvars>',
		targetPopup		: '<uznirstosā logā>',
		targetFrameName	: 'Mērka ietvara nosaukums',
		targetPopupName	: 'Uznirstosā loga nosaukums',
		popupFeatures	: 'Uznirstosā loga nosaukums īpasības',
		popupResizable	: 'Resizable', // MISSING
		popupStatusBar	: 'Statusa josla',
		popupLocationBar: 'Atrasanās vietas josla',
		...
		name			: 'Nosaukums',
		langCode			: 'Valodas lasīsanas virziens',
		tabIndex			: 'Cilnu indekss',
		advisoryTitle		: 'Konsultatīvs virsraksts',
		...
		emailSubject		: 'Zinas tēma',
		emailBody		: 'Zinas saturs',
		noAnchors		: '(Sajā dokumentā nav iezīmju)',
	...
	anchor :
	{
		...
		menu		: 'Iezīmes īpasības',
		title		: 'Iezīmes īpasības',
	...
	{
		toolbar		: 'Tabula',
		title		: 'Tabulas īpasības',
		menu		: 'Tabulas īpasības',
		...
		cellSpace	: 'Rūtinu atstatums',
		cellPad		: 'Rūtinu nobīde',
		caption		: 'Legenda',
		summary		: 'Anotācija',
		...
		cell :
		{
			...
			deleteCell		: 'Dzēst rūtinas',
			merge			: 'Apvienot rūtinas',
	...
	checkboxAndRadio :
	{
		checkboxTitle : 'Atzīmēsanas kastītes īpasības',
		radioTitle	: 'Izvēles poga īpasības',
		value		: 'Vērtība',
		selected	: 'Iezīmēts'
	},
	...
	form :
	{
		title		: 'Formas īpasības',
		menu		: 'Formas īpasības',
		action		: 'Darbība',
		method		: 'Metode',
	...
	select :
	{
		title		: 'Iezīmēsanas lauka īpasības',
		selectInfo	: 'Informācija',
		opAvail		: 'Pieejamās iespējas',
		value		: 'Vērtība',
		size		: 'Izmērs',
		lines		: 'rindas',
		chkMulti	: 'Atlaut vairākus iezīmējumus',
		opText		: 'Teksts',
		opValue		: 'Vērtība',
		btnAdd		: 'Pievienot',
		btnModify	: 'Veikt izmainas',
		btnUp		: 'Augsup',
		btnDown		: 'Lejup',
	...
	hidden :
	{
		title	: 'Paslēptās teksta rindas īpasības',
		name	: 'Nosaukums',
		value	: 'Vērtība'
	},
	...
	image :
	{
		title		: 'Attēla īpasības',
		titleButton	: 'Attēlpogas īpasības',
		menu		: 'Attēla īpasības',
	...
	flash :
	{
		properties		: 'Flash īpasības',
		propertiesTab	: 'Properties', // MISSING
		title			: 'Flash īpasības',
		chkPlay			: 'Automātiska atskanosana',
		chkLoop			: 'Nepārtraukti',
		chkMenu			: 'Atlaut Flash izvēlni',
	...
	spellCheck :
	{
		...
		noMispell		: 'Pareizrakstības pārbaude pabeigta: klūdas netika atrastas',
	...
	{
		title		: 'Ievietot',
		cutError	: 'Jūsu pārlūkprogrammas drosības iestatījumi nepielauj editoram automātiski veikt izgriesanas darbību.  Lūdzu, izmantojiet (Ctrl/Cmd+X, lai veiktu so darbību.',
		copyError	: 'Jūsu pārlūkprogrammas drosības iestatījumi nepielauj editoram automātiski veikt kopēsanas darbību.  Lūdzu, izmantojiet (Ctrl/Cmd+C), lai veiktu so darbību.',
		pasteMsg	: 'Lūdzu, ievietojiet tekstu sajā laukumā, izmantojot klaviatūru (<STRONG>Ctrl/Cmd+V</STRONG>) un apstipriniet ar <STRONG>Darīts!</STRONG>.',
	...
	pasteText :
	{
		button	: 'Ievietot kā vienkārsu tekstu',
		title	: 'Ievietot kā vienkārsu tekstu'
	},
	...
	docprops :
	{
		label : 'Dokumenta īpasības',
		title : 'Dokumenta īpasības',
		...
		margin : 'Lapas robezas',
		marginTop : 'Augsā',
		marginLeft : 'Pa kreisi',
		marginRight : 'Pa labi',
		marginBottom : 'Apaksā',
		metaKeywords : 'Dokumentu aprakstosi atslēgvārdi (atdalīti ar komatu)',
