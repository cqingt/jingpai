...
CKEDITOR.lang['ca'] =
{
	...
	common :
	{
		...
		invalidHeight	: 'L\'alcada ha de ser un nombre.',
	...
	link :
	{
		toolbar		: 'Insereix/Edita enllac',
		other 		: '<altre>',
		menu		: 'Edita l\'enllac',
		title		: 'Enllac',
		info		: 'Informació de l\'enllac',
		target		: 'Destí',
		upload		: 'Puja',
		advanced	: 'Avancat',
		type		: 'Tipus d\'enllac',
		toUrl		: 'URL',
		toAnchor	: '`Ancora en aquesta pàgina',
		...
		popupLocationBar: 'Barra d\'adreca',
	...
	findAndReplace :
	{
		title				: 'Cerca i reemplaca',
		find				: 'Cerca',
		replace				: 'Reemplaca',
		findWhat			: 'Cerca:',
		replaceWith			: 'Remplaca amb:',
		...
		replaceAll			: 'Reemplaca-ho tot',
		replaceSuccessMsg	: '%1 ocurrència/es reemplacada/es.'
	},
	...
	table :
	{
		...
		invalidHeight	: 'L\'alcada de la taula  ha de ser un nombre.',
		...
		cell :
		{
			...
			invalidHeight	: 'L\'alcada de cel·la ha de ser un nombre.',
	...
	flash :
	{
		...
		hSpace			: 'Espaiat horit.',
		vSpace			: 'Espaiat vert.',
		validateSrc		: 'Si us plau, escrigui l\'enllac URL',
	...
	templates :
	{
		...
		insertOption	: 'Reemplaca el contingut actual',
	...
	format :
	{
		...
		tag_pre		: 'Formatejat',
		tag_address	: 'Adreca',
		tag_h1		: 'Encapcalament 1',
		tag_h2		: 'Encapcalament 2',
		tag_h3		: 'Encapcalament 3',
		tag_h4		: 'Encapcalament 4',
		tag_h5		: 'Encapcalament 5',
		tag_h6		: 'Encapcalament 6',
		tag_div		: 'Normal (DIV)'
	},
	...
	iframe :
	{
		...
		toolbar		: 'IFrame',
		noUrl		: 'Si us plau, introdu"iu la URL de l\'iframe URL',
		scrolling	: 'Activa les barrres de desplacament',
	...
	docprops :
	{
		...
		docType : 'Capcalera de tipus de document',
		docTypeOther : 'Un altra capcalera de tipus de document',
