...
CKEDITOR.lang['fr'] =
{
	...
	common :
	{
		...
		confirmNewPage	: 'Les changements non sauvegardés seront perdus. ^Etes-vous s^ur de vouloir charger une nouvelle page?',
		confirmCancel	: 'Certaines options ont été modifiées. ^Etes-vous s^ur de vouloir fermer?',
		options			: 'Options',
		target			: 'Cible (Target)',
	...
	spellCheck :
	{
		...
		errorLoading	: 'Erreur du chargement du service depuis l\'h^ote : %s.',
