...
CKEDITOR.lang['sl'] =
{
	...
	horizontalrule	: 'Vstavi vodoravno crto',
	...
	common :
	{
		browseServer	: 'Prebrskaj na strezniku',
		url				: 'URL',
		protocol		: 'Protokol',
		upload			: 'Prenesi',
		uploadSubmit	: 'Poslji na streznik',
		image			: 'Slika',
		flash			: 'Flash',
		form			: 'Obrazec',
		...
		validateNumberFailed : 'Ta vrednost ni stevilo.',
		confirmNewPage	: 'Vse neshranjene spremembe te vsebine bodo izgubljene. Ali gotovo zelis naloziti novo stran?',
		confirmCancel	: 'Nekaj moznosti je bilo spremenjenih. Ali gotovo zelis zapreti okno?',
		...
		invalidHeight	: 'Visina mora biti stevilo.',
		invalidWidth	: 'Sirina mora biti stevilo.',
	...
	link :
	{
		...
		popupFeatures	: 'Znacilnosti pojavnega okna',
		...
		emailSubject		: 'Predmet sporocila',
		emailBody		: 'Vsebina sporocila',
	...
	findAndReplace :
	{
		...
		matchCase			: 'Razlikuj velike in male crke',
	...
	table :
	{
		...
		headersBoth		: 'Oboje',
		invalidRows		: 'Stevilo vrstic mora biti vecje od 0.',
		invalidCols		: 'Stevilo stolpcev mora biti vecje od 0.',
		invalidBorder	: 'Sirina obrobe mora biti stevilo.',
		invalidWidth	: 'Sirina tabele mora biti stevilo.',
		invalidHeight	: 'Visina tabele mora biti stevilo.',
		invalidCellSpacing	: 'Razmik med celicami mora biti stevilo.',
		invalidCellPadding	: 'Zamik celic mora biti stevilo',
		...
		cell :
		{
			...
			deleteCell		: 'Izbrisi celice',
			merge			: 'Zdruzi celice',
			mergeRight		: 'Zdruzi desno',
			mergeDown		: 'Druzi navzdol',
			splitHorizontal	: 'Razdeli celico vodoravno',
			splitVertical	: 'Razdeli celico navpicno',
			...
			yes				: 'Da',
			no				: 'Ne',
			invalidWidth	: 'Sirina celice mora biti stevilo.',
			invalidHeight	: 'Visina celice mora biti stevilo.',
			invalidRowSpan	: 'Razpon vrstic mora biti celo stevilo.',
			invalidColSpan	: 'Razpon stolpcev mora biti celo stevilo.',
			chooseColor		: 'Izberi'
		},
	...
	select :
	{
		...
		selectInfo	: 'Podatki',
		opAvail		: 'Razpolozljive izbire',
		value		: 'Vrednost',
		size		: 'Velikost',
		lines		: 'vrstic',
		chkMulti	: 'Dovoli izbor vecih vrstic',
		opText		: 'Besedilo',
		opValue		: 'Vrednost',
		btnAdd		: 'Dodaj',
		btnModify	: 'Spremeni',
	...
	textarea :
	{
		title		: 'Lastnosti vnosnega obmocja',
		cols		: 'Stolpcev',
		rows		: 'Vrstic'
	},
	...
	textfield :
	{
		...
		value		: 'Vrednost',
		charWidth	: 'Dolzina',
		maxChars	: 'Najvecje stevilo znakov',
		type		: 'Tip',
		typeText	: 'Besedilo',
		typePass	: 'Geslo'
	},
	...
	image :
	{
		...
		vSpace		: 'Navpicni razmik',
		alertUrl	: 'Vnesite URL slike',
		linkTab		: 'Povezava',
		button2Img	: 'Zelis pretvoriti izbrani gumb s sliko v preprosto sliko?',
		img2Button	: 'Zelis pretvoriti izbrano sliko v gumb s sliko?',
	...
	flash :
	{
		...
		chkLoop			: 'Ponavljanje',
		chkMenu			: 'Omogoci Flash Meni',
		chkFull			: 'Dovoli celozaslonski nacin',
 		scale			: 'Povecava',
		scaleAll		: 'Pokazi vse',
		scaleNoBorder	: 'Brez obrobe',
		scaleFit		: 'Natancno prileganje',
		...
		alignBaseline	: 'Na osnovno crto',
		alignTextTop	: 'Besedilo na vrh',
		quality			: 'Kakovost',
		qualityBest		: 'Najvisja',
		qualityHigh		: 'Visoka',
		...
		validateHSpace	: 'Vodoravni razmik mora biti stevilo.',
		validateVSpace	: 'Navpicni razmik mora biti stevilo.'
	},

	// Speller Pages Dialog
	spellCheck :
	{
		toolbar			: 'Preveri crkovanje',
		title			: 'Crkovalnik',
		...
		progress		: 'Preverjanje crkovanja se izvaja...',
		noMispell		: 'Crkovanje je koncano: Brez napak',
		noChanges		: 'Crkovanje je koncano: Nobena beseda ni bila spremenjena',
		oneChange		: 'Crkovanje je koncano: Spremenjena je bila ena beseda',
		manyChanges		: 'Crkovanje je koncano: Spremenjenih je bilo %1 besed',
		ieSpellDownload	: 'Crkovalnik ni namescen. Ali ga zelite prenesti sedaj?'
	},
	...
	numberedlist	: 'Ostevilcen seznam',
	bulletedlist	: 'Oznacen seznam',
	indent			: 'Povecaj zamik',
	outdent			: 'Zmanjsaj zamik',
	...
	{
		title		: 'Prilepi',
		cutError	: 'Varnostne nastavitve brskalnika ne dopuscajo samodejnega izrezovanja. Uporabite kombinacijo tipk na tipkovnici (Ctrl/Cmd+X).',
		copyError	: 'Varnostne nastavitve brskalnika ne dopuscajo samodejnega kopiranja. Uporabite kombinacijo tipk na tipkovnici (Ctrl/Cmd+C).',
		pasteMsg	: 'Prosim prilepite v sleci okvir s pomocjo tipkovnice (<STRONG>Ctrl/Cmd+V</STRONG>) in pritisnite <STRONG>V redu</STRONG>.',
		securityMsg	: 'Zaradi varnostnih nastavitev vasega brskalnika urejevalnik ne more neposredno dostopati do odlozisca. Vsebino odlozisca ponovno prilepite v to okno.',
	...
	templates :
	{
		...
		selectPromptMsg	: 'Izberite predlogo, ki jo zelite odpreti v urejevalniku<br>(trenutna vsebina bo izgubljena):',
		emptyListMsg	: '(Ni pripravljenih predlog)'
	},

	showBlocks : 'Prikazi ograde',
	...
	scayt :
	{
		title			: 'Crkovanje med tipkanjem',
		opera_title		: 'Not supported by Opera', // MISSING
		enable			: 'Omogoci SCAYT',
		disable			: 'Onemogoci SCAYT',
		about			: 'O storitvi SCAYT',
		toggle			: 'Preklopi SCAYT',
		options			: 'Moznosti',
		langs			: 'Jeziki',
		moreSuggestions	: 'Vec predlogov',
		ignore			: 'Prezri',
	...
	about :
	{
		...
		moreInfo	: 'Za informacijo o licenci prostim obiscite naso spletno stran:',
		copy		: 'Copyright &copy; $1. Vse pravice pridrzane.'
	},
	...
	docprops :
	{
		...
		marginRight : 'Desno',
		marginBottom : 'Spodaj',
		metaKeywords : 'Kljucne besede (locene z vejicami)',
