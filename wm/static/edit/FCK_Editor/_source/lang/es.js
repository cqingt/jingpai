...
CKEDITOR.lang['es'] =
{
	...
	list:
	{
		...
		bulletedTitle		: 'Propiedades de vi~netas',
		type				: 'Tipo',
		start				: 'Inicio',
	...
	table :
	{
		...
		invalidBorder	: 'El tama~no del borde debe ser un número.',
	...
	scayt :
	{
		...
		addWord			: 'A~nadir palabra',
		emptyDic		: 'El nombre del diccionario no puede estar en blanco.',

		optionsTab		: 'Opciones',
		allCaps			: 'Omitir palabras en MAY'USCULAS',
		...
		dic_info		: 'Inicialmente el Diccionario de usuario se guarda en una Cookie. Sin embargo, las cookies están limitadas en tama~no. Cuando el diccionario crece a un punto en el que no se puede guardar en una Cookie, el diccionario puede ser almacenado en nuestro servidor. Para almacenar su diccionario personalizado en nuestro servidor debe especificar un nombre para su diccionario. Si ya ha guardado un diccionaro, por favor, escriba su nombre y pulse el botón Recuperar',
