...
CKEDITOR.lang['pt'] =
{
	...
	contextmenu :
	{
		options : 'Menu de opc~oes de contexto'
	},
	...
	link :
	{
		toolbar		: 'Inserir/Editar Hiperligac~ao',
		other 		: '<outro>',
		menu		: 'Editar Hiperligac~ao',
		title		: 'Hiperligac~ao',
		info		: 'Informac~ao de Hiperligac~ao',
		target		: 'Destino',
		upload		: 'Carregar',
		advanced	: 'Avancado',
		type		: 'Tipo de Hiperligac~ao',
		toUrl		: 'URL',
		...
		popupLocationBar: 'Barra de localizac~ao',
		...
		popupLeft		: 'Posic~ao Esquerda',
		popupTop		: 'Posic~ao Direita',
		id				: 'ID',
		langDir			: 'Orientac~ao de idioma',
		langDirLTR		: 'Esquerda à Direita (LTR)',
		langDirRTL		: 'Direita a Esquerda (RTL)',
		...
		name			: 'Nome',
		langCode			: 'Orientac~ao de idioma',
		tabIndex			: ''Indice de Tubulac~ao',
		advisoryTitle		: 'Título',
		...
		noAnchors		: '(N~ao há referências disponíveis no documento)',
		noUrl			: 'Por favor introduza a hiperligac~ao URL',
		noEmail			: 'Por favor introduza o endereco de e-mail'
	},
	...
	anchor :
	{
		...
		menu		: 'Propriedades da ^Ancora',
		title		: 'Propriedades da ^Ancora',
		name		: 'Nome da ^Ancora',
		errorName	: 'Por favor, introduza o nome da ^ancora',
	...
	checkboxAndRadio :
	{
		checkboxTitle : 'Propriedades da Caixa de Verificac~ao',
		radioTitle	: 'Propriedades do Bot~ao de Opc~ao',
		value		: 'Valor',
	...
	select :
	{
		title		: 'Propriedades da Caixa de Combinac~ao',
		selectInfo	: 'Informac~ao',
		opAvail		: 'Opc~oes Possíveis',
		value		: 'Valor',
		size		: 'Tamanho',
		lines		: 'linhas',
		chkMulti	: 'Permitir selecc~oes múltiplas',
		opText		: 'Texto',
		opValue		: 'Valor',
		btnAdd		: 'Adicionar',
		btnModify	: 'Modificar',
	...
	textarea :
	{
		title		: 'Propriedades da 'Area de Texto',
		cols		: 'Colunas',
		rows		: 'Linhas'
	},
	...
	image :
	{
		...
		titleButton	: 'Propriedades do Bot~ao de imagens',
		menu		: 'Propriedades da Imagem',
		infoTab		: 'Informac~ao da Imagem',
	...
	flash :
	{
		...
		hSpace			: 'Esp.Horiz',
		vSpace			: 'Esp.Vert',
		validateSrc		: 'Por favor introduza a hiperligac~ao URL',
	...
	spellCheck :
	{
		toolbar			: 'Verificac~ao Ortográfica',
		title			: 'Spell Check', // MISSING
		notAvailable	: 'Sorry, but service is unavailable now.', // MISSING
		errorLoading	: 'Error loading application service host: %s.', // MISSING
		notInDic		: 'N~ao está num directório',
		changeTo		: 'Mudar para',
		btnIgnore		: 'Ignorar',
		...
		btnUndo			: 'Anular',
		noSuggestions	: '- Sem sugest~oes -',
		progress		: 'Verificac~ao ortográfica em progresso…',
		noMispell		: 'Verificac~ao ortográfica completa: n~ao foram encontrados erros',
		noChanges		: 'Verificac~ao ortográfica completa: n~ao houve alterac~ao de palavras',
		oneChange		: 'Verificac~ao ortográfica completa: uma palavra alterada',
		manyChanges		: 'Verificac~ao ortográfica completa: %1 palavras alteradas',
		ieSpellDownload	: ' Verificac~ao ortográfica n~ao instalada. Quer descarregar agora?'
	},
	...
	numberedlist	: 'Numerac~ao',
	bulletedlist	: 'Marcas',
	indent			: 'Aumentar Avanco',
	outdent			: 'Diminuir Avanco',
	...
	blockquote : 'Bloco de citac~ao',

	clipboard :
	{
		title		: 'Colar',
		cutError	: 'A configurac~ao de seguranca do navegador n~ao permite a execuc~ao automática de operac~oes de cortar. Por favor use o teclado (Ctrl/Cmd+X).',
		copyError	: 'A configurac~ao de seguranca do navegador n~ao permite a execuc~ao automática de operac~oes de copiar. Por favor use o teclado (Ctrl/Cmd+C).',
	...
	docprops :
	{
		...
		docType : 'Tipo de Cabecalho do Documento',
		docTypeOther : 'Outro Tipo de Cabecalho do Documento',
		...
		marginRight : 'Direita',
		marginBottom : 'Fundo',
		metaKeywords : 'Palavras de Indexac~ao do Documento (separadas por virgula)',
