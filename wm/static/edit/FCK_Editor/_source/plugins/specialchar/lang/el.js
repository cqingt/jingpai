...
{
	euro: 'Σμβολο Ευρ',
	lsquo: 'Αριστερ χαρακτρα μονο εισαγωγικο',
	rsquo: 'Δεξι χαρακτρα μονο εισαγωγικο',
	ldquo: 'Αριστερ χαρακτρα διπλο εισαγωγικο',
	rdquo: 'Δεξι χαρακτρα διπλο εισαγωγικο',
	ndash: 'Παλα en',
	mdash: 'Παλα em',
	iexcl: 'Ανποδο θαυμαστικ',
	cent: 'Σμβολο Σεντ',
	pound: 'Σμβολο λρα',
	curren: 'Σμβολο συναλλαγματικ μονδα',
	yen: 'Σμβολο Γιν',
	brvbar: 'Σπασμνη μπρα',
	sect: 'Σμβολο τμματο',
	uml: 'Διαρεση',
	copy: 'Σμβολο πνευματικν δικαιωμτων',
	...
	AElig: 'Latin Capital letter AE', // MISSING
	...
	aelig: 'Latin small letter ae', // MISSING
