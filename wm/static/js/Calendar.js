...
__ci.document.writeln('td.sat {color:#64a3f3;background-color:#EFEFEF;}');
__ci.document.writeln('td.sun {color:#64a3f3;background-color:#EFEFEF;}');
__ci.document.writeln('td.normal {background-color:#64a3f3;}');
