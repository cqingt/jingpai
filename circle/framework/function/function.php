...
function memberLevelHtml($param){
	return "<div class=\"member-rank member-rank-".$param['cm_level']."\" title=\"".L('circle_level_introduction_page')."\"><a href=\"".CIRCLE_SITE_URL."/index.php?act=group&op=level_intr&c_id=".$param['circle_id']."\" target=\"_blank\">".($param['cm_levelname'] == ''?L('circle_violation'):$param['cm_levelname'])."</a><i></i><em style=\"color: #e4393c;\">LV".$param['cm_level']."</em></div>";
}
/**
 * 文本过滤
