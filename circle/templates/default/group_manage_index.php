		...
		(
			{
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['nc_cut'];?>','index.php?act=cut&op=pic_cut&filename=<?php echo ATTACH_CIRCLE;?>/group/<?php echo intval($_GET['c_id']);?>.jpg&x=200&y=200&resize=1&url='+data.url,780);
					}else{
						alert(data.msg);
					}
