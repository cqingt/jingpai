$(function(){
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url:'index.php?act=goods_edit&op=image_upload&upload_type=uploadedfile&store_id='+STORE_ID,
    ...
    $('#add_album').fileupload({
        dataType: 'json',
        url: 'index.php?act=goods_edit&op=image_upload&store_id='+STORE_ID,
    ...
    $('a[nctype="mb_add_img"]').click(function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?act=goods_edit&op=pic_list&item=mobile&store_id='+STORE_ID);
    });
    // 关闭 图片选择
    ...
    $('div[nctype="mobile_pannel"]').on('click', 'a[nctype="mp_rpl"]', function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load('index.php?act=goods_edit&op=pic_list&item=mobile&type=replace&store_id='+STORE_ID);
    });
    // 插图图片
