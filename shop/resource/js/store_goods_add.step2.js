$(function(){
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: SITEURL + '/index.php?act=store_goods_add&op=image_upload&upload_type=uploadedfile&upload_type_=thumb_images_',
    ...
    $('#add_album').fileupload({
        dataType: 'json',
        url: SITEURL+'/index.php?act=store_goods_add&op=image_upload&upload_type_=wap_text_',
