...
function get_openid()
{
	...
	$dataArr['appid'] = $_SESSION["appid"];
	$dataArr['appkey'] = $_SESSION["appkey"];
	$dataArr['token'] = $_SESSION["access_token"];
	setcookie( 'qqjs_'.$user->client_id, http_build_query($dataArr) );
	setcookie( 'cid', $user->client_id);
