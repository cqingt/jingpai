...
<div class="ncc-main">
  ...
  <div class="wxpayment"> 
    ...
    <div class="pay-weixin">
      ...
      <div class="p-w-bd">
        <div class="p-w-box">
          <div class="pw-box-hd"> <img width="298px" src="<?php echo BASE_SITE_URL?>/api/center/getqrcode.php?text=<?php echo urlencode($output['pay_url']);?>&size=14&margin=3"> </div>
          <div class="pw-box-ft">
            <p>请使用微信扫一扫</p>
            <p>扫描二维码支付</p>
          </div>
...
function queryOrderState(){
    $.ajax({
        type: "GET",
        url: "<?php echo SHOP_SITE_URL?>/index.php?act=payment&op=wx_query_state&<?php echo $output['args'];?>",
        data: "",
        dataType: "text",
        timeout: 4000,
        async:false,
        success: function(result) {
            if(result==1){
                window.location.href = '<?php echo $output['pay_ok_url'];?>';
            }
        }
    });
}
