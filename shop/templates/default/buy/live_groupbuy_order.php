...
<div class="ncc-main">
  <div class="ncc-title">
    <h3>我的藏品惠</h3>
    <h5>查看藏品惠清单，增加减少藏品惠数量，进入下一步操作。</h5>
  </div>
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        ...
        <tr class="shop-list">
          ...
          <td><a title="减少藏品惠数" class="add-substract-key tip" href="javascript:void(0)" id="reduce" >-</a>
            <input type="text" value="1" name="q_number" maxlength="4" class="text w20" id="q_number">
            <a title="增加藏品惠数" class="add-substract-key tip" href="javascript:void(0)" id="add">+</a>
