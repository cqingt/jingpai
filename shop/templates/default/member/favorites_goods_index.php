  ...
  <table class="ncm-default-table shoplist">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><span class="goods-price"><?php if($favorites['goods']['promotion_price'] > 0 ){ ?><?php echo ncPriceFormat($favorites['goods']['promotion_price']);?><?php }else{ ?><?php echo ncPriceFormat($favorites['goods']['goods_price']);?><?php } ?></span></td>
