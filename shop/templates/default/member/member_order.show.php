  ...
  <div class="ncm-order-info">
    <div class="ncm-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><span><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>，</span><span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['mob_phone'];?>，</span><span>
		  <?php echo @iconv("GBK","UTF-8",$output['order_info']['extend_order_common']['reciver_info']['address']);?></span></dd>
        </dl>
		<!--
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
        ...
        <dl>
          ...
          <dd><?php echo $output['order_info']['extend_store']['store_name']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
			...
			<a style="float: left;display: block;background: url(/shop/templates/default/images/icon-chat.png)no-repeat;width: 16px;height: 14px;margin: 3px 0 0 8px;" href="javascript:void(0);" title="在线联系" <?php if(in_array($output['order_info']['extend_store']['store_id'], model('store')->getOwnShopIds())){?>onclick="NTKF.im_openInPageChat('sc_1000_9999')"
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <?php if ($output['order_info']['if_evaluation'] && $output['order_info']['refund_state'] != 2) { ?>
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td><!-- 退款 -->
			...
			<!--
				<p><a href="javascript:void(0);" onclick="get_confirm('确认系统将自动为您的整张订单确认收货，否则请取消申请！', 'index.php?act=member_refund&op=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>');">退款/退货</a></p>
			-->
				...
				<!-- 点击弹出框 -->
					  <div class="xcConfirm" id="sub_form_1">
							...
							<input class="btn go-on" type="button" id="JiXuTiJiao" value="继续申请" style="padding: 0px;font-weight:normal;cursor:pointer;" JiXuUrl="index.php?act=member_refund&op=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">
          ...
          <td colspan="7" class="tl"><div class="ncm-goods-gift">赠品：
              <ul>
                ...
                <li><a target="_blank" title="赠品：<?php echo $zengpin_info['goods_name'];?> * <?php echo $zengpin_info['goods_num'];?>" href="<?php echo $zengpin_info['goods_url']; ?>"><img src="<?php echo $zengpin_info['image_60_url']; ?>" onMouseOver="toolTip('<img src=<?php echo $zengpin_info['image_240_url']; ?>>')" onMouseOut="toolTip()" /></a></li>
                    <li style="font-size:12px;line-height: 30px"> <?php echo $zengpin_info['goods_name'];?> × <?php echo $zengpin_info['goods_num'];?></li>
                <?php } ?>
              </ul>
        ...
        <tr>
          <td colspan="20"><dl class="freight">
              ...
              <?php if(!empty($output['order_info']['pay_fee']) && $output['order_info']['pay_fee'] > 0){ ?>
                  &nbsp;货到付款手续费：<span>¥<?php echo $output['order_info']['pay_fee']?></span>&nbsp;
              <?php }?>
              </dd>
            </dl>
            <dl class="sum">
              ...
              <dd><em><?php echo $output['order_info']['pd_amount']; ?></em>元</dd>
               <?php } ?>
                <?php if($output['order_info']['money_paid']>0 && $output['order_info']['order_state'] == ORDER_STATE_NEW){ ?>
                    <dt style="color:blue">已支付总金额：</dt>
                    <dd><em><?php echo $output['order_info']['money_paid']+$output['order_info']['pd_amount']+$output['order_info']['rcb_amount']; ?></em>元</dd>
                <?php } ?>
            </dl></td>
        </tr>
      </tfoot>
