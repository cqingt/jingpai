            ...
            <li class="favorite-pic-list">
              ...
              <div class="favorite-goods-info">
                <dl>
                  ...
                  <dd><span><strong><?php if($favorites['goods']['promotion_price'] > 0 ){ ?><?php echo ncPriceFormat($favorites['goods']['promotion_price']);?><?php }else{ ?><?php echo ncPriceFormat($favorites['goods']['goods_price']);?><?php } ?></strong><?php echo $lang['currency_zh'];?></span><a href="javascript:void(0)"  nc_type="sharegoods" data-param='{"gid":"<?php echo $favorites['goods']['goods_id'];?>"}' class="sns-share" title="<?php echo $lang['favorite_snsshare_goods'];?>"><i class="icon-share"></i><?php echo $lang['nc_snsshare'];?></a></dd>
