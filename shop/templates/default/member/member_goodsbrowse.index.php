        ...
        <li id="browserow_<?php echo $v['goods_id']; ?>">
          ...
          <div class="browse-goods">
            ...
            <dl class="goods-info">
              ...
              <?php }?> -->
              <em class="sale-price"><?php if($v['goods_price'] <= 1){ echo '咨询客服'; }else{ ?><?php echo $lang['currency'];?><?php if($v['promotion_price'] > 0){ echo $v['promotion_price']; }else{ echo $v['goods_price']; } ?><?php } ?></em>
