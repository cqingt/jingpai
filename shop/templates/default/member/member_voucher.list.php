      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle">
          <?php if ($val['voucher_state'] == '1'){?>
            ...
            <?php if($val['voucher_t_cate_rule'] == '3'){?>
  
  

              <span><a href="<?php echo 'http://www.96567.com/goods-'.(@reset(explode(',',$val['voucher_t_diff_goods']))).'.html';?>" class="btn-green" ><i class="icon-shopping-cart"></i><p>使用</p></a></span>
