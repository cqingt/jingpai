...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <div class="alert alert-block alert-info">
     ...
     <ul><li><strong><?php echo $lang['member_show_receive_info'].$lang['nc_colon'];?></strong><?php echo $output['order_info']['extend_order_common']['reciver_name']?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['order_info']['extend_order_common']['reciver_info']['phone'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @iconv("GB2312","UTF-8",$output['order_info']['extend_order_common']['reciver_info']['address']);?></li>
