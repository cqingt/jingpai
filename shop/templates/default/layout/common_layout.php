...
<head>
	...
	<?php if($output['seo_keywords'] != '尾品竞拍,'){?>
    <meta name="keywords" content="<?php echo $output['seo_keywords']; ?>" />
	<?php }?>
	<?php if($output['seo_description'] != '尾品竞拍,'){?>
...
<!-- 顶部广告展开效果-->
<!-- 顶部广告展开效果-->
<div  class="header-wrap"  <?php if ($output['hidden_nctoolbar'] == 1) {?>style="background: #FFF;"<?php }?> style="display: block">
...
<nav class="public-nav-layout" style="display: block">
    <div class="wrapper">
        <a class="spring-festival" href="#" target="_blank"><img src="#" alt=""></a>
        <div class="all-category" style="display: inline;">
            <?php require template('layout/home_goods_class');?>
        </div>
        <ul class="site-menu">
            <li style="display: none">
                <a href="<?php echo LEPAI_SITE_URL;?>" <?php if($output['index_sign'] == 'index' && $output['index_sign'] != '0') {echo 'class="current"';} ?>><?php echo $lang['nc_index'];?></a></li>
