...
<div id="ncToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
	...
	?>><span class="icon-oce"><img src="http://www.96567.com/shop/templates/default/images/oce.png" alt=""></span><i id="new_msg" class="new_msg" style="display:none;"></i><span class="tit">在线客服</span></a></div>
    </div>
    <div class="variation">
      <div class="middle">
	  ...
	  <dl class="weixin">
        ...
        <dd>
          <h4>扫描二维码<br/>
            关注商城微信号</h4>
			<?php if($output['YiShu']){ ?>
			  <img src="http://www.96567.com/shop/templates/default/images/art/footerwechat.jpg" > 
			<?php }else{ ?>
