...
<div class="banner"><a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$output['store_info']['store_id']));?>" class="img">
    ...
    <div id="nav" class="ncs-nav">
      <ul>
        ...
        <li class="<?php if ($output['page'] == 'shop_view') {?>active<?php }else{?>normal<?php }?>"><a href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $output['store_info']['store_id']))?>"><span>全部商品<i></i></span></a></li>
