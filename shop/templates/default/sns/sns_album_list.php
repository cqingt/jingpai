...
<div class="wrapper dfclearfix mtb">
	<div class="picture-content dfclearfix">
		...
		<div class="handover_con mt">
			<div class="demo">
			 <?php if($output['relation'] == '3'){?>
				<div class="btn-found-photo">
					<div class="btnimg" id="open_uploader"></div>
            ...
            <form method="post" action="" id="fileupload" enctype="multipart/form-data">
              ...
              <div class="upload-txt"><span><?php echo $lang['album_batch_upload_description'].$output['setting_config']['image_max_filesize'].'KB'.$lang['album_batch_upload_description_1'];?></span> </div>
					...
					<a href="JavaScript:void(0);" uri="index.php?act=sns_album&op=album_add" nc_type="dialog" dialog_title="<?php echo $lang['album_new_class_add'];?>"  class="btn1"><?php echo $lang['album_new_class_add'];?></a>
					<?php if(C('malbum_max_sum') > 0){?>
