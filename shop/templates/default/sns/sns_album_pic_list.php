  ...
  <div id="pictureFolder" class="album">
    <div class="intro">
      ...
      <?php if($output['relation'] == 3){?>
          <div class="button" style="width: 117px;"><a id="open_uploader" href="JavaScript:void(0);" class="ncsc-btn ncsc-btn-acidblue "><i class="icon-cloud-upload"></i><?php echo $lang['sns_upload_more_pic'];?></a></div>
