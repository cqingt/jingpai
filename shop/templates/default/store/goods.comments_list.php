      ...
      <div class="ncs-comment">
        ...
        <div class="ncs-goods-info-content bd" id="ncGoodsRate">
          ...
          <div class="ncs-goods-title-nav">
            <ul id="comment_tab">
              <li <?php echo empty($output['type']) ? 'class="current"' : '' ;?>><a href="<?php echo urlShop('goods', 'comments_list', array('goods_id' => $output['goods']['goods_id']));?>"><?php echo $lang['goods_index_evaluation'];?>(<?php echo intval($output['goods_evaluate_info']['all']);?>)</a></li>
              <li <?php echo $output['type'] == '1'?'class="current"':'';?>><a href="<?php echo urlShop('goods', 'comments_list', array('goods_id' => $output['goods']['goods_id'],'type' => '1'));?>">好评(<?php echo intval($output['goods_evaluate_info']['good']);?>)</a></li>
              <li <?php echo $output['type'] == '2'?'class="current"':'';?>><a href="<?php echo urlShop('goods', 'comments_list', array('goods_id' => $output['goods']['goods_id'],'type' => '2'));?>">中评(<?php echo intval($output['goods_evaluate_info']['normal']);?>)</a></li>
              <li <?php echo $output['type'] == '3'?'class="current"':'';?>><a href="<?php echo urlShop('goods', 'comments_list', array('goods_id' => $output['goods']['goods_id'],'type' => '3'));?>">差评(<?php echo intval($output['goods_evaluate_info']['bad']);?>)</a></li>
            </ul>
          </div>
