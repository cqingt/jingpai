...
<div class="wrapper mt10">
  <div class="ncs-main">
    <div class="flexslider" <?php echo (empty($output['store_slide']))?'style="display:none"':'';?>>
      <ul class="slides">
        ...
        <ul>
          ...
          <li>
            <dl>
			  ...
			  <span class="price"><?php if($value['goods_price'] <= 0){echo '咨询客服';}else{?><i><?php echo $lang['currency'];?></i> <?php if($value['promotion_price'] > 0) { ?> <?php echo $value['promotion_price'];?> <?php }else{ ?> <?php echo $value['goods_price']; }?> <?php } ?></span> 
              ...
              <dd class="goods-promotion"><span><?php echo $value['promotion_type'];?></span></dd>
              <?php } ?>
              </dl>
          </li>
          <?php }?>
        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-name"><a href="<?php echo urlShop('goods', 'index', array('goods_id'=>$value['goods_id']));?>" title="<?php echo $value['goods_name'];?>" target="_blank"><?php echo $value['goods_name'];?></a></dd>
              <dd class="goods-info"><span class="price">
			  <?php if($value['goods_price'] <= 0){echo '咨询客服';}else{?><i><?php echo $lang['currency'];?></i>
			  <?php if($value['promotion_price'] > 0) { ?> <?php echo $value['promotion_price'];?> <?php }else{ ?> <?php echo $value['goods_price']; }?> <?php } ?>
