...
<div class="ncs-goods-info-content" nctype="gbc_content">
  ...
  <div class="ncs-combo-container" <?php if ($current) {?>style="display:none;"<?php }?>>
    <div class="default-goods">
      ...
      <dl>
        ...
        <dd class="goods-price">商城价<?php echo $output['goods_info']['promotion_price'] > 0 ? $lang['nc_colon'].$lang['currency'].$output['goods_info']['promotion_price'] : $lang['nc_colon'].$lang['currency'].$output['goods_info']['goods_price'];?></dd>
      ...
      <ul>
        ...
        <li <?php if ($j == 0) {?>class="combo-goods-first"<?php $j++;}?>>
          ...
          <dl>
            ...
            <dd>
              <input type="checkbox" class="checkbox" nctype="comb"  name="<?php echo $combo['goods_id'];?>" data-param="{price:<?php echo $combo['promotion_price'] > 0 ? $combo['promotion_price'] : $combo['goods_price'];?>,marketprice:<?php echo $combo['goods_marketprice'];?>}">
              <?php echo $combo['promotion_price'] > 0 ? $lang['currency'].$combo['promotion_price'] : $lang['currency'].$combo['goods_price'];?></dd>
          </dl>
        </li>
        <?php }?>
      </ul>
    ...
    <dl>
    <dt>推荐购买组合</dt>
    <dd>商城总价：<?php echo $lang['currency'];?><em nctype="gbcc_p"><?php echo $output['goods_info']['promotion_price'] > 0 ? $output['goods_info']['promotion_price'] : $output['goods_info']['goods_price'];?></em></dd>
  ...
  $(function(){
      var g_p = <?php echo $output['goods_info']['promotion_price'] > 0 ? $output['goods_info']['promotion_price'] : $output['goods_info']['goods_price'];?>;
