...
<?php if($output['store_info']['is_own_shop']){ ?>
    <div class="ser-box ser-right">
            <a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzkzODA3MjY4MF8xNDAzMDBfNDAwODE5NjU2N18yXw" target="_blank">
                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/se2.png">
                <p>QQ咨询</p>
            </a>
        </div>
		<?php } ?>
        <div class="ser-box" <?php if($output['store_info']['is_own_shop'] == 0){ ?>style="padding-left: 50px;"<?php } ?>>
		<!--http://kefu.qycn.com/vclient/chat/?websiteid=109465&groupid=38509  target="_blank"-->
            <a href="javascript:void(0);" <?php if($output['store_info']['is_own_shop'] == 1){?> 
	...
	?>>
                <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/se1.png">
                <p>在线客服</p>
            </a>
        </div>
    </div>
