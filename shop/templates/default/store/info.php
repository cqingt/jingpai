...
<?php } ?>
	...
	<dt>商户保障：</dt>
        ...
        <span id="certMaterqtian" class="text-hidden fl ml5" title="7天退换"></span>
        <?php }?>
...
<?php } ?>
    ...
    <div class="goto"><a href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" name="store_http">进入商家店铺</a><a href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')" >收藏店铺<!--em nctype="store_collect"><?php echo $output['store_info']['store_collect']?></em--></a></div>
...
<div class="self-support">
   <h2><i><?php echo $output['store_info']['store_name'];?></i><strong>自营</strong></h2>
   <div class="btn-boxes">
    <a class="a1" name="store_http" href="http://www.96567.com/index.php?act=show_store&op=index&store_id=<?php echo $output['store_info']['store_id'];?>" target="_blank"><i>进入店铺</i></a>
    <a class="a2" name="store_kefu" href="javascript:void(0);" onclick="NTKF.im_openInPageChat('sc_1024_9999')"><i>联系客服</i></a>
   </div>
   <dl class="messenger">   
  <dt>服务保障：</dt>
       <dd>
