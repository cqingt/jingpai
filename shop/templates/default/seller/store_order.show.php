    ...
    <div class="ncsc-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>&nbsp; <?php echo @$output['order_info']['extend_order_common']['reciver_info']['mob_phone'];?>&nbsp;
		  <?php 
    ...
    <table class="ncsc-default-table order">
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <?php echo $goods['goods_pay_price']; ?> <?php echo $goods['pingtai_voucher_price'] > 0 ? "<br />+使用平台优惠劵(“".$goods['pingtai_voucher_price']."元”)" : '';?> * <?php echo $goods['commis_rate']; ?>% = <b><?php echo ncPriceFormat(($goods['goods_pay_price']+$goods['pingtai_voucher_price'])*$goods['commis_rate']/100); ?></b>
          <?php } ?>
          </td>
