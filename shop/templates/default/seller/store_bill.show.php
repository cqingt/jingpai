...
.bill_alert {
  ...
  <div class="bill_alert bill-alert-block mt10">
    ...
    <ul>
      ...
      <li>银行开户名：<?php echo $output['store_joinin']['bank_account_name'];?></li>
      <li>公司银行账号：<?php echo $output['store_joinin']['bank_account_number'];?></li>
      <li>开户银行支行名称：<?php echo $output['store_joinin']['bank_name'];?></li>
