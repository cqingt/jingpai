...
$encode = mb_detect_encoding($output['order_info']['extend_order_common']['reciver_info']['area'], array("ASCII",'UTF-8',"GB2312","GBK",'BIG5'));
if($encode != 'UTF-8'){
	echo iconv("GB2312","UTF-8//IGNORE",$output['order_info']['extend_order_common']['reciver_info']['area']);
}else{
	echo $output['order_info']['extend_order_common']['reciver_info']['area'];
}
?>" name="reciver_area" id="reciver_area">
    <input type="hidden" value="<?php 
			$encode = mb_detect_encoding($output['order_info']['extend_order_common']['reciver_info']['street'], array("ASCII",'UTF-8',"GB2312","GBK",'BIG5'));
			if($encode != 'UTF-8'){
				echo iconv("GB2312","UTF-8//IGNORE",$output['order_info']['extend_order_common']['reciver_info']['street']);
			}else{
				echo $output['order_info']['extend_order_common']['reciver_info']['street'];
			}
			?>" name="reciver_street" id="reciver_street">
    ...
    <input type="hidden" value="<?php echo JieMiMobile($output['order_info']['extend_order_common']['reciver_info']['tel_phone']);?>" name="reciver_tel_phone" id="reciver_tel_phone">
    ...
    <table class="ncsc-default-table order deliver">
      <tbody>
        ...
        <?php }?>
        <tr>
          <td colspan="20" class="tl bdl bdr" style="padding:8px" id="address"><strong class="fl"><?php echo $lang['store_deliver_buyer_adress'].$lang['nc_colon'];?></strong><span id="buyer_address_span"><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>&nbsp;<?php echo $output['order_info']['extend_order_common']['reciver_info']['mob_phone'];?>&nbsp;
		  <?php 
$encode = mb_detect_encoding($output['order_info']['extend_order_common']['reciver_info']['address'], array("ASCII",'UTF-8',"GB2312","GBK",'BIG5'));
if($encode != 'UTF-8'){
	echo iconv("GB2312","UTF-8//IGNORE",$output['order_info']['extend_order_common']['reciver_info']['address']);
}else{
	echo $output['order_info']['extend_order_common']['reciver_info']['address'];
}
?></span><?php echo $output['order_info']['extend_order_common']['reciver_info']['dlyp'] ? '[自提服务站]' : '';?>
