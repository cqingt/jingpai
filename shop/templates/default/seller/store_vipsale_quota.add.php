...
<div class="ncsc-form-default">
  <form id="add_form" action="<?php echo urlShop('store_vipsale', 'vipsale_quota_add_save');?>" method="post">
    <dl>
      <dt><i class="required">*</i>购买数量</dt>
      <dd>
          <input id="vipsale_quota_quantity" name="vipsale_quota_quantity" type="text" class="text w30" /><em class="add-on">月</em><span></span>
        <p class="hint">购买单位为月(30天)，您可以在所购买的周期内发布会员特价活动</p>
        <p class="hint"><?php echo '每月(30天)您需要支付'.$output['setting_config']['vipsale_price'].$lang['nc_yuan'];?> ; </p>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
    	...
    	submitHandler:function(form){
            var unit_price = <?php echo C('vipsale_price');?>;
            var quantity = $("#vipsale_quota_quantity").val();
