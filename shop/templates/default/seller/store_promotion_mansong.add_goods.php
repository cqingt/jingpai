<div class="div-goods-select">
    <table class="search-form">
        ...
        <tr>
            ...
            <td class="tc w70"><a href="index.php?act=store_promotion_mansong&op=mansong_add_goods" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
            <td class="w10"></td>
        </tr>
        </tbody>
    </table>
