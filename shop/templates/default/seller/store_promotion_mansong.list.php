  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
          <span><a href="index.php?act=store_promotion_mansong&op=mansong_update&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-blue"><i class="icon-edit"></i>
                  <p><?php echo ($val['end_time'] > TIMESTAMP)?$lang['nc_edit']:'查看';?></p>
              </a></span>
           <span><a nctype="btn_mansong_del" data-mansong-id="<?php echo $val['mansong_id'];?>" href="javascript:return void(0)" class="btn-red"><i class="icon-trash"></i>
