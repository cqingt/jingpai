...
<form method="get" action="index.php">
  <table class="search-form">
    ...
    <tr>
      <td>&nbsp;</td>
	  <th style="width:100px;">推荐商品&nbsp;&nbsp;<input type="checkbox" name="store_goods_commend" value="1" <?php if(isset($output['store_goods_commend']) && $output['store_goods_commend'] == 1){?> checked="checked"<?}?>></th>
