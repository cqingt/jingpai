    ...
    <div id="printarea">
      ...
      <div class="orderprint">
        ...
        <table class="buyer-info">
          ...
          <tr>
            <td colspan="3"><?php echo $lang['member_printorder_address'].$lang['nc_colon']; ?><?php echo @iconv("GB2312","UTF-8",$output['order_info']['extend_order_common']['reciver_info']['address']);?></td>
          </tr>
          <tr>
