<div class="div-goods-select">
    <table class="search-form">
        ...
        <tr>
            ...
            <td class="tc w70"><a href="index.php?act=store_voucher&op=mansong_add_goods" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
            <td class="w10"></td>
        </tr>
        </tbody>
    </table>
            ...
            <ul class="goods-list" nctype="bundling_goods_add_tbody" style=" width:760px;">
                <?php foreach ($output['goods_list'] as $val){?>
                    <li nctype="<?php echo $val['goods_id'];?>">
                        ...
                        <dl class="goods-info">
                            <dt><a href="#" target="_blank" title="商品名称/货号 <?php echo $val['goods_name'];?><?php  if($val['goods_serial'] != ''){ echo $val['goods_serial'];}?>"><?php echo $val['goods_name'];?></a></dt>
