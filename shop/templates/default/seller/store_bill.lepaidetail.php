...
<div class="ncsc-oredr-show">
  <div class="ncsc-order-info">
    <div class="ncsc-order-details">
      <div class="title">乐拍订单信息</div>
      <div class="content">
        <dl>
          <dt><?php echo $lang['store_show_order_receiver'].$lang['nc_colon'];?></dt>
          <dd><?php echo $output['order_info']['reciver_info']['true_name'];?>&nbsp; <?php echo @$output['order_info']['reciver_info']['mob_phone'];?>&nbsp; <?php echo @$output['order_info']['reciver_info']['area_info'].@$output['order_info']['reciver_info']['address'];?></dd>
        </dl>
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
          <dd>
          ...
          <dd><?php echo $output['order_info']['order_sn']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                ...
                <li><?php echo $lang['store_order_pay_method'].$lang['nc_colon'];?><span><?php echo orderPaymentName($output['order_info']['payment_code']); ?>
                ...
                <li><?php echo $lang['store_show_order_send_time'].$lang['nc_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_info']['shipping_time']); ?></span></li>
                <?php } ?>
    ...
    <div class="ncsc-order-condition">
      ...
      <ul>
        <li>1. 商品已发出；
          ...
          物流公司：<?php echo $output['order_info']['shipping_ename']?>；单号：<?php echo $output['order_info']['shipping_code'];?>。
  ...
  <div id="order-step" class="ncsc-order-step">
    ...
    <dl class="<?php if($output['order_info']['shipping_time']) echo 'current'; ?>">
      <dt>商家发货</dt>
      <dd class="bg"> </dd>
      <dd class="date" title="<?php echo $lang['store_show_order_send_time'];?>"><?php echo date("Y-m-d H:i:s",$output['order_info']['shipping_time']); ?></dd>
    </dl>
  ...
  <div class="ncsc-order-contnet">
    <table class="ncsc-default-table order">
      ...
      <tbody>
        ...
        <tr>
          <th colspan="6" style="border-right: 0;"> <div class="order-deliver"> <span>物流公司： <a target="_blank" href="<?php echo $output['order_info']['express_info']['e_url'];?>"><?php echo $output['order_info']['shipping_ename'];?></a></span> <span><?php echo $lang['store_order_shipping_no'].$lang['nc_colon'];?> <?php echo $output['order_info']['shipping_code']; ?></span><span><a href="javascript:void(0);" id="show_shipping">物流跟踪<i class="icon-angle-down"></i>
              <div class="more"><span class="arrow"></span>
                <ul id="shipping_ul">
                  <li>加载中...</li>
                </ul>
        ...
        <tr class="bd-line">
          <td>&nbsp;</td>
          <td class="w50"><div class="pic-thumb"><a target="_blank" href="<?php echo urlLepai('auction',$goods['G_Id']);?>"><img src="<?php echo $goods['G_MainImg']; ?>" /></a></div></td>
          <td class="tl"><dl class="goods-name">
              <dt><a target="_blank" href="<?php echo urlLepai('auction',$goods['G_Id']); ?>"><?php echo $goods['G_Name']; ?></a></dt>
              <dd>
          ...
          <td><?php echo $output['order_info']['goods_amount']; ?>
            </td>
          <td>1</td>
          <td>乐拍</td>
          <td class="commis bdl bdr">
          <?php echo $output['order_info']['order_amount']; ?> * <?php echo $output['store_info']['commis_rate']; ?>% = <b><?php echo ncPriceFormat($output['order_info']['order_amount']*$output['store_info']['commis_rate']/100); ?></b>
          </td>
