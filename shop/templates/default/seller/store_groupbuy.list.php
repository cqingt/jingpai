...
<?php } ?>
      ...
      <td><?php if($group['state'] == 30){?><a href="<?php echo urlShop('store_groupbuy','groupbuy_up',array('groupbuy_id'=>$group['groupbuy_id']));?>">编辑  </a><?php }?><?php echo $group['groupbuy_state_text'];?></td>
    </tr>
    <?php }?>
    <?php }else{?>
    <tr>
