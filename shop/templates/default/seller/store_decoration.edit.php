  ...
  <form action="">
    <dl>
      ...
      <dd>
        ...
        <p class="hint">选择上传jpg/gif/png格式图片，建议宽度不超过1200像素，高度不超过400像素，如超出此范围，请先自行对图片进行裁切调整。</p>
      </dd>
    </dl>
  </form>
  <dl>
...
<script type="text/javascript" src="<?php echo BASE_SITE_URL;?>/data/resource/kindeditor/kindeditor-min.js" charset="utf-8"></script> 
<script type="text/javascript" src="<?php echo BASE_SITE_URL;?>/data/resource/kindeditor/lang/zh_CN.js" charset="utf-8"></script>
