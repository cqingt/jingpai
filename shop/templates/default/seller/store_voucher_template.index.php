...
<?php if($val['voucher_t_show'] != 1){?>
<span>
  <a class="btn-blue" href="javascript:showDialog('http://www.96567.com/index.php?act=pointvoucher&op=voucherexchange_add&vid=<?php echo encrypt(base64_encode($val['voucher_t_id']), sha1(md5('key')));?>', 'succ', '优惠券领取链接', null, true, null, '', '', '', 120);">
      <i class="icon-edit"></i><p>发放</p>
  </a>
 </span>
<?php }?>
