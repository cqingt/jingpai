  ...
  <div class="seller-cont">
    ...
    <div class="container type-b">
     ...
     <!--      <?php
          ...
          <?php
			 ...
			 ?> -->
          <dd><?php echo $lang['store_site_phone'].$lang['nc_colon'];?><?php echo $output['store_info']['yunying_mobile'];?></dd>

          <dd><?php echo $output['store_info']['yunying_qq'];?>@qq.com</dd>
        </dl>
      </div>
    </div>
    <div class="container type-a">
    ...
    <div class="container type-d h500">
      ...
      <div class="content">
        ...
        <?php if (intval(C('paimai_allow')) == 1){ ?>
        <dl class="xszk">
