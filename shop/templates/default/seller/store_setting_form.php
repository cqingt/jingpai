...
<div class="ncsc-form-default">
  <form method="post"  action="index.php?act=store_setting&op=store_setting" enctype="multipart/form-data" id="my_store_form">
    ...
    <dl>
      <dt>店铺名称：</dt>
      <dd>
       <input type="text" value="<?php echo $output['store_info']['store_name'];?>" disabled="disabled" name="store_name" class="text w400">
        </dd>
    </dl>
    <dl>
  ...
  <!--
    <dl>
      <dt>运营类目：</dt>
      <dd>
          <input type="radio" name="store_is_shuhua_" value="1" <?php if($output['store_info']['store_is_shuhua_'] == 1){echo "checked='checked'";}?>>书画代运营
          <input type="radio" name="store_is_shuhua_" value="0" <?php if(empty($output['store_info']['store_is_shuhua_'])){echo "checked='checked'";}?>>其它
      </dd>
    </dl>
	-->
