...
<div class="nc-login-layout">
  <div class="left-pic"><?php echo loadadv(1077);?></div>
  <div class="nc-login">
    ...
    <div class="nc-login-content" id="demo-form-site">
      <form id="login_form" method="post" action="index.php?act=login&op=login"  class="bg">
        ...
        <dl>
          <dt><?php echo $lang['login_index_username'];?>/手机</dt>
        ...
        <dl>
          <dt>&nbsp;</dt>
          <dd>
            <input type="button" class="submit" id="Log_But" value="<?php echo $lang['login_index_login'];?>">
...
<script>
$(function(){$("#Log_But").click(function(){
    if($("#login_form").valid()){
