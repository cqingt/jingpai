...
<div class="ncg-container wrapper">
  <div class="ncg-layout-l">
      ...
      <div class="ncg-group">
        ...
        <div class="ncg-item">
          ...
          <div class="info" id="main-nav-holder">
            ...
            <div class="require">
              <h4>本藏品惠已被抢<em><?php echo $output['live_groupbuy']['buyer_num'];?></em>个</h4>
              <p>
    ...
    <div class="ncg-title-bar">
      <ul class="tabs-nav">
        <li class="tabs-selected"><a href="javascript:void(0);">藏品惠介绍</a></li>
      </ul>
    </div>
    <div class="ncg-detail-content">
      <div class="ncg-instructions">
        ...
        <ul>
          ...
          <li>2. 单人每笔订单最多藏品惠<strong><?php echo $output['live_groupbuy']['buyer_limit'];?></strong>个兑换码/券，如需更多请再次购买。</li>
          <li>3. 消费藏品惠兑换码/券时，请向商家提供系统发送的”线下藏品惠兑换码“，一码一销。</li>
        </ul>
      </div>
