  ...
  <div class="content">
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        ...
        <div class="goods-promotion"><span><?php echo $v['promotion_type'];?></span></div>
			 <dl class="goods-info">
			  ...
			  <dd>
				<div><em><?php echo ncPriceFormatForList($v['promotion_price']);?></em></div>
			  </dd>
			</dl>
        <?php } else { ?>
			 <dl class="goods-info">
			  <dt><a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank"><?php echo $v['goods_name'];?></a></dt>
			  <dd>
				<div><em><?php echo ncPriceFormatForList($v['goods_price']);?></em></div>
			  </dd>
			</dl>
        <?php } ?>
