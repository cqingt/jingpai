...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/index_riobeifen.css" rel="stylesheet" type="text/css">
...
<div class="aoyunboxes wrapper">
   <a class="btn-aoyun" href="http://www.96567.com/index.php?act=zhuanti&op=ad_20160801#topay">1</a>
</div>
<div class="home-focus-layout"> <?php echo $output['web_html']['index_pic'];?>
  ...
  <!--
	...
	<div class="policy">
      ...
      <h2 class="block">收藏快讯<a class="more" href="/article_cate-1.html" target="_blank">更多></a></h2>
  ...
  <!-- Olympic -->
  <div class="olympic-box wrapper">
     <h2>奥运专属活动</h2>
     <div class="olympic-nav">
         <a class="oly_a1" href="http://www.96567.com/index.php?act=zhuanti&op=ad_20160801#n1" target="_blank">
           <h3>里约奥运火热进行</h3>
           <p>好运投资银条送不停</p>
         </a>
         <a class="oly_a2" href="http://www.96567.com/index.php?act=zhuanti&op=ad_20160801#n3" target="_blank">
           <h3>奥运收藏最后的机会</h3>
           <p>限时特供直降677元</p>
         </a>
         <a class="oly_a3" href="http://www.96567.com/index.php?act=zhuanti&op=ad_20160801#n4" target="_blank">
           <h3>奥运竞猜人人有奖</h3>
           <p>赢北京奥运纪念币</p>
         </a>
         <a class="oly_a4" href="http://www.96567.com/index.php?act=zhuanti&op=ad_20160801#n2" target="_blank">
           <h3>里约奥运“惠”</h3>
           <p>幸运抽奖等你来</p>
         </a>                           
     </div>
...
<div id="myModalRio" class="reveal-modal rio2016">
    <img class="rioimg ri1" src="<?php echo SHOP_TEMPLATES_URL;?>/images/rio-dandan.png"/>
    <img class="rioimg ri2" src="<?php echo SHOP_TEMPLATES_URL;?>/images/rio-dw.png" />
    <img class="rioimg ri3" src="<?php echo SHOP_TEMPLATES_URL;?>/images/rio-tc2016.png"/>
    <img class="rioimg ri4" src="<?php echo SHOP_TEMPLATES_URL;?>/images/rio-text.png" alt="" />
    <img class="rioimg ri5" src="<?php echo SHOP_TEMPLATES_URL;?>/images/rio-ty.png" alt="" />
    <a id="clickMe" class="close-reveal-modal"></a>
</div>

<script>
	$(function(e){
	
  $('#myModalRio').reveal($(this).data());
	// setTimeout("$('#myModalRio,.reveal-modal-bg,.rioimg').fadeOut(800)",4000);
                                ...
                                <?php foreach ($output['hqkx'] as $k=>$v){?>
                                    <?php if($k==0){?>
                                        <li>
                                            ...
                                            <span><a href="<?php echo getCMSArticleUrl($v['article_id']);?>" target="_blank"><?php echo html_substr_word($v['article_content'],50).'...';?></span>
                                        </li>
                                    <?php }else{?>
