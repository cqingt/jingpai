...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="index.php">首页</a> </span> <span class="arrow">></span> <span>商城藏品惠</span></div>
</div>
<div class="ncg-container">
  ...
  <div class="ncg-content">
    ...
    <div class="group-list mt20">
      ...
      <?php }else{ ?>
      <div class="norecommend">暂无藏品惠推荐</div>
      <?php }?>
    </div>
