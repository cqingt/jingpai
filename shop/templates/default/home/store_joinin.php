  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写入驻申请资料<br/>
          请点击“<a href="<?php echo urlShop('store_joinin_c2c', 'step0');?>" target="_blank">我要入驻</a>”进行入驻资料填写</dd>
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_joinin_c2c', 'index');?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况 </dd>
      </dl>
      <div class="bottom"><a href="<?php echo urlShop('store_joinin_c2c', 'step0');?>" target="_blank">我要入驻</a><a href="<?php echo urlShop('store_joinin_c2c', 'index');?>" target="_blank">查看入驻进度</a></div>
    </div>
     <?php }else { ?>
    <div class="user-login">
      <h3>平台商户登录<em>（使用已注册的会员账号）</em></h3>
      ...
      <div class="register">还没有成为我们的合作伙伴？ <a href="index.php?act=login&op=register" target="_blank">立即注册</a></div>
    </div>
    <?php } ?>
  </div>
