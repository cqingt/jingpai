...
<?php if ($output['groupbuy_info']['is_vr']) { ?>
  ...
  -->
<?php } else { ?>
  <span><a href="group_buy.php">藏品惠</a></span>
<?php } ?>
...
<div class="ncg-main <?php echo $output['groupbuy_info']['state_flag'];?>">
	 ...
	 <div class="favour">
		  <div class="favour-l">
			   <i><img src="<?php echo cthumb($output['groupbuy_info']['groupbuy_image1'],'1280');?>" alt=""></i>
		  </div>
		  <div class="favour-r">
			   <h2><?php echo $output['groupbuy_info']['groupbuy_name'];?></h2>
			   <h4><?php echo $output['groupbuy_info']['remark'];?></h4>
			   <div class="favour-rob">
					<div class="rob-a">
						 <span>优惠价：<strong><?php echo $lang['currency'];?></strong><em><?php echo $output['groupbuy_info']['groupbuy_price'];?></em></span>
						 <!--
						 <dl>
						   <dt>购买数量：</dt>
						 ...
						 -->
						 <?php if($output['groupbuy_info']['upper_limit'] != 0 && $output['groupbuy_info']['buy_quantity'] >= $output['groupbuy_info']['upper_limit']){?>
						<a >已售完</a>
						<?php }else{?>
						...
						<!--<?php echo $output['groupbuy_info']['buynow_submit'];?> href="javascript:(0);"-->
						<a href="<?php echo $output['groupbuy_info']['goods_url'];?>" target="_blank" class="btn-rob"><?php echo $output['groupbuy_info']['button_text'];?></a>
						
						<?php }?>
					</div>
					<div class="rob-b">
						 <span class="rb1"><em><?php echo $lang['text_goods_price'];?></em><i><?php echo $lang['currency'];?><?php echo $output['groupbuy_info']['goods_price'];?></i></span>
						 <span class="rb2"><em><?php echo $lang['text_discount'];?></em><?php echo $output['groupbuy_info']['groupbuy_rebate'];?><?php echo $lang['text_zhe'];?></span>
						 <span class="rb3"><em><?php echo $lang['text_save'];?></em><?php echo $lang['currency'];?><?php echo sprintf("%01.2f",$output['groupbuy_info']['goods_price']-$output['groupbuy_info']['groupbuy_price']);?></span>
						 <span class="rb4">
							<p><i class="icon-okay"></i><strong><?php echo $output['groupbuy_info']['virtual_quantity']+$output['groupbuy_info']['buy_quantity']; ?></strong>人已购买</p>
						 </span>
					</div>
			...
			<div class="rob-c">
              <!-- 倒计时 距离本期结束 -->
              <p><i class="icon-time"></i>剩余时间：<span id="d1">0</span><strong><?php echo $lang['text_tian'];?></strong><span id="h1">0</span><strong><?php echo $lang['text_hour'];?></strong><span id="m1">0</span><strong><?php echo $lang['text_minute'];?></strong><span id="s1">0</span><strong><?php echo $lang['text_second'];?></strong>
			  </p>
...
<?php } ?>
          ...
          <li>2. 消费藏品惠兑换码/券时，请向商家提供系统发送的“虚拟藏品惠兑换码”，一码一销。</li>
<?php if ($output['buy_limit'] > 0) { ?>
          <li>3. 单人每笔订单最多藏品惠<strong><?php echo $output['buy_limit']; ?></strong>个兑换码/券，如需更多请再次购买。</li>
<?php } ?>
        </ul>
      </div>
<?php } ?>
      <div class="ncg-intro"><?php echo html_entity_decode($output['goods_body']);?></div>
    </div>
      ...
      <div class="content">
        <div class="ncg-group-command">
          ...
          <dl <?php if($hot_groupbuy_count === 1) { echo "style=' border:none'";$hot_groupbuy_count++; }?> >
            ...
            <dd class="pic-thumb"><a href="<?php echo $hot_groupbuy['groupbuy_url'];?>" target="_blank"><img src="<?php echo cthumb($hot_groupbuy['groupbuy_image1'],'360');?>"></a></dd>
...
$(function(){
   ...
   // $("#groupbuy_order").load('<?php echo urlShop('show_groupbuy', 'groupbuy_order', array('group_id' => $output['groupbuy_info']['groupbuy_id'],'is_vr'=>$output['groupbuy_info']['is_vr']));?>');
    $("#groupbuy_order").load('<?php echo urlShop('show_groupbuy', 'groupbuy_order', array('goods_id' => $output['groupbuy_info']['goods_id']));?>');
