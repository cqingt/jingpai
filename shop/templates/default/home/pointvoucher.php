          ...
          <ul>
            ...
            <li>优惠券面额：
              <select id="price" onchange="javascript:searchvoucher();">
                ...
                <option value="<?php echo $v;?>" <?php echo intval($_GET['price']) == $v?'selected':'';?>><?php echo $v;?><?php echo $lang['currency_zh'];?>代金券</option>
                <?php } ?>
                <?php } ?>
              </select>
            </li>
...
function searchvoucher(){
	var url = '<?php echo BASE_SITE_URL;?>/index.php?act=pointvoucher&op=index';
	var sc_id = $("#sc_id").val();
	if(sc_id){
		url += ('&sc_id='+sc_id);
	}
