...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/miaosha.css" rel="stylesheet" type="text/css">
<script>
    $(function(){
        //--网络营销
        ...
        <div class="NetworkFast" id="inner">
            <div class="djh_ms_menu">
                ...
                <div class="warm-prompt">
                     ...
                     <h4>温馨提示</h4>
                     <p>秒杀频道商品数量有限，请您在秒杀成功后及时付款，以免售罄；订单生成后超过30分钟未付款系统将自动取消。</p>
                </div>
                            ...
                            <div class="djh_dang_box">
                                ...
                                <dl>
                                    <?php if($end=='1'){ ?>
                                        <p class="chuo"></p>
                                    <?php } ?>
                                    <dd><a href="<?php echo $v['goods_url'];?>" target="_blank"><img src="<?php echo $v['goods_image'];?>" alt="<?php echo $v['goods_name'];?>" width="240px" height="240px"/></a></dd>
                                    <dt>
                                    <div>
                                        <?php if($end=='1'){ ?>
