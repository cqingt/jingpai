...
<div class="course-nav-hd wrapper mtb-course">
	...
	<div class="message-board-nav">
		<a class="a1" href="">已有<?php echo $output['totalNum'];?>条评论</a>
...
function pinglun_huifu(id){
    ...
    if(!!pinglun_huifu_text === false){
        ...
        $.ajax({
            ...
            url:"<?php echo urlShop('artist_blog','addPinglunHuifu');?>",
            type:"POST",
            ...
            success:function(data){
                ...
                switch(data)
                {
                    case '1':
                        alert('评论成功');
                        window.location.href="<?php echo urlShop('artist_blog','liuyan',array('aid'=>$_GET['aid']));?>";
                        break;
                    case '11':
    ...
    $("#do_pinglun").click(function(){
        ...
        if(!!pinglun_text === false){
            ...
            $.ajax({
                ...
                url:"<?php echo urlShop('artist_blog','addPinglun');?>",
                type:"POST",
