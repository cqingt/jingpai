...
class store_listControl extends BaseHomeControl {
	...
	public function indexOp(){
		...
		$order = 'store_sort asc,store_sales desc';
		...
		//Tpl::output('html_title',(empty($_GET['keyword']) ? '' : $_GET['keyword'].' - ').$lang['nc_common_search'].' - '.C('site_name'));
		Tpl::output('html_title',(empty($_GET['keyword']) ? '全部店铺 - ' : $_GET['keyword'].' - ').C('site_name'));
