...
class store_settingControl extends BaseSellerControl {
	...
	public function store_settingOp(){
		...
		if (chksubmit()){
            ...
            $param = array(
               ...
               // ,'store_is_shuhua_' => $_POST['store_is_shuhua_']?$_POST['store_is_shuhua_']:0,
            );
   ...
   //          }
			...
			$PhpQRCode->set('date',M_SITE_URL . '/index.php?act=member_store&op=store_info&store_id='.$store_id);
