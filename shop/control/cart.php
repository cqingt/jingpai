...
class cartControl extends BaseBuyControl {
	...
	public function indexOp() {
        ...
        foreach ($cart_list as $cart) {
        	...
        	/* Add is name lt 2016-10-25 活动商品价格单独计算*/
            if(!empty($activity_list[$cart['goods_id']])){
                $cart['goods_price'] = $activity_list[$cart['goods_id']]['A_GoodsPrice'];
            }
            /* End */
	...
	public function updateOp() {
		...
		if ($cart_info['bl_id'] == '0') {
            ...
            //add 秒杀：购物车限制购买数量  xin 20151102
            $logic_buy_1->getMiaoshaInfo($goods_info,$quantity);
            //add end
