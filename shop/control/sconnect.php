...
class sconnectControl extends BaseHomeControl{
	public function __construct(){
		...
		//盛威添加 2015-11-25
		parse_str($_COOKIE['weibojs_'.$_COOKIE['cid']],$arr);
		$_SESSION['slast_key'] = $arr;
	...
	public function registerOp(){
		...
		if($result) {
			...
			showMessage(Language::get('login_usersave_regist_fail'),BASE_SITE_URL.'/index.php?act=login&op=register','html','error');
		}
	}
	/**
	 * 新浪微博账号绑定已有用户
