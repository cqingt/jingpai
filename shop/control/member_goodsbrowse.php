        ...
        if ($browselist){
            ...
            foreach ((array)$goods_list_tmp as $v){
				...
				if($goods_info['promotion_type'] && $goods_info['promotion_price']){
					$goods_list[$v['goods_id']]['promotion_type'] = $goods_info['promotion_type'];
					$goods_list[$v['goods_id']]['promotion_price'] = $goods_info['promotion_price'];
				}
            }
...
Tpl::output('html_title','我的足迹'.' - '.C('site_name'));
