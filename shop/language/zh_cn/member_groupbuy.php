...
$lang['group_template_tip'] = '选择要参加的藏品惠活动及时间段';
$lang['group_name'] = '藏品惠名称';
$lang['group_name_tip'] = '藏品惠标题名称长度最多可输入30个字符';
...
$lang['groupbuy_price_tip'] = '藏品惠价格为该商品参加活动时的促销价格<br/>必须是1~1000000之间的数字(单位：元)<br/>藏品惠价格应包含邮费，藏品惠商品系统默认不收取邮费';
...
$lang['groupbuy_class'] = '藏品惠类别';
$lang['groupbuy_class_tip'] = '请选择藏品惠商品的所属类别';
$lang['groupbuy_area'] = '所属区域';
$lang['groupbuy_goods'] = '藏品惠商品';
$lang['groupbuy_goods_explain'] = '点击上方输入框从已发布商品中选择要参加藏品惠的商品';
$lang['min_quantity_explain'] = '藏品惠成功的最低数值，默认为 "1"';
$lang['virtual_quantity_explain'] = '虚拟购买数量，只用于前台显示，不影响成交记录';
$lang['sale_quantity_explain'] = '藏品惠商品限制总数，不限数量请填 "0" 以商品库存数为准';
$lang['max_num_explain'] = '藏品惠商品总数应等于或小于该商品库存数量<br/>请提前确认要参与活动的商品库存数量足够充足';
$lang['group_pic_explain'] = '用于藏品惠活动页面的图片,请使用宽度352像素、高度352像素、大小1M内的图片，<br/>支持jpg、jpeg、gif、png格式上传。';
$lang['group_pic_explain2'] = '用于藏品惠页侧边推荐位，首页推荐位的图片,请使用宽度210像素、高度180像素、大小1M内的图片，<br/>支持jpg、jpeg、gif、png格式上传。';
$lang['groupbuy_message_not_start'] = '藏品惠活动尚未开始';
$lang['groupbuy_message_close'] = '藏品惠活动已经结束';
$lang['groupbuy_message_start'] = '数量有限请您尽快下单';
$lang['groupbuy_message_success'] = '藏品惠成功可继续购买';

/**
 * 错误提示
 **/
$lang['groupbuy_unavailable'] = '藏品惠功能没有开启';
$lang['no_groupbuy_template_in_progress'] = '没有正在进行中的藏品惠活动';
$lang['no_groupbuy_info'] = '没有藏品惠信息';
$lang['no_groupbuy_template_soon'] = '没有即将开始的藏品惠活动';
$lang['no_groupbuy_template_history'] = '没有历史藏品惠活动';
$lang['no_groupbuy'] = '当前没有藏品惠信息';
$lang['param_error'] = '参数错误';
$lang['group_name_error'] = '藏品惠名称不能为空';
$lang['group_goods_error'] = '请选择藏品惠商品';
$lang['group_help_error'] = '藏品惠说明不能为空';
$lang['start_time_error'] = '开始时间不能为空';
$lang['end_time_error'] = '结束时间不能为空';
$lang['groupbuy_price_error'] = '请输入正确的藏品惠价格';
$lang['group_pic_error'] = '藏品惠图片不能为空，且必须为jpg/gif/png格式';
...
$lang['groupbuy_none'] = '平台当前没有进行中的藏品惠活动';
$lang['group_goods_is_exist'] = '该商品已经在本期藏品惠活动中，请选择其它商品';
$lang['goods_info'] = '商品信息';
$lang['buyer_list'] = '购买记录';
$lang['store_info'] = '店铺信息';
$lang['groupbuy_not_state'] = '藏品惠活动尚未开始';
$lang['groupbuy_closed'] = '藏品惠活动已经结束';
$lang['goods_not_enough'] = '商品库存不足';
$lang['groupbuy_not_enough'] = '藏品惠余额不足';
$lang['groupbuy_sale_quantity'] = '您最多只能购买';
$lang['can_not_buy'] = '您不能购买自己发布的商品';

$lang['groupbuy_add_success'] = '藏品惠活动发布成功请等待审核';
$lang['groupbuy_add_fail'] = '藏品惠活动发布失败';
$lang['groupbuy_edit_success'] = '藏品惠活动编辑成功';
$lang['groupbuy_edit_fail'] = '藏品惠活动编辑失败';
$lang['groupbuy_quota_add_success'] = '藏品惠活动套餐购买成功';

/**
 * 文字
 **/
$lang['groupbuy_title'] = '商品藏品惠';
$lang['groupbuy_soon'] = '即将开始';
$lang['groupbuy_history'] = '往期藏品惠';
$lang['text_year'] = '年';
$lang['text_month'] = '月';
$lang['text_day'] = '日';
$lang['text_tian'] = '天';
...
$lang['text_di'] = '第';
$lang['text_qi'] = '期';
$lang['text_groupbuy'] = '藏品惠';
$lang['text_groupbuy_list'] = '藏品惠列表';
$lang['text_groupbuy_detail'] = '藏品惠详情';
...
$lang['groupbuy_index_add_success']			= '添加藏品惠活动成功';
$lang['groupbuy_index_add_fail']			= '添加藏品惠活动失败';
$lang['groupbuy_index_not_exists']			= '未找到藏品惠活动';
$lang['groupbuy_index_modify_success']		= '修改藏品惠活动成功';
$lang['groupbuy_index_modify_fail']			= '修改藏品惠活动失败';
$lang['groupbuy_index_default_spec']		= '默认规格';
$lang['groupbuy_index_all_group']			= '全部藏品惠';
...
$lang['groupbuy_index_input_name']			= '请填写藏品惠名称';
$lang['groupbuy_index_desc']				= '藏品惠说明';
$lang['groupbuy_index_end_time']			= '结束时间';
$lang['groupbuy_index_search_first']		= '请先搜索藏品惠商品';
...
$lang['groupbuy_index_input_right_price']	= '请正确填写藏品惠价格';
$lang['groupbuy_index_max_per_user_error']  = '请正确填写每人限购数量';
$lang['groupbuy_index_input_price']			= '请填写藏品惠价格';
$lang['groupbuy_index_base_info']			= '藏品惠基本信息';
...
$lang['groupbuy_index_publish_tip']			= '如果“立即发布”，除“藏品惠说明”外的信息将不能再被更改';
$lang['groupbuy_index_start_time']			= '开始时间';
$lang['groupbuy_index_end_time']			= '结束时间';
$lang['groupbuy_index_goods_info']			= '藏品惠商品信息';
...
$lang['groupbuy_index_group_espect_num']	= '能完成藏品惠的期望订购人数';
$lang['groupbuy_index_group_amount']		= '成抢件数';
$lang['groupbuy_index_group_espect_amount']	= '能完成藏品惠的期望订购件数';
...
$lang['groupbuy_index_del_tip']				= '若该藏品惠已完成，则删除该藏品惠将导致未下单的用户无法下单，您确定要这么做吗';
$lang['groupbuy_index_order']				= '订单';
$lang['groupbuy_index_order_state']			= '订购情况';
$lang['groupbuy_index_finish_tip']			= '该操作将要把藏品惠设置为成功状态，您确定要结束预定吗';
...
$lang['groupbuy_index_group_canceled']			= '藏品惠商品已取消';
...
$lang['groupbuy_index_del_success']		= '删除藏品惠活动成功';
$lang['groupbuy_index_del_fail']		= '删除藏品惠活动失败';
$lang['groupbuy_index_datefail']		= '日期不能小于当日，\n默认藏品惠时间为7天！';
$lang['groupbuy_index_startdatefail']		= '藏品惠开始时间不早于当日，\n默认藏品惠开始时间为当日！';
