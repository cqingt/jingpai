(function() {
	...
	u; (function() {
		...
		h) ? (e = f("<div style='" + a + "border-radius:" + g + "px; border:2px #ccc solid; background-repeat:no-repeat'></div>"), a = f("<img   style='position: absolute'>")) : (m = f("<img style='position:absolute'>"), j = m.style, e = f("<div style='" + a + "filter:chroma(color=#123456); background-repeat:no-repeat; overflow:hidden'></div>"), a = f("<img src='images/mask.png' style='position:absolute'>"), e.appendChild(m), e.appendChild(a), a = f("<div style='bwidth:370px;height:370px;position: absolute;'></div>"), h.cursor = "url(http://www.jcang.com.cn/themes/jcang/images/blank.ico)");
		k.appendChild(e);
		k.appendChild(a);
