...
function showEditor(name){
	var editor1 = KindEditor.create('textarea[name="'+name+'"]', {
		width:'600px',
		minWidth:'550px',
		height:'300px',
...
function update_category1() {//更新分类
	var get_text = update_data("category_list");
	if (get_text=='1') {
		$(".home-templates-board-layout .category-list").html('');
		$(".home-templates-board-layout .category-list").append(''+$('#article_content').val()+'');
		DialogManager.close("category_list");
	}
}
//商品推荐相关
...
function add_artist_recommend() {//增加商品推荐
	for (var i = 1; i <= 10; i++) {//防止数组下标重复
		if ($(".middle dl[recommend_id='"+i+"']").size()==0) {//编号不存在时添加
			var add_html = '';
			var del_append = '';
			del_append = '<a href="JavaScript:del_recommend('+i+');"><i class="icon-remove-sign "></i>删除</a>';//删除
			add_html = '<dl recommend_id="'+i+'"><dt><h4>商品推荐</h4>'+del_append+
    			'<a href="JavaScript:show_recommend_dialog('+i+');"><i class="icon-shopping-cart"></i>商品块</a><a href="JavaScript:show_artist_recommend_pic_dialog('+i+');"><i class="icon-lightbulb"></i>广告块</a></dt>'+
    			'<dd><ul class="goods-list"><li><span><i class="icon-gift"></i></span></li><li><span><i class="icon-gift"></i></span></li><li><span><i class="icon-gift"></i></span></li>'+
    			'<li><span><i class="icon-gift"></i></span></li><li><span><i class="icon-gift"></i></span></li><li><span><i class="icon-gift"></i></span></li>'+
    			'<li><span><i class="icon-gift"></i></span></li><li><span><i class="icon-gift"></i></span></li></ul></dd></dl>';
			$("#btn_add_list").before(add_html);
...
function select_recommend_goods(goods_id) {//商品选择
	...
	var goods_artist_name = goods.attr("goods_artist_name");
	var goods_artist_zhiwei = goods.attr("goods_artist_zhiwei");
	...
	text_append += '<input name="recommend_list['+id+'][goods_list]['+goods_id+'][goods_artist_name]" value="'+goods_artist_name+'" type="hidden">';
	text_append += '<input name="recommend_list['+id+'][goods_list]['+goods_id+'][goods_artist_zhiwei]" value="'+goods_artist_zhiwei+'" type="hidden">';
...
function show_recommend_pic_dialog(id) {//弹出框
    ...
    if(obj.find("div[select_recommend_pic_id='"+id+"']").size()==0) {//不存在时添加
        var text_append = '<div select_recommend_pic_id="'+id+'" class="middle-banner">'+
							'<a href="javascript:void(0);" recommend_pic_id="11" class="left-y">291*420</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="12" class="left-z">210*209</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="14" class="middle-y">210*209</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="21" class="right-y">210*209</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="32" class="bottom-y">210*209</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="24" class="right-b">210*209</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="31" class="bottom-a">210*209</a>'+
							//'<a href="javascript:void(0);" recommend_pic_id="32" class="bottom-b">274*400</a>'+
							//'<a href="javascript:void(0);" recommend_pic_id="33" class="bottom-c">300*110</a>'+
	...
	obj.find("div[select_recommend_pic_id='"+id+"'] a[recommend_pic_id='12']").trigger("click");//默认选中第一个图片
}

//中部推荐图片上传
function show_artist_recommend_pic_dialog(id) {//弹出框
    show_dialog('recommend_pic');
	var obj = $("#recommend_pic_form");
	recommend_show = id;
    ...
    if(obj.find("div[select_recommend_pic_id='"+id+"']").size()==0) {//不存在时添加
        var text_append = '<div select_recommend_pic_id="'+id+'" class="middle-banner">'+
							'<a href="javascript:void(0);" recommend_pic_id="11" class="left-a">250*364</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="12" class="left-b">230*181</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="14" class="middle-a">388*388</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="21" class="right-a">230*181</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="24" class="right-b">250*364</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="31" class="bottom-a">230*181</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="32" class="bottom-b">230*181</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="33" class="bottom-c">230*181</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="34" class="bottom-d">230*181</a>'+
            	  '</div>';
        obj.find("#add_recommend_pic").append(text_append);
	}
	obj.find("div[select_recommend_pic_id='"+id+"']").show();
...
//中部推荐图片上传
function show_recommend_pic_dialog1(id) {//弹出框
    show_dialog('recommend_pic');
	var obj = $("#recommend_pic_form");
	recommend_show = id;
	...
	obj.find("input[name='recommend_list[recommend][name]']").val(recommend_name);
    if(obj.find("div[select_recommend_pic_id='"+id+"']").size()==0) {//不存在时添加
        var text_append = '<div select_recommend_pic_id="'+id+'" class="middle-banner1">'+
							'<a href="javascript:void(0);" recommend_pic_id="11" class="left-a">242*400</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="12" class="left-b">242*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="14" class="middle-a">242*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="21" class="right-a">242*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="24" class="right-b">242*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="31" class="bottom-a">242*400</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="32" class="bottom-b">242*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="33" class="bottom-c">242*200</a>'+
							//'<a href="javascript:void(0);" recommend_pic_id="34" class="bottom-d">194*110</a>'+
            	  '</div>';
        obj.find("#add_recommend_pic").append(text_append);
	}
...
function select_recommend_pic(pic_td) {//选中推荐图片
    ...
    var pic_goods_price = obj.attr("pic_goods_price");
	var pic_price = obj.find("img").attr("pic_price");
    ...
    if (pic_img!='') {
		...
		$("input[name='pic_list[pic_price]']").val(pic_price);
        $("input[name='pic_list[pic_goods_price]']").val(pic_goods_price);
...
function recommend_pic(pic_id,pic_img) {//更新图片
	if (pic_img!='') {
		...
		var pic_price = $("input[name='pic_list[pic_price]']").val();
	    var text_append = '';
	    ...
	    text_append += '<input name="recommend_list['+id+'][pic_list]['+pic_id+'][pic_url]" value="'+pic_url+'" type="hidden">';
		 text_append += '<input name="recommend_list['+id+'][pic_list]['+pic_id+'][pic_price]" value="'+pic_price+'" type="hidden">';
...
function recommend_pic1(pic_id,pic_img) {//更新图片
	if (pic_img!='') {
	    var id = recommend_show;
	    var recommend_name = $("input[name='recommend_list[recommend][name]']").val();
	    $("input[name='recommend_list["+id+"][recommend][name]']").val(recommend_name);
	    ...
	    obj.find("img").attr("title",pic_name);
	    obj.find("img").attr("pic_url",pic_url);
		obj.find("img").attr("pic_price",pic_price);
	    obj.find("img").attr("src",UPLOAD_SITE_URL+'/'+pic_img);

	    text_append = $("div[select_recommend_pic_id='"+id+"']").html();
        $(".middle1 dl[recommend_id='"+id+"'] dd").html('<div class="middle-banner">'+text_append+'</div>');//页面中的图片显示
        $(".middle1 dl[recommend_id='"+id+"'] dd div.middle-banner a").css("opacity","");
	    $(".middle1 dl[recommend_id='"+id+"'] dt h4").html(recommend_name);
	}
}
//切换图片上传
