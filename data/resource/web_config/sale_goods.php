                                    ...
                                    <?php foreach($val['goods_list'] as $k => $v){ ?>
                                      <li>
                                        <dl>
                                          ...
                                          <dd class="goods-price"><?php echo $lang['index_index_store_goods_price'].$lang['nc_colon'];?><em><?php if($v['goods_price'] < 1){echo '咨询客服';}else{echo ncPriceFormatForList($v['goods_price']);}?></em></dd>
                                        </dl>
                                      </li>
                                    <?php } ?>
                                    </ul>
