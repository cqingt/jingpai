...
function show_recommend_pic_dialog(id) {//弹出框
    ...
    if(obj.find("div[select_recommend_pic_id='"+id+"']").size()==0) {//不存在时添加
        var text_append = '<div select_recommend_pic_id="'+id+'" class="middle-banner">'+
							'<a href="javascript:void(0);" recommend_pic_id="11" class="left-a">274*400</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="12" class="left-b">239*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="14" class="middle-a">239*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="21" class="right-a">245*400</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="24" class="right-b">230*200</a>'+
							'<a href="javascript:void(0);" recommend_pic_id="31" class="bottom-a">230*200</a>'+
