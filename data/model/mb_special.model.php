...
class mb_specialModel extends Model{
     ...
     * 首页专题
     */
    public function getMbSpecialIndex($spid=self::INDEX_SPECIAL_ID) {
        return $this->getMbSpecialItemUsableListByID($spid);
    }
    ...
    private function _initMbSpecialItemGoodsData($item_data, $item_type) {
        ...
        if(!empty($item_data['item'])) {
            ...
            $goods_list = $model_goods->getGoodsList($condition, 'goods_id,goods_name,goods_price,goods_promotion_price,goods_image');
