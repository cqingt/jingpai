        ...
        <tr>
          ...
          <td class="handle">
            <?php if($value['article_state'] != '3') {?>
              <a href="<?php echo CMS_SITE_URL.DS;?>index.php?act=article&op=article_detail&article_id=<?php echo $value['article_id'];?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?act=member_article&op=article_edit&article_id=<?php echo $value['article_id'];?>" style="color:#F90;" ><?php echo $lang['cms_text_edit'];?></a>
              <?php } else { ?>
              <a href="<?php echo $article_url;?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a>
                <a href="<?php echo CMS_SITE_URL.DS;?>index.php?act=member_article&op=article_edit&article_id=<?php echo $value['article_id'];?>" style="color:#F90;" ><?php echo $lang['cms_text_edit'];?></a>
              <?php } ?>
