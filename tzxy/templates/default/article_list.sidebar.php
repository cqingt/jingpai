...
<div class="block-style-one">
    ...
    <div class="content">
        ...
        <ol class="article-liked-top">
            ...
            <a href="<?php echo getCMSArticleUrl($value['article_id']);?>" target="_blank"><div class="article-cover" style=" background-image:url(<?php echo getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image'], 'list');?>)"></div></a>
            <div class="article-title"><a href="<?php echo getCMSArticleUrl($value['article_id']);?>" target="_blank"><?php echo $value['article_title'];?></a></div>
            </li>
            <?php $commend_count++;?>
            <?php } ?>
        </ol>
