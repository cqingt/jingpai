  ...
  <div class="mainbox">
    ...
    <ul class="article-list">
      ...
      <li>
        ...
        <div class="article-preface"><?php echo html_substr_word($value['article_content'],100).'...';?><a href="<?php echo $article_url;?>" target="_blank"><?php echo $lang['cms_read_more'];?></a></div>
