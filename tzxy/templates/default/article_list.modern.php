    ...
    <div class="modern-list">
      ...
      <div class="modern-list-tag block-style-two">
        ...
        <div class="modern-list-item">
          ...
          <div class="article-preface"><?php echo html_substr_word($output['article_list'][$i]['article_content'],100).'...';?><a href="<?php echo $article_url;?>" target="_blank"><?php echo $lang['cms_read_more'];?></a></div>
