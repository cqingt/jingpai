...
<![endif]-->
    ...
    <script src="<?php echo RESOURCE_SITE_URL;?>/js/jquery-1.2.6.pack.js" ></script>
    <script src="<?php echo RESOURCE_SITE_URL;?>/js/jcarousellite_1.0.1.js" ></script>
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        <h1 class="site-logo"><a href="<?php echo LEPAI_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1>
...
<nav class="public-nav-layout">
    <div class="wrapper">
        ...
        <ul class="site-menu">
            ...
            <?php if (C('miaosha_allow')){ ?>
                <li><a href="<?php echo urlShop('show_miaosha', 'index');?>" <?php if($output['index_sign'] == 'miaosha' && $output['index_sign'] != '0') {echo 'class="current"';} ?>> 秒杀</a></li>
            <?php } ?>
