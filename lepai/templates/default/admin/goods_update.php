...
<div class="wrapper">
     ...
     <div class="content boxes mtop25">
          <div class="title">拍品修改</div>
          <div class="article">
               <form action="index.php?act=adminGoods&op=doUpGoods" method="POST">
...
-->
               ...
               <div class="overflow issue has-number">
                     <label>起 拍 价</label>
                     <input onkeyup="if(/\D/.test(this.value)){this.value='';}" required="required"  value="<?php echo $output['result']['G_Qipai']?>" id="G_Qipai" name="G_Qipai" type="textarea" class="overflow issue-input" placeholder="">
                     <span class="describe-red"></span>
               </div>
               <div class="overflow issue has-number">
                     <label>加价幅度</label>
                     <input onkeyup="if(/\D/.test(this.value)){this.value='';}" required="required"  value="<?php echo $output['result']['G_IncMoney']?>" id="G_IncMoney" name="G_IncMoney" type="textarea" class="overflow issue-input" placeholder="">
                     <span class="describe-red"></span>
               </div>
               <div class="overflow issue has-number">
                     <label>保 证 金</label>
                     <input onkeyup="if(/\D/.test(this.value)){this.value='';}" required="required"  value="<?php echo $output['result']['G_BaoZhenMoney']?>" id="G_BaoZhenMoney" name="G_BaoZhenMoney" type="textarea" class="overflow issue-input" placeholder="">
                     <span class="describe-red"></span>
               </div>
               <div class="overflow issue has-number">
                     <label>保 留 价</label>
                     <input onkeyup="if(/\D/.test(this.value)){this.value='';}" required="required"  value="<?php echo $output['result']['G_BaoliuMoney']?>" id="G_BaoliuMoney" name="G_BaoliuMoney" type="textarea" class="overflow issue-input" placeholder="">
...
function delImg(id,vid,imgid){
  ...
  $.ajax({
    ...
    cache: false,
    async: false,
    url : "index.php?act=adminGoods&op=ajaxDelImg",
    data: 'imgid=' + imgid,
